...
public class ResponsibleAdministrationCodeServiceImpl implements ResponsibleAdministrationCodeService {
    ...
    /**
     * @see org.kuali.kfs.module.endow.document.service.ResponsibleAdministrationCodeService#getByPrimaryKey(java.lang.String)
     */
    public ResponsibleAdministrationCode getByPrimaryKey(String code) {
        ResponsibleAdministrationCode responsibleAdministrationCode = null;
        if (StringUtils.isNotBlank(code)) {
            Map criteria = new HashMap();
            criteria.put("code", code);
            responsibleAdministrationCode = (ResponsibleAdministrationCode) businessObjectService.findByPrimaryKey(ResponsibleAdministrationCode.class, criteria);
