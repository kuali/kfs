 ...
 */ 
public class AttributedUpdateCheckEvent extends AttributedDocumentEventBase {
     ...
     * @param check
     */
    public AttributedUpdateCheckEvent(String description, String errorPathPrefix, Document document, Check check) {
