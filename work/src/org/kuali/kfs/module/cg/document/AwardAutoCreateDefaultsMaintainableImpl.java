...
public class AwardAutoCreateDefaultsMaintainableImpl extends FinancialSystemMaintainable {
    ...
    private boolean isReadOnly(Field field, boolean isNew) {
        if (CGConstants.AwardCreationDefaults.KcUnit.equals(field.getPropertyName())) {
            if (!isNew)
                return true;
        }
        return false;
    ...
    public void processAfterCopy(MaintenanceDocument document, Map<String, String[]> parameters) {
        ...
        AwardAutoCreateDefaults newAcctAuto = (AwardAutoCreateDefaults) document.getNewMaintainableObject().getBusinessObject();
