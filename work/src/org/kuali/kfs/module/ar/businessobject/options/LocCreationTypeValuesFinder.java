...
public class LocCreationTypeValuesFinder extends KeyValuesBase {
    ...
    public List<KeyValue> getKeyValues() {
        ...
        activeLabels.add(new ConcreteKeyValue(ArConstants.LOC_BY_LOC_FUND, ArConstants.LOC_BY_LOC_FUND));
        activeLabels.add(new ConcreteKeyValue(ArConstants.LOC_BY_LOC_FUND_GRP, ArConstants.LOC_BY_LOC_FUND_GRP));
        return activeLabels;
    }
}
