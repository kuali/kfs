...
<div align="right">
	<kul:help documentTypeName="${DataDictionary.KualiRoutingFormDocument.documentTypeName}" pageName="${CGConstants.OUTPUT_HEADER_TAB}" altText="page help"/>
</div>
...
<div id="globalbuttons" class="globalbuttons">
  <html:image src="${ConfigProperties.externalizable.images.url}buttonsmall_genpdf.gif" styleClass="globalbuttons" property="methodToCall.pdfOutput" alt="Copy current document" title="Copy current document" onclick="excludeSubmitRestriction=true"/>
</div>
