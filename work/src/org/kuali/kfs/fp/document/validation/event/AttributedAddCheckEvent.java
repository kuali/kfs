 ...
 */ 
public class AttributedAddCheckEvent extends AttributedDocumentEventBase {
     ...
     * @param check
     */
    public AttributedAddCheckEvent(String description, String errorPathPrefix, Document document, Check check) {
