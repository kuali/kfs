...
public class CustomerAgingReportLookupableHelperServiceImplTest extends KualiTestBase {
    ...
    public void testGetSearchResultsMap() {
        ...
        customerInvoiceDocumentBatchStep.createCustomerInvoiceDocumentForFunctionalTesting("EAT17609", new Date(), 1, new KualiDecimal(4), new BigDecimal(25.00));
        customerInvoiceDocumentBatchStep.createCustomerInvoiceDocumentForFunctionalTesting("EAT17609", new Date(), 1, new KualiDecimal(1), new BigDecimal(25.00));
