 ...
 */
public class SavePersonnelEventBase extends KualiDocumentEventBase implements SavePersonnelEvent {

    private final List personnel;

    /**
     * Constructs a SavePersonnelEventBase.java.
     * 
     * @param description
     * @param errorPathPrefix
     * @param document
     */
    public SavePersonnelEventBase(String errorPathPrefix, Document document, List personnel) {
    ...
    public SavePersonnelEventBase(Document document, List personnel) {
    ...
    public boolean invokeRuleMethod(BusinessRule rule) {
        return ((BudgetDocumentRule) rule).processSavePersonnelBusinessRules(personnel);
    }
}