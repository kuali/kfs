...
<kul:page headerTitle="Contracts Grants Invoice On Demand Summary"
	transactionalDocument="false" showDocumentInfo="false"
	htmlFormAction="arContractsGrantsInvoiceOnDemandSummary"
	docTitle="Contracts Grants Invoice On Demand Summary">
	...
	<div id="globalbuttons" class="globalbuttons">
		...
		<c:if test="${!KualiForm.awardInvoiced}">
			...
			<ar:contractsGrantsInvoiceOnDemandSummaryResults
