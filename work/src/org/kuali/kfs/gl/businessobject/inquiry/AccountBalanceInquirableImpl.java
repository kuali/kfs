...
public class AccountBalanceInquirableImpl extends KualiInquirableImpl {
    ...
    private static List buildUserDefinedAttributeKeyList(String attributeName){
        ...
        keys.add(Constants.UNIVERSITY_FISCAL_YEAR_PROPERTY_NAME);
        keys.add(Constants.ACCOUNT_NUMBER_PROPERTY_NAME);
        keys.add(Constants.CHART_OF_ACCOUNTS_CODE_PROPERTY_NAME);
        keys.add("objectCode");
        keys.add("subObjectCode");
    ...
    private static Map getUserDefinedAttributeMap(){
        ...
        userDefinedAttributeMap.put("currentBudgetLineBalanceAmount", "CB"); 
        userDefinedAttributeMap.put("accountLineActualsBalanceAmount", "AC");
        userDefinedAttributeMap.put("accountLineEncumbranceBalanceAmount", "EX");
