...
public class ContractsGrantsInvoiceDocumentForm extends CustomerInvoiceDocumentForm {
    ...
    public List<ExtraButton> getExtraButtons() {
        ...
        // add Prorate Button
        if (getDocumentActions().containsKey(KNSConstants.KUALI_ACTION_CAN_EDIT) && KNSConstants.YES_INDICATOR_VALUE.equals(KNSServiceLocator.getParameterService().getParameterValue(ArConstants.CG_NAMESPACE_CODE, KNSConstants.DetailTypes.ALL_DETAIL_TYPE, ArConstants.ENABLE_CG_PRORATE_BILL_IND)) && !presoController.isBillingFrequencyMilestone(cgInvoiceDocument) && !presoController.isBillingFrequencyPredeterminedBillingSchedule(cgInvoiceDocument)) {
