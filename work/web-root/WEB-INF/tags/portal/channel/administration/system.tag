...
<div class="body">
    <ul class="chan">
		...
		<li><portal:portalLink displayTitle="true" title="Financial System User" url="kr/lookup.do?methodToCall=start&businessObjectClassName=org.kuali.kfs.bo.FinancialSystemUser&docFormKey=88888888&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true" /></li>
