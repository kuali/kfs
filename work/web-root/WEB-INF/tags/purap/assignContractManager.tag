<%--
 ...
 $Source: /opt/cvs/kfs/work/web-root/WEB-INF/tags/purap/assignContractManager.tag,v $
...
<!--
        <kul:htmlAttributeHeaderCell>
            ...
            <html:hidden property="document.unassignedRequisitions" />
        </kul:htmlAttributeHeaderCell>
-->
	        ...
	        <logic:iterate id="requisitions" name="KualiForm" property="document.unassignedRequisitions" indexId="ctr">
	            <tr>
	                <td align=left valign=middle class="datacell">
				        ...
				        <c:if test="${!readOnly}" >
	                        <kul:lookup boClassName="org.kuali.module.purap.bo.ContractManager" fieldConversions="contractManager.contractManagerCode:document.contractManagerCode" /></div>
				        </c:if>
	                </td>
	                <td align=left valign=middle class="datacell">
