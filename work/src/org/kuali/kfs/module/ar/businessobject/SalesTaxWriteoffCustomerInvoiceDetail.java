...
public class SalesTaxWriteoffCustomerInvoiceDetail extends CustomerInvoiceDetail{
    
    private TaxDetail taxDetail;
    private WriteoffCustomerInvoiceDetail writeoffCustomerInvoiceDetail;
    
    public SalesTaxWriteoffCustomerInvoiceDetail(TaxDetail taxDetail, WriteoffCustomerInvoiceDetail writeoffCustomerInvoiceDetail) {
        this.taxDetail = taxDetail;
        this.writeoffCustomerInvoiceDetail = writeoffCustomerInvoiceDetail;
    }
