...
public class NonCheckDisbursementDocumentRuleTest extends KualiTestBaseWithFixtures {
    ...
    /*
     * Old fixture code that contains valuable info for when we implement this rule class.
     * 
     * public void fixturesDefault() {
     ...
     public final void fixturesPartiallyLoadedDoc() throws Exception {
     ...
     public final void fixturesApplyAddAccountingLineBusinessRulesInvalidSubObjectCode() 
     throws Exception {
     List sourceLines = new ArrayList();
     List targetLines = new ArrayList();

     addFixture( KualiRuleTestCase.SUBOBJECT_CODE,
     TransactionalDocumentRuleBase.OBJECT_TYPE_CODE.INCOME_NOT_CASH );
     addFixture( KualiRuleTestCase.DOCUMENT_DESCRIPTION, "test" );
     ...
     public final void fixturesApplyAddAccountingLineBusinessRulesValidSubObjectCode() 
     throws Exception {
     List sourceLines = new ArrayList();
     List targetLines = new ArrayList();

     addFixture( KualiRuleTestCase.DOCUMENT_DESCRIPTION, "testing "
     + "NonCheckDisbursementDocumentTest.createValidRuleDIDocument" );
     addFixture( KualiRuleTestCase.EXPLANATION, "This is a test document, "
     + "testing valid accounting line business rules." );
