...
public class LetterOfCreditByLOCFundBatchStep extends AbstractStep {
    ...
    public boolean execute(String jobName, Date jobRunDate) {
        ...
        while (it.hasNext()) {
            ...
            Collection<ContractsGrantsInvoiceDocument> cgInvoices = contractsGrantsInvoiceDocumentService.retrieveOpenAndFinalCGInvoicesByLOCFund(letterOfCreditFund.getLetterOfCreditFundCode(), outputFileStream);
