...
<%--	<kul:hiddenDocumentFields /> --%>
    ...
    <table align="center" cellpadding="0" cellspacing="0" class="datatable-100">
	    ...
	    <tr>
            ...
            <th class="grid" colspan="1" rowspan="1"><br>${KualiForm.operatingModePullFlagLabel}
              <html:hidden property="operatingModePullFlagLabel" value="${KualiForm.operatingModePullFlagLabel}" />
            </th>
