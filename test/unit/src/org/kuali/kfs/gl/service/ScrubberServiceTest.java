...
public class ScrubberServiceTest extends OriginEntryTestBase {
    ...
    public void testPlantIndebtedness() throws Exception {
        ...
        String[] input = new String[] { testingYear + "BA9020204-----9100---ACLI07SB  01DEBTEDNES     00000Biology Stockroom                                       13.77D" + testingYear + "-01-05          ----------                                                                       ",
                testingYear + "BA9020204-----8000---ACAS07SB  01DEBTEDNES     00000TP Generated Offset                                     13.77C" + testingYear + "-01-05          ----------                                                                       ", testingYear + "BA9120657-----9120---ACLI07ST  EUDEBTEDNES     00000PAYROLL EXPENSE TRANSFERS                              620.00C" + testingYear + "-01-05          ----------                                                                       ",
                testingYear + "BA9120657-----8000---ACAS07ST  EUDEBTEDNES     00000PAYROLL EXPENSE TRANSFERS                              620.00D" + testingYear + "-01-05          ----------                                                                       " };

        EntryHolder[] output = new EntryHolder[] { new EntryHolder(GeneralLedgerConstants.BatchFileSystem.SCRUBBER_INPUT_FILE, testingYear + "BA9020204-----9100---ACLI07SB  01DEBTEDNES     00000Biology Stockroom                                       13.77D" + testingYear + "-01-05          ----------                                                                       "),
    ...
    public void testInvalidTransactionDate() throws Exception {
        String[] inputTransactions = { testingYear + "BL1031497-----4100---ACEX07PO  LGINVALDATE     00000Rite Quality Office Supplies Inc.                       43.42D2096-02-11          ----------                                                                               ",
        ...
        String[] fixedTransactionDatesAndAmounts = { testingYear + "BL1031497-----4100---ACEX07PO  LGINVALDATE     00000Rite Quality Office Supplies Inc.       +00000000000000043.42D" + strToday + "          ----------                                                                               ",
                testingYear + "BL1031497-----9892---ACFB07PO  LGINVALDATE     00000Rite Quality Office Supplies Inc.       +00000000000000043.42C" + strToday + "          ----------                                                                               " };
    ...
    public void testInvalidObjectType() throws Exception {
        String[] inputTransactions = { testingYear + "BL1031400-----4100---ACXX07PO  LGINVALOBTY     00000Rite Quality Office Supplies Inc.                       43.42D" + testingYear + "-01-05          ----------                                                                               ",
