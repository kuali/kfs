...
public class AccountingLineRuleHelperServiceImpl implements AccountingLineRuleHelperService {
    private static final Logger LOG = Logger.getLogger(AccountingLineRuleHelperServiceImpl.class);
    ...
    public String getAccountLabel() {
        return dataDictionaryService.getDataDictionary().getBusinessObjectEntry(Account.class.getName()).getAttributeDefinition(KFSPropertyConstants.ACCOUNT_NUMBER).getShortLabel();
    }
    ...
    public String getChartLabel() {
        return dataDictionaryService.getDataDictionary().getBusinessObjectEntry(Chart.class.getName()).getAttributeDefinition(KFSPropertyConstants.CHART_OF_ACCOUNTS_CODE).getShortLabel();
    }
    ...
    public String getObjectCodeLabel() {
        return dataDictionaryService.getDataDictionary().getBusinessObjectEntry(ObjectCode.class.getName()).getAttributeDefinition(KFSPropertyConstants.FINANCIAL_OBJECT_CODE).getShortLabel();
    }
    ...
    public String getSubAccountLabel() {
        return dataDictionaryService.getDataDictionary().getBusinessObjectEntry(SubAccount.class.getName()).getAttributeDefinition(KFSPropertyConstants.SUB_ACCOUNT_NUMBER).getShortLabel();
    }
    ...
    public String getSubObjectCodeLabel() {
        return dataDictionaryService.getDataDictionary().getBusinessObjectEntry(SubObjectCode.class.getName()).getAttributeDefinition(KFSPropertyConstants.FINANCIAL_SUB_OBJECT_CODE).getShortLabel();
    }
    ...
    public boolean hasAccountRequiredOverrides(AccountingLine line, String overrideCode) {
        ...
        if (AccountingLineOverride.needsExpiredAccountOverride(account) && !override.hasComponent(AccountingLineOverride.COMPONENT.EXPIRED_ACCOUNT)) {
            ...
            if (continuation == null) {
                GlobalVariables.getMessageMap().putError(KFSPropertyConstants.ACCOUNT_NUMBER, KFSKeyConstants.ERROR_DOCUMENT_ACCOUNT_EXPIRED_NO_CONTINUATION, new String[] { account.getAccountNumber() });
            }
            else {
                GlobalVariables.getMessageMap().putError(KFSPropertyConstants.ACCOUNT_NUMBER, KFSKeyConstants.ERROR_DOCUMENT_ACCOUNT_EXPIRED, new String[] { account.getAccountNumber(), continuation.getChartOfAccountsCode(), continuation.getAccountNumber() });
    ...
    public boolean hasObjectBudgetRequiredOverrides(AccountingLine line, String overrideCode) {
        ...
        if (AccountingLineOverride.needsObjectBudgetOverride(account, objectCode) && !override.hasComponent(AccountingLineOverride.COMPONENT.NON_BUDGETED_OBJECT)) {
            GlobalVariables.getMessageMap().putError(KFSPropertyConstants.FINANCIAL_OBJECT_CODE, KFSKeyConstants.ERROR_DOCUMENT_ACCOUNT_PRESENCE_NON_BUDGETED_OBJECT_CODE, new String[] { account.getAccountNumber(), objectCode.getFinancialObjectCode() });
            retVal = false;
        }
        return retVal;
    }
    ...
    public boolean isValidAccount(String accountIdentifyingPropertyName, Account account, DataDictionary dataDictionary) {
        return isValidAccount(account, dataDictionary, KFSPropertyConstants.ACCOUNT_NUMBER, accountIdentifyingPropertyName);
    }
    ...
    public boolean isValidChart(String accountIdentifyingPropertyName, Chart chart, DataDictionary dataDictionary) {
        return isValidChart(chart, dataDictionary, KFSPropertyConstants.CHART_OF_ACCOUNTS_CODE, accountIdentifyingPropertyName);
    }
    ...
    public boolean isValidObjectCode(String accountIdentifyingPropertyName, ObjectCode objectCode, DataDictionary dataDictionary) {
        return isValidObjectCode(objectCode, dataDictionary, KFSPropertyConstants.FINANCIAL_OBJECT_CODE, accountIdentifyingPropertyName);
    }
    ...
    public boolean isValidObjectTypeCode(String accountIdentifyingPropertyName, ObjectType objectTypeCode, DataDictionary dataDictionary) {
        return isValidObjectTypeCode(objectTypeCode, dataDictionary, KFSPropertyConstants.OBJECT_TYPE_CODE, accountIdentifyingPropertyName);
    }
    ...
    public boolean isValidProjectCode(String errorPropertyIdentifyingName, ProjectCode projectCode, DataDictionary dataDictionary) {
        return isValidProjectCode(projectCode, dataDictionary, KFSPropertyConstants.PROJECT_CODE, errorPropertyIdentifyingName);
    }
    ...
    public boolean isValidSubAccount(String accountIdentifyingPropertyName, SubAccount subAccount, DataDictionary dataDictionary) {
        return isValidSubAccount(subAccount, dataDictionary, KFSPropertyConstants.SUB_ACCOUNT_NUMBER, accountIdentifyingPropertyName);
    }
    ...
    public boolean isValidSubObjectCode(String accountIdentifyingPropertyName, SubObjectCode subObjectCode, DataDictionary dataDictionary) {
        return isValidSubObjectCode(subObjectCode, dataDictionary, KFSPropertyConstants.FINANCIAL_SUB_OBJECT_CODE, accountIdentifyingPropertyName);
    }
    ...
    protected boolean isValidReferenceTypeCode(String documentTypeCode, DocumentTypeEBO referenceType, org.kuali.rice.krad.datadictionary.BusinessObjectEntry accountingLineEntry, String errorPropertyIdentifyingName) {
        if (StringUtils.isNotBlank(documentTypeCode) && !financialSystemDocumentTypeService.isCurrentActiveAccountingDocumentType(documentTypeCode)) {
