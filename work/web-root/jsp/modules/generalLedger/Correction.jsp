                    ...
                    <c:choose>
                      <c:when test="${KualiForm.editableFlag == 'Y'}">
                        <display:column title="Manual Edit" >
                          <html:image property="methodToCall.showOneEntry.anchor${currentTabIndex}.${allEntries.entryId}" src="images/tinybutton-edit1.gif" styleClass="tinybutton" alt="edit" />
                          <html:image property="methodToCall.deleteEntry.anchor${currentTabIndex}.${allEntries.entryId}" src="images/tinybutton-delete1.gif" styleClass="tinybutton" alt="delete" />
                        </display:column>
                      </c:when>
                      <c:otherwise>
                  ...
                  <tr>                
                    <td>
                      <display:table id="eachEntryForManualEdit" name="${KualiForm.eachEntryForManualEdit}" requestURIcontext="false"  >
                        ...
                        <display:column title="Account Number" ><html:text property="eachEntryForManualEdit.accountNumber" size="7"  /></display:column>
                        <display:column title="Sub Account Number" ><html:text property="eachEntryForManualEdit.subAccountNumber" size="7"  /></display:column>
                        <display:column title="Object Code" ><html:text property="eachEntryForManualEdit.financialObjectCode" size="5"  /></display:column>
                        <display:column title="Sub Object Code" ><html:text property="eachEntryForManualEdit.financialSubObjectCode" size="6"  /></display:column>
                        <display:column title="Balance Type" ><html:text property="eachEntryForManualEdit.financialBalanceTypeCode" size="8"  /></display:column>
                        <display:column title="Object Type" ><html:text property="eachEntryForManualEdit.financialObjectTypeCode" size="6"  /></display:column>
                        <display:column title="Fiscal Period" ><html:text property="eachEntryForManualEdit.universityFiscalPeriodCode" size="6"  /></display:column>
                        <display:column title="Document Type" ><html:text property="eachEntryForManualEdit.financialDocumentTypeCode" size="10"  /></display:column>
                        <display:column title="Origin Code" ><html:text property="eachEntryForManualEdit.financialSystemOriginationCode" size="6"  /></display:column>
                        <display:column title="Document Number" ><html:text property="eachEntryForManualEdit.financialDocumentNumber" size="9"  /></display:column>  
                        <display:column title="Sequence Number" ><html:text property="eachEntryForManualEdit.transactionLedgerEntrySequenceNumber" size="9"  /></display:column>
                        <display:column title="Description" ><html:text property="eachEntryForManualEdit.transactionLedgerEntryDescription" size="11"  /></display:column>
                        <display:column title="Amount" ><html:text property="eachEntryForManualEdit.transactionLedgerEntryAmount" size="7"  /></display:column>
                        <display:column title="Debit Credit Indicator" ><html:text property="eachEntryForManualEdit.transactionDebitCreditCode" size="9"  /></display:column>
                        <display:column title="Transaction Date" ><html:text property="eachEntryForManualEdit.transactionDate" size="12"  /></display:column>
                        <display:column title="Org Doc Number" ><html:text property="eachEntryForManualEdit.organizationDocumentNumber" size="12"  /></display:column>
                        <display:column title="Project Code" ><html:text property="eachEntryForManualEdit.projectCode" size="7"  /></display:column>
                        <display:column title="Org Ref ID" ><html:text property="eachEntryForManualEdit.organizationReferenceId" size="13"  /></display:column>
                        <display:column title="Ref Doc Type" ><html:text property="eachEntryForManualEdit.referenceFinancialDocumentTypeCode" size="10"  /></display:column>
                        <display:column title="Ref Origin Code" ><html:text property="eachEntryForManualEdit.referenceFinancialSystemOriginationCode" size="10"  /></display:column>
                        <display:column title="Ref Doc Number" ><html:text property="eachEntryForManualEdit.referenceFinancialDocumentNumber" size="9"  /></display:column>
                        <display:column title="Reversal Date" ><html:text property="eachEntryForManualEdit.financialDocumentReversalDate" size="8"  /></display:column>        
                        <display:column title="Enc Update Code" ><html:text property="eachEntryForManualEdit.transactionEncumbranceUpdateCode" size="13"  /></display:column>
                      </display:table>
                    </td>
                  </tr>
                </c:if>
            ...
            <c:forEach var="group" items="${KualiForm.document.correctionChangeGroup}"> 
              ...
              <tr style="border-bottom: 1px solid #333;"> 
                <td class="bord-l-b" style="padding: 4px; vertical-align: top;">
                  <input type="hidden" name="correction-groups[<c:out  value="${group.correctionChangeGroupLineNumber}" />][group-number]" value="" /> 
                  <input type="hidden" name="correction-groups[<c:out  value="${group.correctionChangeGroupLineNumber}" />][next-search-criterion-number]" value="<c:out value="${group.correctionCriteriaNextLineNumber}" />" /> 
                  <input type="hidden" name="correction-groups[<c:out  value="${group.correctionChangeGroupLineNumber}" />][next-replacement-specification-number]" value="<c:out value="${group.correctionChangeNextLineNumber}" />" />
                  <c:forEach items="${group.correctionCriteria}" var="criterion"> 
                    <div>
                      <label for="correction-groups[<c:out value="${group.correctionChangeGroupLineNumber }" />][search-criteria][<c:out value="${criterion.correctionCriteriaLineNumber}" />][field-name]">Field</label>
                      <select id="correction-groups[<c:out value="${ group.correctionChangeGroupLineNumber}" />][search-criteria][<c:out value="${criterion.correctionCriteriaLineNumber}" />][field-name]" name="correction-groups[<c:out value="${ group.correctionChangeGroupLineNumber}" />][search-criteria][<c:out value="${criterion.correctionCriteriaLineNumber}" />][field-name]">
                        <option value="" selected>Select Search Criteria</option> 
                        <c:forEach var="fieldName" items="${KualiForm.fieldNames}">
                          <option value="<c:out value="${fieldName.value}" />"<c:if test="${fieldName.value eq criterion.correctionFieldName}"> selected="true"</c:if>><c:out value="${fieldName.value}" /></option>
                        </c:forEach>
                      </select>
                      <label for="correction-groups[<c:out value="${ group.correctionChangeGroupLineNumber}" />][search-criteria][<c:out value="${criterion.correctionCriteriaLineNumber}" />][operator]">Operator</label>
                      <select id="correction-groups[<c:out value="${ group.correctionChangeGroupLineNumber}" />][search-criteria][<c:out value="${criterion.correctionCriteriaLineNumber}" />][operator]" name="correction-groups[<c:out value="${ group.correctionChangeGroupLineNumber}" />][search-criteria][<c:out value="${criterion.correctionCriteriaLineNumber}" />][operator]">
                        <c:forEach var="operator" items="${KualiForm.searchOperators}">
                          <option value="<c:out value="${operator.key }" />"<c:if test="${operator.key eq criterion.correctionOperatorCode}">selected="true"</c:if>><c:out value="${ operator.value}" /></option>
                        </c:forEach>
                      </select>
                  ...
                  <div>
                    ...
                    <select id="correction-groups[<c:out value="${group.correctionChangeGroupLineNumber}" />][search-criteria][field-name]" name="correction-groups[<c:out value="${ group.correctionChangeGroupLineNumber}" />][search-criteria][field-name]">
                      <option value="" selected="selected">Select Search Criteria</option>
                      <c:forEach var="fieldName" items="${ KualiForm.fieldNames}">
                        <option value="<c:out value="${fieldName.value}" />"><c:out value="${fieldName.value}" /></option>
                      </c:forEach> 
                    </select>
                    <label for="correction-groups[<c:out value="${group.correctionChangeGroupLineNumber}" />][search-criteria][operator]">Operator</label> 
                    <select id="correction-groups[<c:out value="${group.correctionChangeGroupLineNumber}" />][search-criteria][operator]" name="correction-groups[<c:out value="${ group.correctionChangeGroupLineNumber}" />][search-criteria][operator]">
                      <c:forEach var="operator" items="${ KualiForm.searchOperators}">
                ...
                <td class="bord-l-b" style="padding: 4px; vertical-align: top;">
                  <c:forEach var="specification" items="${group.correctionChange }">
                    <div>
                      <label for="correction-groups[<c:out value="${ group.correctionChangeGroupLineNumber}" />][replacement-specifications][<c:out value="${specification.correctionChangeLineNumber}" />][field-name]">Field</label>
                      <select id="correction-groups[<c:out value="${ group.correctionChangeGroupLineNumber}" />][replacement-specifications][<c:out value="${specification.correctionChangeLineNumber}" />][field-name]" name="correction-groups[<c:out value="${ group.correctionChangeGroupLineNumber}" />][replacement-specifications][<c:out value="${specification.correctionChangeLineNumber}" />][field-name]">
                        <c:forEach var="fieldName" items="${ KualiForm.fieldNames}">
                          <option value="<c:out value="${fieldName.value}" />"<c:if test="${fieldName.value eq specification.correctionFieldName}"> selected="true"</c:if>><c:out value="${fieldName.value}" /></option>
                        </c:forEach>
                      </select>
                  ...
                  <div>
                    ...
                    <select id="correction-groups[<c:out value="${group.correctionChangeGroupLineNumber}" />][replacement-specifications][field-name]" name="correction-groups[<c:out value="${ group.correctionChangeGroupLineNumber}" />][replacement-specifications][field-name]">
                ...
                <tr style="border-bottom: 1px solid #333;"> 
                  <td class="bord-l-b" style="padding: 4px; vertical-align: top;">
                    ...
                    <c:forEach items="${group.correctionCriteria}" var="criterion"> 
                      ...
                      <div>
                        ...
                        <select id="correction-groups[<c:out value="${ group.correctionChangeGroupLineNumber}" />][search-criteria][<c:out value="${criterion.correctionCriteriaLineNumber}" />][field-name]" name="correction-groups[<c:out value="${ group.correctionChangeGroupLineNumber}" />][search-criteria][<c:out value="${criterion.correctionCriteriaLineNumber}" />][field-name]">
                          <option value="" selected>Select Search Criteria</option> 
                          <c:forEach var="fieldName" items="${KualiForm.fieldNames}">
                            <option value="<c:out value="${fieldName.value}" />"<c:if test="${fieldName.value eq criterion.correctionFieldName}"> selected="true"</c:if>>
                    ...
                    <div>
                      ...
                      <select id="correction-groups[<c:out value="${group.correctionChangeGroupLineNumber}" />][search-criteria][field-name]" name="correction-groups[<c:out value="${ group.correctionChangeGroupLineNumber}" />][search-criteria][field-name]">
                        <option value="" selected="selected">Select Search Criteria</option>
                        <c:forEach var="fieldName" items="${ KualiForm.fieldNames}"><option value="<c:out value="${fieldName.value}" />"><c:out value="${fieldName.value}" /></option></c:forEach> 
                      </select>
                      <label for="correction-groups[<c:out value="${group.correctionChangeGroupLineNumber}" />][search-criteria][operator]">Operator</label> 
                      <select id="correction-groups[<c:out value="${group.correctionChangeGroupLineNumber}" />][search-criteria][operator]" name="correction-groups[<c:out value="${ group.correctionChangeGroupLineNumber}" />][search-criteria][operator]">
                        <c:forEach var="operator" items="${ KualiForm.searchOperators}">
    ...
    <div class="tab-container" align="center" >
      <table cellpadding=0 class="datatable" summary=""> 
        ...
        <tr>
          <td>
            <center>
              <Strong> <c:out value="${oldDocSystem}" /> </Strong>
              <Strong> <c:out value="${oldDocEditMethod}" /> </Strong>
            </center>
          </td>
        </tr>
      </table>
          ...
          <tr style="border-bottom: 1px solid #333;"> 
            <td class="bord-l-b" style="padding: 4px; vertical-align: top;">
              ...
              <c:forEach items="${group.correctionCriteria}" var="criterion"> 
                <div>
                  <label for="correction-groups[<c:out value="${group.correctionChangeGroupLineNumber }" />][search-criteria][<c:out value="${criterion.correctionCriteriaLineNumber}" />][field-name]">Field</label>
                  <input type="text" value="<c:out value="${criterion.correctionFieldName}" />" disabled="true" />
                  <label for="correction-groups[<c:out value="${ group.correctionChangeGroupLineNumber}" />][search-criteria][<c:out value="${criterion.correctionCriteriaLineNumber}" />][operator]">Operator</label>
                  <input type="text" value="<c:out value="${criterion.correctionOperatorCode}" />" disabled="true" />
                  <label for="correction-groups[<c:out value="${ group.correctionChangeGroupLineNumber}" />][search-criteria][<c:out value="${criterion.correctionCriteriaLineNumber}" />][field-value]">Value</label>
                  <input id="correction-groups[<c:out value="${ group.correctionChangeGroupLineNumber}" />][search-criteria][<c:out value="${criterion.correctionCriteriaLineNumber}" />][field-value]" value="${ criterion.correctionFieldValue}" name="correction-groups[<c:out value="${group.correctionChangeGroupLineNumber}" />][search-criteria][<c:out value="${ criterion.correctionCriteriaLineNumber}" />][field-value]" type="text" disabled="true">
                </div>
              </c:forEach>
            </td> 
            <td class="bord-l-b" style="padding: 4px; vertical-align: top;">
              <c:forEach var="specification" items="${group.correctionChange }">
                <div>
                  <label for="correction-groups[<c:out value="${ group.correctionChangeGroupLineNumber}" />][replacement-specifications][<c:out value="${specification.correctionChangeLineNumber}" />][field-name]">Field</label>
                  <input type="text" value="<c:out value="${specification.correctionFieldName}" />" disabled="true" />
                  <label for="correction-groups[<c:out value="${group.correctionChangeGroupLineNumber }" />][replacement-specifications][<c:out value="${specification.correctionChangeLineNumber}" />][replacement-value]">Replacement Value</label>
                  <input type="text" disabled="true" name="correction-groups[<c:out value="${group.correctionChangeGroupLineNumber}" />][replacement-specifications][<c:out value="${ specification.correctionChangeLineNumber}" />][replacement-value]" value="<c:out value="${specification.correctionFieldValue}" />" id="correction-groups[<c:out value="${ group.correctionChangeGroupLineNumber}" />][replacement-specifications][<c:out value="${specification.correctionChangeLineNumber}" />][replacement-value]">
                </div>
              </c:forEach>
            </tr>
          </c:forEach>
