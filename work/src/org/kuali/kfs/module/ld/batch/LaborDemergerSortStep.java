...
public class LaborDemergerSortStep extends AbstractStep {
    ...
    public boolean execute(String jobName, Date jobRunDate) {
        ...
        String inputFile = batchFileDirectoryName + File.separator + LaborConstants.BatchFileSystem.SCRUBBER_ERROR_OUTPUT_FILE;
        String outputFile = batchFileDirectoryName + File.separator + LaborConstants.BatchFileSystem.SCRUBBER_ERROR_SORTED_FILE;
