        ...
        if (ObjectUtils.isNotNull(inactivatedAccount.getSubAccounts()) && !inactivatedAccount.getSubAccounts().isEmpty()) {
            for (Iterator<SubAccount> i = inactivatedAccount.getSubAccounts().iterator(); i.hasNext(); ) {
                ...
                if (subAccount.isActive()) {
                    ...
                    final String failedLockDocumentId = maintenanceDocumentService.getLockingDocumentId(subAccountMaintainable, documentNumber);
                    if (!StringUtils.isBlank(failedLockDocumentId)) {
                        ...
                        alreadyLockedSubAccounts.put(subAccount, failedLockDocumentId);
                    }
                    else {
