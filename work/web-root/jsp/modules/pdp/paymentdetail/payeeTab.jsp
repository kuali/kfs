				        ...
				        <tbody>
				          <tr>
				            ...
				            <td rowspan="4" align=left class="datacell">						
											<c:out value="${KualiForm.paymentDetail.paymentGroup.line1Address}"/><br>
											<c:out value="${KualiForm.paymentDetail.paymentGroup.line2Address}"/><br>
											<c:out value="${KualiForm.paymentDetail.paymentGroup.line3Address}"/><br>
											<c:out value="${KualiForm.paymentDetail.paymentGroup.line4Address}"/>
											&nbsp;
										</td>	
				          </tr>
				          <tr>
				            ...
				            <td class="datacell">
						          <c:if test="${(SecurityRecord.viewIdRole == true)}">
					              <c:out value="${KualiForm.paymentDetail.paymentGroup.alternatePayeeId}"/>&nbsp;
							        </c:if>
						          <c:if test="${(SecurityRecord.viewIdRole != true)}">
						          	<font color="#800000">
						          	<c:if test="${not empty KualiForm.paymentDetail.paymentGroup.alternatePayeeId}">
					              	*************
					              </c:if>&nbsp;
					              </font>
							        </c:if>
