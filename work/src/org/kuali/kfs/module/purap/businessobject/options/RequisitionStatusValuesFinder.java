...
public class RequisitionStatusValuesFinder extends KeyValuesBase {
    ...
    public List getKeyValues() {
        ...
        Collection<RequisitionStatus> statuses = boService.findAll(RequisitionStatus.class);
        List labels = new ArrayList();
        for (RequisitionStatus requisitionStatus : statuses) {
            if (requisitionStatus.isActive()) {
                labels.add(new KeyLabelPair(requisitionStatus.getStatusCode(), requisitionStatus.getStatusDescription()));
            }
        }
        return labels;
    }
