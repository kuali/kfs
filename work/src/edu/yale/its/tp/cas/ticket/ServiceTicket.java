...
public class ServiceTicket extends Ticket {
    ...
    /**
     * Returns true if this service ticket was generated in response to a dialogue with a user during which the user supplied
    ...
    /**
     * Returns true if it would be appropriate to confer access to the service returned by getService() at the present point in
