...
public enum AwardAccountFixture {
    ...
    private AwardAccountFixture(Long proposalNumber, String chartOfAccountsCode, String accountNumber, boolean finalBilled, Date currentLastBilledDate, Date previousLastBilledDate, KualiDecimal amountToDraw, boolean locReviewIndicator) {
