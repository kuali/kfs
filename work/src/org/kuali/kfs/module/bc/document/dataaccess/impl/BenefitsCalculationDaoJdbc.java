...
public class BenefitsCalculationDaoJdbc extends BudgetConstructionDaoJdbcBase implements BenefitsCalculationDao {
    ...
    /**
     * these two fields need to be passed in as parameters to the SQL, so they are wrapped as strings. we can't be sure what the
    ...
    public BenefitsCalculationDaoJdbc() {
        ...
        String budgetBalanceTypeCode = KFSConstants.BALANCE_TYPE_BASE_BUDGET;
        String defaultSubObjectCode = LABOR_LEDGER_PENDING_ENTRY_CODE.BLANK_SUB_OBJECT_CODE;
         ...
         */
        sqlBuilder.delete(0, sqlBuilder.length());
        sqlBuilder.append("INSERT INTO LD_BCN_BENEFITS_RECALC01_MT\n(SESID, POS_FRNGBEN_OBJ_CD, VER_NBR, FB_SUM)\n");
        sqlBuilder.append("(SELECT ?,LD_BENEFITS_CALC_T.POS_FRNGBEN_OBJ_CD, 1,\n");
