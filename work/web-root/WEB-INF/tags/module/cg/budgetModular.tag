...
<div align="right">
  	<kul:help documentTypeName="${DataDictionary.BudgetDocument.documentTypeName}" pageName="${CGConstants.MODULAR_HEADER_TAB}" altText="page help"/>
</div>
...
<div id="workarea">
	...
	<kul:tab 
		...
		<div class="tab-container-error"><div class="left-errmsg-tab"><cg:auditErrors cluster="modularSoftAuditErrors" keyMatch="document.budget.audit.modular.consortium*" isLink="false" includesTitle="true"/></div></div>
