 ...
 */
public class MassImportFileParserException extends RuntimeException {
     ...
     */
    public MassImportFileParserException(String message, String errorKey, String... errorParameters) {
        super(message);
