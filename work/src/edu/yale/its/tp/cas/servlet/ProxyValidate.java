...
/**
 * Handles PT validations and sub-PGT acquisitions for the Central Authentication Service. Subclassed (versus collapsed into
 * superclass) in order to provided rigid segmentation, at runtime, between caches, even though they share an implementation.
 */
public class ProxyValidate extends ServiceValidate {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        stCache = (ServiceTicketCache) config.getServletContext().getAttribute("ptCache");
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        /*
         * Interesting approach: if we have a service ticket (one that starts with "ST"), we forward to the actual serviceValidate
         * URL, which happens to be implemented by our superclass. Otherwise, we invoke the superclass directly, which lets
         * modifications we've made in init() take effect.
         */
