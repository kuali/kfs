 ...
 */
public class AwardFundManager implements ContractsAndGrantsFundManager, Inactivateable {
    ...
    public Person getFundManager() {
        fundManager = SpringContext.getBean(org.kuali.rice.kim.service.PersonService.class).updatePersonIfNecessary(principalId, fundManager);
        return fundManager;
    }
