...
@Transactional
public class AssetSegmentedLookupResultsServiceImpl extends LookupResultsServiceImpl implements AssetSegmentedLookupResultsService {

    private static final Log LOG = LogFactory.getLog(AssetSegmentedLookupResultsServiceImpl.class);
