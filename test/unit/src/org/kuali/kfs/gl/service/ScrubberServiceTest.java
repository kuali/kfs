...
public class ScrubberServiceTest extends OriginEntryTestBase {
    ...
    //
    // String[] convertedStringInput = new String[] {
    // "2004BA6044900-----7000---ACEECBCD PDNOCAPCB 00000214090047 EVERETT J PRESCOTT INC.
    // 1445.00D2006-01-05ACCDEFGHIJ----------12345678 ",
    // "2004BA6044900-----8000---ACASCBCD PDNOCAPCB 00000214090047 EVERETT J PRESCOTT INC.
    // 1445.00C2006-01-05ABCDEFGHIG----------12345679 "
    // };
    //
    // // Add inputs to expected output ...
    // Vector expectedOutput = new Vector();
    ...
    //
    // String[] convertedStringInput = new String[] {
    // "2004BA6044900-----7000---BBEE07CD PDNOCAPBB 00000214090047 EVERETT J PRESCOTT INC. 1445.00
    // 2006-01-05ACCDEFGHIJ----------12345678 ",
    // "2004BA6044900-----8000---BBAS07CD PDNOCAPBB 00000214090047 EVERETT J PRESCOTT INC. 1445.00
    // 2006-01-05ABCDEFGHIG----------12345679 "
    // };
    //
    // // Add inputs to expected output ...
    // Vector expectedOutput = new Vector();
    ...
    // new EntryHolder(OriginEntrySource.EXTERNAL,"2004BL2131401-----4100---ACEX07DI 01CLOSACT0100000Rite Quality Office Supplies
    // Inc. 94.35D2006-01-05 ---------- "),
    // new EntryHolder(OriginEntrySource.EXTERNAL,"2004BL2131401-----9041---ACLI07DI 01CLOSACT0100000Rite Quality Office Supplies
    // Inc. 94.35C2006-01-05 ---------- "),
    // new EntryHolder(OriginEntrySource.SCRUBBER_EXPIRED,"2004BL2131401-----4100---ACEX07DI 01CLOSACT0100000Rite Quality Office
    // Supplies Inc. 94.35D2006-01-05 ---------- "),
    // new EntryHolder(OriginEntrySource.SCRUBBER_ERROR,"2004BL2131401-----9041---ACLI07DI 01CLOSACT0100000Rite Quality Office
    // Supplies Inc. 94.35C2006-01-05 ---------- "),
    // new EntryHolder(OriginEntrySource.SCRUBBER_EXPIRED,"2004BL2131401-----4100---ACEX07DI 01CLOSACT0100000Rite Quality Office
    // Supplies Inc. 94.35D2006-01-05 ---------- "),
    // new EntryHolder(OriginEntrySource.SCRUBBER_ERROR,"2004BL2131401-----9041---ACLI07DI 01CLOSACT0100000Rite Quality Office
    // Supplies Inc. 94.35C2006-01-05 ---------- ")
    ...
    // // Inputs.
    // String[] stringInput = new String[] {
    // "2004BL1031467-----5300---ACEE07DD 01EXPRACT0112345214090047 EVERETT J PRESCOTT INC.
    // 1445.00D2006-01-05ABCDEFGHIJ----------12345678 ",
    // "2004BL1031467-----8000---ACAS07DD 01EXPRACT0112345214090047 EVERETT J PRESCOTT INC.
    // 1445.00C2006-01-05ABCDEFGHIG----------12345679 ",
    // };
    //
    // // Add inputs to expected output ...
    ...
    // // Inputs.
    // String[] stringInput = new String[] {
    // "2004BL1031467-----5300---ACEE07CD PDEXPIRACCT12345214090047 EVERETT J PRESCOTT INC.
    // 1445.00D2006-01-05ABCDEFGHIJ----------12345678 ",
    // "2004BL1031467-----8000---ACAS07CD PDEXPIRACCT12345214090047 EVERETT J PRESCOTT INC.
    // 1445.00C2006-01-05ABCDEFGHIG----------12345679 "
    // };
    //
    // // Add inputs to expected output ...
    ...
    public void dontRunTestInvalidReversalDate() throws Exception {
        ...
        String[] inputTransactions = { "2004BA6044913-----1470---ACIN07CR  01INVALREVD     Poplars Garage Fees                                 20.00D2006-01-05          ----------                       2005-02-30                                         ", "2004BA6044913-----8000---ACAS07CR  01INVALREVD     TP Generated Offset                                 20.00C2006-01-05          ----------                       2005-12-32                                         " };
    ...
    public void testInvalidOriginCode() throws Exception {
        String[] inputTransactions = { "2004BA9120656-----5000---ACEX07INV XXINVALORIG00000BALDWIN WALLACE COLLEGE                           3375.00C2006-01-05          ----------                                                                          ", "2004BA9120656-----8000---ACAS07INV EUINVALORIG00000TP Generated Offset                               3375.00D2006-01-05          ----------                                                                          " };
    ...
    public void testBlankOriginCode() throws Exception {
        ...
        String[] inputTransactions = { "2004BL2231411-----2400---ACEX07ST    BLANKORIG00000PAYROLL EXPENSE TRANSFERS                          620.00C2006-01-05          ----------                                                                          ", "2004BL2231411-----8000---ACAS07ST  01BLANKORIG00000PAYROLL EXPENSE TRANSFERS                          620.00D2006-01-05          ----------                                                                          " };

        String[] outputs = { "2004BL2231411-----2400---ACEX07ST    BLANKORIG00000PAYROLL EXPENSE TRANSFERS                          620.00C2006-01-05          ----------                                                                          ", "2004BL2231411-----8000---ACAS07ST  01BLANKORIG00000PAYROLL EXPENSE TRANSFERS                          620.00D2006-01-05          ----------                                                                          ", "2004BL2231411-----8000---ACAS07ST  01BLANKORIG00000GENERATED OFFSET                                   620.00C2006-02-21          ----------                                                                          " };

        EntryHolder[] outputTransactions = { new EntryHolder(OriginEntrySource.EXTERNAL, inputTransactions[0]), new EntryHolder(OriginEntrySource.EXTERNAL, inputTransactions[1]), new EntryHolder(OriginEntrySource.SCRUBBER_ERROR, outputs[0]), new EntryHolder(OriginEntrySource.SCRUBBER_VALID, outputs[1]), new EntryHolder(OriginEntrySource.SCRUBBER_VALID, outputs[2]) };
    ...
    public void testInvalidObjectType() throws Exception {
        String[] inputTransactions = { "2004BL1031467-----4100---ACXX07PO  LGINVALOBTY00000Rite Quality Office Supplies Inc.                   43.42D2006-01-05          ----------                                                                          ", "2004BL1031467-----9892---ACFB07PO  LGINVALOBTY00000Rite Quality Office Supplies Inc.                   43.42C2006-01-05          ----------                                                                          " };
    ...
    public void testBlankObjectCode() throws Exception {
        String[] inputTransactions = { "2004BL2231411-----    ---ACEX07ST  01BLANKOBJ 00000PAYROLL EXPENSE TRANSFERS                          620.00C2006-01-05          ----------                                                                          ", "2004BL2231411-----8000---ACAS07ST  01BLANKOBJ 00000PAYROLL EXPENSE TRANSFERS                          620.00D2006-01-05          ----------                                                                          " };
    ...
    public void dontRunTestDefaultFiscalYear() throws Exception {
        ...
        EntryHolder[] outputTransactions = { new EntryHolder(OriginEntrySource.EXTERNAL, inputTransactions[0]), new EntryHolder(OriginEntrySource.EXTERNAL, inputTransactions[1]), new EntryHolder(OriginEntrySource.SCRUBBER_VALID, "2004BA6044900-----5300---ACEE07CHKDPDBLANKFISC12345214090047 EVERETT J PRESCOTT INC.                 1445.00D2006-01-05ABCDEFGHIJ----------12345678                                                                  "), new EntryHolder(OriginEntrySource.SCRUBBER_VALID, "2004BA6044900-----8000---ACAS07CHKDPDBLANKFISC12345214090047 EVERETT J PRESCOTT INC.                 1445.00C2006-01-05ABCDEFGHIG----------12345678                                                                  ") };
