...
<div class="body">
	<c:if
		...
		<ul class="chan">
			<li><portal:portalLink displayTitle="true"
					...
					url="arCustomerStatement.do?methodToCall=start" />
			</li>
			<li><portal:portalLink displayTitle="true"
					title="Customer Aging Report"
					url="arCustomerAgingReportLookup.do?methodToCall=start&businessObjectClassName=org.kuali.kfs.module.ar.businessobject.CustomerAgingReportDetail" />
			</li>
			<li><portal:portalLink displayTitle="true"
					title="Customer Invoice"
					url="arCustomerInvoice.do?methodToCall=start" />
			</li>
			<li><portal:portalLink displayTitle="true"
					title="Federal Financial Report"
					url="arFederalFinancialReport.do?methodToCall=start" />
			</li>
			<li><portal:portalLink displayTitle="true"
					title="Invoice Report Delivery"
					url="arInvoiceReportDelivery.do?methodToCall=start" />
			</li>
		</ul>
	</c:if>
	<c:if
	...
	<c:if
		...
		<ul class="chan">
			<li><portal:portalLink displayTitle="true"
					title="Duplicate Certifications Report"
			...
			<li><portal:portalLink displayTitle="true"
					title="Effort Certification Extract Build"
			...
			<li><portal:portalLink displayTitle="true"
					title="Outstanding Certifications by Chart/Org/Report"
			...
			<li><portal:portalLink displayTitle="true"
					title="Outstanding Certifications By Report"
	...
	<c:if test="${ConfigProperties.module.endowment.enabled == 'true'}">
		<strong>Endowments</strong>
		</br>
		<ul class="chan">
			<li><portal:portalLink displayTitle="true"
					title="Asset Statement"
					url="reportEndowAssetStatement.do?methodToCall=start" />
			</li>
			<li><portal:portalLink displayTitle="true"
					title="Transaction Statement"
					url="reportEndowTransactionStatement.do?methodToCall=start" />
			</li>
			<li><portal:portalLink displayTitle="true"
					title="Transaction Summary"
					url="reportEndowTransactionSummary.do?methodToCall=start" />
			</li>
			<li><portal:portalLink displayTitle="true" title="Trial Balance"
					url="reportEndowTrialBalance.do?methodToCall=start" />
			</li>
		</ul>
	</c:if>
	<strong>System (PDF Samples Only)</strong></br>
	<ul class="chan">
		<li><a class="portal_link"
			href="http://kuali.org/kfs/fis-standard-reports/kuali_acct_labor_trans.pdf"
			title="Account Labor Transactions" target="_BLANK">Account Labor
				Transactions</a>
		</li>
		<li><a class="portal_link"
			href="http://kuali.org/kfs/fis-standard-reports/accountStatus.pdf"
			title="Account Status" target="_BLANK">Account Status</a>
		</li>
		<li><a class="portal_link"
			href="http://kuali.org/kfs/fis-standard-reports/accountTransactions.pdf"
			title="Account Transactions" target="_BLANK">Account Transactions</a>
		</li>
		<li><a class="portal_link"
			href="http://kuali.org/kfs/fis-standard-reports/consolidatedAccountStatus.pdf"
			title="Consolidated Account Status" target="_BLANK">Consolidated
				Account Status</a>
		</li>
		<li><a class="portal_link"
			href="http://kuali.org/kfs/fis-standard-reports/consolidatedStatus.pdf"
			title="Consolidated Status" target="_BLANK">Consolidated Status</a>
		</li>
		<li><a class="portal_link"
			href="http://kuali.org/kfs/fis-standard-reports/kuali_rvrsn_carryfwd_sum.pdf"
			title="Reversion and Carry Forward Summary" target="_BLANK">Reversion
				and Carry Forward Summary</a>
		</li>
		<li><a class="portal_link"
			href="http://kuali.org/kfs/fis-standard-reports/trialBalance.pdf"
			title="Trial Balance" target="_BLANK">Trial Balance</a>
		</li>
	</ul>
</div>
