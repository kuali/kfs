...
public class ItemTypeRule extends MaintenanceDocumentRuleBase {
    ...
    protected boolean checkForSystemParametersExistence() {
        ...
        List<String> cmAdditionalCharges = SpringContext.getBean(ParameterService.class).getParameterValues(CreditMemoDocument.class, PurapConstants.BELOW_THE_LINES_PARAMETER);
        ...
        List<String> cmAllowNegative = SpringContext.getBean(ParameterService.class).getParameterValues(CreditMemoDocument.class, PurapConstants.ITEM_ALLOWS_NEGATIVE);
        ...
        List<String> cmAllowPositive = SpringContext.getBean(ParameterService.class).getParameterValues(CreditMemoDocument.class, PurapConstants.ITEM_ALLOWS_POSITIVE);
        ...
        List<String> cmAllowZero = SpringContext.getBean(ParameterService.class).getParameterValues(CreditMemoDocument.class, PurapConstants.ITEM_ALLOWS_ZERO);
        ...
        List<String> cmRequireDescription = SpringContext.getBean(ParameterService.class).getParameterValues(CreditMemoDocument.class, PurapConstants.ITEM_REQUIRES_USER_ENTERED_DESCRIPTION);
