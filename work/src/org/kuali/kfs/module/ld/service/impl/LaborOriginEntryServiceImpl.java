...
public class LaborOriginEntryServiceImpl implements LaborOriginEntryService {
    ...
    //To use just one method for Poster --> should merge with OriginEntryDao.
     ...
     */
    public Iterator<LaborOriginEntry> getEntriesByGroup(OriginEntryGroup originEntryGroup) {
        LOG.debug("getEntriesByGroup() started");
        Iterator returnVal = laborOriginEntryDao.getLaborEntriesByGroup(originEntryGroup, originEntryDao.SORT_DOCUMENT);
