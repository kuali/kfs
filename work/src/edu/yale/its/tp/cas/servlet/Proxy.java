...
public class Proxy extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (request.getParameter("pgt") == null || request.getParameter("targetService") == null) {
                proxyFailure(out, INVALID_REQUEST, "'pgt' and 'targetService' parameters are both required");
            }
            else {
    ...
    protected void proxyFailure(PrintWriter out, String code, String errorMessage) throws IOException {
