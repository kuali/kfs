...
public class PendingLedgerEntryForTesting extends PendingLedgerEntry{
    ...
    public Map getPrimaryKeyMap() {
        ...
        primaryKeyMap.put(PropertyConstants.FINANCIAL_SYSTEM_ORIGINATION_CODE, this.getFinancialSystemOriginationCode());
        primaryKeyMap.put(PropertyConstants.DOCUMENT_NUMBER, this.getDocumentNumber());
        primaryKeyMap.put(PropertyConstants.TRANSACTION_ENTRY_SEQUENCE_NUMBER, this.getTransactionLedgerEntrySequenceNumber());
