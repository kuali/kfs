...
public class RequisitionRequiresAccountValidationBranchingValidation extends BranchingValidation {
    ...
    protected String determineBranch(AttributedDocumentEvent event) {
        if (!purapWorkflowIntegrationService.willDocumentStopAtGivenFutureRouteNode((PurchasingAccountsPayableDocument)event.getDocument(), NodeDetailEnum.CONTENT_REVIEW) ||
