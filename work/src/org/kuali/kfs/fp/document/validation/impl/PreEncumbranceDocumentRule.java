...
public class PreEncumbranceDocumentRule extends TransactionalDocumentRuleBase {
                                                               ...
                                                               GeneralLedgerPendingEntry offsetEntry)
    {
        ...
        OffsetDefinition offsetDefinition = SpringServiceLocator.getOffsetDefinitionService().getByPrimaryId(
            transactionalDocument.getPostingYear(), explicitEntry.getChartOfAccountsCode(),
