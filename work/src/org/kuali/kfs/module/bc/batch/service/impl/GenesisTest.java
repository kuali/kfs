...
public class GenesisTest {
    ...
    private static void configurationStep() {
        ...
        PropertyConfigurator.configure(ResourceBundle.getBundle("configuration").getString(KFSConstants.LOG4J_SETTINGS_FILE_KEY));
        ...
        SpringResourceLoader springResourceLoader = new SpringResourceLoader(dummyQName, "SpringBeans.xml");
        try {
        ...
        dateMakerTestService = SpringContext.getBean(DateMakerService.class);
    ...
    public static void main(String args[]) throws SQLException {
        ...
        /*
         * // genesisDao.createNewBCDocuments(2009); // LOG.info("\nDocument creation ended:
