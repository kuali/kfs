...
public class DisbursementVoucherAccountingLineValidation extends GenericValidation {
    ...
    public boolean validate(AttributedDocumentEvent event) {
        LOG.debug("validating accounting line # " + accountingLineForValidation.getSequenceNumber());
    ...
    public boolean validateAccountNumber(AccountingDocument financialDocument, AccountingLine accountingLine) {
        ...
        if (accountNumberAllowed) {
            ParameterEvaluator evaluator = parameterService.getParameterEvaluator(DisbursementVoucherDocument.class, DisbursementVoucherRuleConstants.FUNCTION_CODE_GLOBAL_RESTRICTION_PARM_NM, accountingLine.getAccount().getFinancialHigherEdFunctionCd());
