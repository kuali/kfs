...
public class SubObjectCodeImportLineObjectExistenceValidation extends GenericValidation {
    private static final Logger LOG = Logger.getLogger(SubObjectCodeImportLineObjectExistenceValidation.class);
    ...
    public boolean validate(AttributedDocumentEvent event) {
        ...
        valid &= checkRefObjectExistence(subObjectCdLine);
        valid &= checkAccountActive(subObjectCdLine);
        return valid;
    }

    protected boolean checkAccountActive(SubObjectCodeImportDetail subObjectCdLine) {
     ...
     * @return
     */
    protected boolean checkRefObjectExistence(SubObjectCodeImportDetail subObjectImpLine) {
        boolean valid = true;
