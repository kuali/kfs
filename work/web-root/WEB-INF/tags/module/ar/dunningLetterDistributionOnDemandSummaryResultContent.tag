...
<c:set var="dunningLetterDistributionOnDemandLookupResultAttributes" value="${DataDictionary.DunningLetterDistributionOnDemandLookupResult.attributes}" />
...
<div class="tab-container" align="center">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="datatable">
		...
		<logic:iterate id="invoices" name="KualiForm" property="${propertyName}.invoices" indexId="ctr">
			<ar:dunningLetterDistributionOnDemandSummarySubResult invoiceAttributes="${invoiceAttributes}" propertyName="${propertyName}.invoices[${ctr}]" />
		</logic:iterate>
	</table>
</div>
