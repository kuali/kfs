...
<c:set var="contractsGrantsInvoiceOnDemandLookupResultAttributes" value="${DataDictionary.ContractsGrantsInvoiceOnDemandLookupResult.attributes}" />
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="datatable">
		<thead>
			<tr>
				...
				<kul:htmlAttributeHeaderCell attributeEntry="${awardAttributes.contractGrantType}" useShortLabel="false" hideRequiredAsterisk="true" />
		...
		<logic:iterate id="awards" name="KualiForm" property="${propertyName}.awards" indexId="ctr">
			<ar:contractsGrantsInvoiceOnDemandSummarySubResult awardAttributes="${awardAttributes}" propertyName="${propertyName}.awards[${ctr}]" />
		</logic:iterate>
	</table>
</div>
