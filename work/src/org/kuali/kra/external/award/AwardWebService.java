...
public interface AwardWebService {
	...
	public AwardBillingUpdateStatusDto updateAwardBillingStatus(@WebParam(name="awardId") Long awardId,
			@WebParam(name="lastBilledDate") Date lastBilledDate,
			@WebParam(name="finalBill") Boolean finalBill);
}
