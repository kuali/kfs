                  ...
                  <tbody>
                    <tr>
                      <td width="100%" valign="top"><uportal_xhtml_fragment> </uportal_xhtml_fragment>
                        <iframe src="${channelUrl}" onload='javascript: setIframeHeight("iframeportlet", 600);' name="iframeportlet" id="iframeportlet" hspace="0" vspace="0" style="height: 600px;" title="E-Doc" frameborder="0" height="600" scrolling="auto" width="100%"></iframe>
                      </td>
                      <td>
