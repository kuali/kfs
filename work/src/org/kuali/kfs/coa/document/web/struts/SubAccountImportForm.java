 ...
 */
public class SubAccountImportForm extends MassImportTransactionalDocumentFormBase {

    private static final Logger Log = Logger.getLogger(SubAccountImportForm.class);
