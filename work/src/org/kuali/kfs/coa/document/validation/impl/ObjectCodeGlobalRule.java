...
public class ObjectCodeGlobalRule extends MaintenanceDocumentRuleBase {
    ...
    /**
     * 
     * This method checks that the reports to object code input on the top level of the
     * global document is valid for a given chart's reportToChart in the detail section
     * @param dtl
     * @return
     */
    ...
    /**
     * 
     * This method checks that the next year object code specified in the 
     * change document is a valid object code for a given chart and year
     * @param dtl
     * @return
     */
    ...
    /**
     * 
     * This method checks that the object level code from the object code change
     * document actually exists for the chart object specified in the detail
     * @param dtl
     * @return
     */
    ...
    protected boolean checkForObjectCodeGlobalDetails(List<ObjectCodeGlobalDetail> objectCodeGlobalDetails) {
        if(objectCodeGlobalDetails == null || objectCodeGlobalDetails.size() == 0) {
            putFieldError( KFSConstants.MAINTENANCE_ADD_PREFIX + KFSPropertyConstants.OBJECT_CODE_GLOBAL_DETAILS + "." + KFSPropertyConstants.FINANCIAL_DOCUMENT_TYPE_CODE, 
                    KFSKeyConstants.ERROR_DOCUMENT_GLOBAL_OBJECTMAINT_NO_CHART_FISCAL_YEAR);
            return false;
        }
        return true;
    }
