...
public class KFSPropertyConstants {
    ...
    public static final String ACTION_REQUESTED = KNSPropertyConstants.ACTION_REQUESTED;
    ...
    public static final String ACTIVE_INDICATOR = KNSPropertyConstants.ACTIVE_INDICATOR;
    public static final String AD_HOC_ROUTE_PERSONS = KNSPropertyConstants.AD_HOC_ROUTE_PERSONS;
    public static final String AD_HOC_ROUTE_WORKGROUPS = KNSPropertyConstants.AD_HOC_ROUTE_WORKGROUPS;
    ...
    public static final String ATTACHMENT = KNSPropertyConstants.ATTACHMENT;
    public static final String ATTRIBUTE_CONTROL_TYPE = KNSPropertyConstants.ATTRIBUTE_CONTROL_TYPE;
    public static final String ATTRIBUTE_DESCRIPTION = KNSPropertyConstants.ATTRIBUTE_DESCRIPTION;
    public static final String ATTRIBUTE_FORMATTER_CLASS_NAME = KNSPropertyConstants.ATTRIBUTE_FORMATTER_CLASS_NAME;
    public static final String ATTRIBUTE_ID = "attributeId";
    public static final String ATTRIBUTE_LABEL = KNSPropertyConstants.ATTRIBUTE_LABEL;
    public static final String ATTRIBUTE_MAX_LENGTH = KNSPropertyConstants.ATTRIBUTE_MAX_LENGTH;
    public static final String ATTRIBUTE_NAME = KNSPropertyConstants.ATTRIBUTE_NAME;
    public static final String ATTRIBUTE_SHORT_LABEL = KNSPropertyConstants.ATTRIBUTE_SHORT_LABEL;
    public static final String ATTRIBUTE_SUMMARY = KNSPropertyConstants.ATTRIBUTE_SUMMARY;
    public static final String ATTRIBUTE_VALIDATING_EXPRESSION = KNSPropertyConstants.ATTRIBUTE_VALIDATING_EXPRESSION;
    ...
    public static final String CAMPUS = KNSPropertyConstants.CAMPUS;
    ...
    public static final String CAMPUS_NAME = KNSPropertyConstants.CAMPUS_NAME;
    ...
    public static final String CONTINUATION_FIN_CHRT_OF_ACCT_CD = "continuationFinChrtOfAcctCd";
    ...
    public static final String CONTRACT_CONTROL_FIN_COA_CODE = "contractControlFinCoaCode";
    ...
    public static final String COST_SHARE_ACCOUNT = "costShareAccount";
    ...
    public static final String DISB_VCHR_REMIT_CITY_NAME = "disbVchrRemitCityName";
    public static final String DISB_VCHR_REMIT_COUNTRY_CODE = "disbVchrRemitCountryCode";
    public static final String DISB_VCHR_REMIT_LINE1_ADDR = "disbVchrRemitLine1Addr";
    public static final String DISB_VCHR_REMIT_LINE2_ADDR = "disbVchrRemitLine2Addr";
    public static final String DISB_VCHR_REMIT_PERSON_NAME = "disbVchrRemitPersonName";
    public static final String DISB_VCHR_REMIT_STATE_CODE = "disbVchrRemitStateCode";
    public static final String DISB_VCHR_REMIT_ZIP_CODE = "disbVchrRemitZipCode";
    ...
    public static final String DV_PAYEE_REVOLVING_FUND_CODE = "dvPayeeRevolvingFundCode";
    ...
    public static final String EXPLANATION = KNSPropertyConstants.EXPLANATION;
    ...
    public static final String GENERIC_DATE = KNSPropertyConstants.GENERIC_DATE;
    ...
    public static final String ID = KNSPropertyConstants.ID;
    ...
    public static final String INCOME_STREAM_FINANCIAL_COA_CODE = "incomeStreamFinancialCoaCode";
    ...
    public static final String INDIRECT_COST_RCVY_FIN_COA_CODE = "indirectCostRcvyFinCoaCode";
    ...
    public static final String INDIRECT_COST_RECOVERY_ACCT = "indirectCostRecoveryAcct";
    public static final String INDIRECT_COST_RECOVERY_ACCT_NBR = "indirectCostRecoveryAcctNbr";
    ...
    public static final String KUALI_USER_DEPT_ID = "deptid";
    public static final String KUALI_USER_EMPL_ID = "emplid";
    public static final String KUALI_USER_EMPLOYEE_STATUS_CODE = "employeeStatusCode";
    public static final String KUALI_USER_EMPLOYEE_TYPE_CODE = "employeeTypeCode";
    ...
    public static final String NOTE = KNSPropertyConstants.NOTE;
    ...
    public static final String OBJECT_ID = KNSPropertyConstants.OBJECT_ID;
    ...
    public static final String ONE_DIGIT_TEXT_CODE = KNSPropertyConstants.ONE_DIGIT_TEXT_CODE;
    ...
    public static final String UU_ID = KNSPropertyConstants.UU_ID;
