...
public class SubClassCodeServiceImpl implements SubClassCodeService {
    ...
    /**
     * @see org.kuali.kfs.module.endow.document.service.SubClassCodeService#getByPrimaryKey(java.lang.String)
     */
    public SubclassCode getByPrimaryKey(String code) {
        ...
        if (StringUtils.isNotBlank(code)) {
            ...
            subClassCode = (SubclassCode) businessObjectService.findByPrimaryKey(SubclassCode.class, criteria);
