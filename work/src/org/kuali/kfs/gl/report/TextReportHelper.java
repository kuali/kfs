...
public class TextReportHelper<C> {
    ...
    public TextReportHelper (String reportTitle, PrintStream ps, DateTimeService dateTimeService, C o) {
        //o parameter is only used to know which class we're dealing with, and if we could only do C.class it wouldn't be necessary at all
        super();
    ...
    public void writeErrors(C o, List<Message> errorMessages) {
        int messageNumber = 0;
