...
public interface AccountingLineRenderingService {
    ...
    /**
     * Returns the edit modes for the given document
     * @param accountingDocument the accounting document to fnd edit modes for
     * @return a Map of edit modes generated by the proper document authorizer
     */
    public abstract Map getEditModes(AccountingDocument accountingDocument);
