...
public class LaborParameterKeyConstants {

	//EreSweep
	public static final String FRINGE_SUB_FUND_GROUPS = "SUB_FUND_GROUPS";
	public static final String FRINGE_OBJECT_SUB_TYPES = "OBJECT_SUB_TYPES";
