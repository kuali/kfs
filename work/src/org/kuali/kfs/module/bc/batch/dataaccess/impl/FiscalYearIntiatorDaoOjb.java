...
public class FiscalYearIntiatorDaoOjb extends PlatformAwareDaoBaseOjb
implements FiscalYearInitiatorDao {
 ...
 */    
    ...
    private static Logger LOG = 
        org.apache.log4j.Logger.getLogger(FiscalYearIntiatorDaoOjb.class);
    ...
    {
        MakersMethods<AccountingPeriod> makersMethods = 
      ...
      Method fieldMethod = specialFieldsMethod("accountingPeriodSpecialFields",
                                               AccountingPeriod.class);  
      makersMethods.genericWarmAndFuzzy(AccountingPeriod.class,
                                        currentFiscalYear,fieldMethod);
    }
    ...
    InvocationTargetException, NoSuchMethodException
    {
      ...
      // a field change method with the standard signature  
        Method fieldMethod = specialFieldsMethod("accountingPeriodSpecialFields",
                AccountingPeriod.class);  
      makersMethods.genericSlashAndBurn(AccountingPeriod.class,
                                        currentFiscalYear,fieldMethod);
    }
    
    private void accountingPeriodSpecialFields(Integer currentFiscalYear,
    ...
    throws NoSuchFieldException, IllegalAccessException,
           InvocationTargetException, NoSuchMethodException
    {
        MakersMethods<BenefitsCalculation> makersMethods = 
            new MakersMethods<BenefitsCalculation>();
        makersMethods.genericWarmAndFuzzy(BenefitsCalculation.class,
                                          currentFiscalYear);
    }
    ...
    InvocationTargetException, NoSuchMethodException
    {
        MakersMethods<BenefitsCalculation> makersMethods = 
            new MakersMethods<BenefitsCalculation>();
        makersMethods.genericSlashAndBurn(BenefitsCalculation.class,
                                          currentFiscalYear);
    }
    ...
    InvocationTargetException, NoSuchMethodException
    {
        MakersMethods<LaborObject> makersMethods =
    ...
    InvocationTargetException, NoSuchMethodException
    {
        MakersMethods<ObjectCode> makersMethods =
            new MakersMethods<ObjectCode>();
        makersMethods.genericWarmAndFuzzy(ObjectCode.class,
                                          currentFiscalYear,
                                          objectCodeAdditionalCriteria());
    }
    ...
    InvocationTargetException, NoSuchMethodException
    {
        MakersMethods<ObjectCode> makersMethods =
            new MakersMethods<ObjectCode>();
        makersMethods.genericSlashAndBurn(ObjectCode.class,
                                          currentFiscalYear,
                                          objectCodeAdditionalCriteria());
    }
    ...
    InvocationTargetException, NoSuchMethodException
    {
      MakersMethods<OffsetDefinition> makersMethods =
          new MakersMethods<OffsetDefinition>();
      makersMethods.genericWarmAndFuzzy(OffsetDefinition.class,
                                        currentFiscalYear);
    }
    ...
    InvocationTargetException, NoSuchMethodException
    {
        MakersMethods<OffsetDefinition> makersMethods =
            new MakersMethods<OffsetDefinition>();
        makersMethods.genericSlashAndBurn(OffsetDefinition.class,
                                          currentFiscalYear);
    }
    ...
    InvocationTargetException, NoSuchMethodException
    {
        MakersMethods<Options> makersMethods = 
            new MakersMethods<Options>();
      // since we change fields other than the fiscal year, we have to pass in
      // a field change method with the standard signature  
        Method fieldMethod = specialFieldsMethod("optionsSpecialFields",
                Options.class);  
      makersMethods.genericWarmAndFuzzy(Options.class,
                                        currentFiscalYear,fieldMethod);
    }
    ...
    InvocationTargetException, NoSuchMethodException
    {
      ...
      // a field change method with the standard signature  
        Method fieldMethod = specialFieldsMethod("optionsSpecialFields",
                Options.class);  
      makersMethods.genericSlashAndBurn(Options.class,
                                        currentFiscalYear,fieldMethod);
    }
    
    private void optionsSpecialFields(Integer currentFiscalYear, Integer newFiscalYear,
    ...
    InvocationTargetException, NoSuchMethodException
    {
      ...
      MakersMethods<OrganizationReversion> makersMethods =
          new MakersMethods<OrganizationReversion>();
      makersMethods.genericWarmAndFuzzy(OrganizationReversion.class,
                                        baseYear);
    }
    ...
    InvocationTargetException, NoSuchMethodException
    {
        ...
        MakersMethods<OrganizationReversion> makersMethods =
            new MakersMethods<OrganizationReversion>();
        makersMethods.genericSlashAndBurn(OrganizationReversion.class,
                                          baseYear);
    }
    ...
    InvocationTargetException, NoSuchMethodException
    {
      MakersMethods<PositionObjectBenefit> makersMethods =
          new MakersMethods<PositionObjectBenefit>();
      makersMethods.genericWarmAndFuzzy(PositionObjectBenefit.class,
                                        currentFiscalYear);
    }
    ...
    InvocationTargetException, NoSuchMethodException
    {
        MakersMethods<PositionObjectBenefit> makersMethods =
            new MakersMethods<PositionObjectBenefit>();
        makersMethods.genericSlashAndBurn(PositionObjectBenefit.class,
                                          currentFiscalYear);
    }
    ...
    InvocationTargetException, NoSuchMethodException
    {
      MakersMethods<SubObjCd> makersMethods =
          new MakersMethods<SubObjCd>();
      makersMethods.genericWarmAndFuzzy(SubObjCd.class,
                                        currentFiscalYear);
    }
    ...
    InvocationTargetException, NoSuchMethodException
    {
        MakersMethods<SubObjCd> makersMethods =
            new MakersMethods<SubObjCd>();
        makersMethods.genericSlashAndBurn(SubObjCd.class,
                                          currentFiscalYear);
    }
    ...
    private Method specialFieldsMethod(String methodName, Class businessObject)
    throws NoSuchMethodException
    {
      ...
      // business object  
       ...
       Method sfMethod = this.getClass().getDeclaredMethod(methodName,
                                                  parmArray);
    ...
    private class MakersMethods<T> 
    {
        ...
        private void genericWarmAndFuzzy(Class ojbMappedClass,Integer currentFiscalYear)
        ...
        throws NoSuchFieldException, IllegalAccessException, InvocationTargetException
        {
            ...
            /* TODO:  the bean is not there yet
             * ParentKeyChecker<T> parentKeyChecker =
             *     new ParentKeyChecker<T>(newFiscalYear);
            */
            ...
            LOG.warn(String.format("\n%s:\n%d read = %d\n%d written = %d",
                    ojbMappedClass.getName(),
                    currentFiscalYear,rowsRead,newFiscalYear,rowsWritten));
            if (fieldMethod != null)
            {
        ...
        // which requires no special processing
        private void genericSlashAndBurn(Class ojbMappedClass, Integer currentFiscalYear)
        throws NoSuchFieldException, IllegalAccessException, InvocationTargetException,
               NoSuchMethodException
        {
            Method genericMethod = null;
...
//                   fieldMethod.invoke(this, args);
        ...
        throws NoSuchFieldException, IllegalAccessException
        {
            ...
            // set the fiscal year
            Field fld = 
                ourBO.getClass().getDeclaredField(KFSPropertyConstants.UNIVERSITY_FISCAL_YEAR);
            fld.setAccessible(true);
