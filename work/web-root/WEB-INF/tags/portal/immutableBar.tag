...
<%--
    ...
    <portal:portalLink displayTitle="false" title='Workflow Services' url='${ConfigProperties.workflow.url}/Portal.do?methodToCall=portal'>
		<img src="images-portal/icon-port-wfservices.gif" alt="workflow services" width="141" height="19" border="0">
	</portal:portalLink>
	-->
--%>
</div>
