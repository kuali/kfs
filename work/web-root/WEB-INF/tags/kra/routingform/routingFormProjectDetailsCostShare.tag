...
<kul:tabTop tabTitle="Cost Share" defaultOpen="false" tabErrorKey="${Constants.DOCUMENT_ERRORS}">
      ...
      <tr>
        ...
        <td class="infoline">
          <div align="center">
            ...
            <kul:lookup boClassName="org.kuali.module.chart.bo.Org" lookupParameters="newRoutingFormInstitutionCostShare.organizationCode:organizationCode,newRoutingFormInstitutionCostShare.chartOfAccountsCode:chartOfAccountsCode" fieldConversions="organizationCode:newRoutingFormInstitutionCostShare.organizationCode,chartOfAccountsCode:newRoutingFormInstitutionCostShare.chartOfAccountsCode" tabindexOverride="5100" anchor="${currentTabIndex}" />
          </div>
        </td>
        <td class="infoline">
          <div align="center">
      ...
      <tr>
        ...
        <td class="neutral">
          <div align="center">
            ...
            <kul:lookup boClassName="org.kuali.module.chart.bo.Org" lookupParameters="document.routingFormInstitutionCostShare[${status.index}].organizationCode:organizationCode,document.routingFormInstitutionCostShare[${status.index}].chartOfAccountsCode:chartOfAccountsCode" fieldConversions="organizationCode:document.routingFormInstitutionCostShare[${status.index}].organizationCode,chartOfAccountsCode:document.routingFormInstitutionCostShare[${status.index}].chartOfAccountsCode" tabindexOverride="5100" anchor="${currentTabIndex}" />
          </div>
        </td>
        <td class="neutral">
          <div align="center">
        ...
        <td class="neutral">
          <div align="center">
            ...
            <kul:lookup boClassName="org.kuali.module.chart.bo.Account" lookupParameters="document.routingFormInstitutionCostShare[${status.index}].accountNumber:accountNumber,document.routingFormInstitutionCostShare[${status.index}].chartOfAccountsCode:chartOfAccountsCode,document.routingFormInstitutionCostShare[${status.index}].organizationCode:organizationCode" fieldConversions="accountNumber:document.routingFormInstitutionCostShare[${status.index}].accountNumber,chartOfAccountsCode:document.routingFormInstitutionCostShare[${status.index}].chartOfAccountsCode,organizationCode:document.routingFormInstitutionCostShare[${status.index}].organizationCode" tabindexOverride="5100" anchor="${currentTabIndex}" />
          </div>
        </td>
        <td class="neutral">
          <div align="right">
            <kul:htmlControlAttribute property="document.routingFormInstitutionCostShare[${status.index}].routingFormCostShareAmount" attributeEntry="${institutionCostShareAttributes.routingFormCostShareAmount}" styleClass="amount" />
          </div>
        </td>
        <td class="neutral">
  ...
  <table cellpadding=0 cellspacing="0" summary="">
    ...
    <tr>
      ...
      <td colspan="2" class="infoline">
        <div align="right">
          <kul:htmlControlAttribute property="newRoutingFormOtherCostShare.routingFormCostShareAmount" attributeEntry="${otherCostShareAttributes.routingFormCostShareAmount}" styleClass="amount" />
        </div>
      </td>
      <td class="infoline">
        <div align=center>
    ...
    <c:forEach items="${KualiForm.document.routingFormOtherCostShares}" var="routingFormOtherCostShare" varStatus="status">
      <tr>
        ...
        <td colspan="2">
          <div align="right">
            <kul:htmlControlAttribute property="document.routingFormOtherCostShare[${status.index}].routingFormCostShareAmount" attributeEntry="${otherCostShareAttributes.routingFormCostShareAmount}" styleClass="amount" />
          </div>
        </td>
        <td>
          <div align=center>
