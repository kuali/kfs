...
build/project driectory and is named kuali-cas-1.0.0.war. There is a project 
...
There is also a sample web.xml named standalone-cas-web.xml that shows how to 
configure the CAS urls.
