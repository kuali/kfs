...
<div class="body">
	<ul class="chan">
		...
		<c:if
			test="${ConfigProperties['module.external.kuali.coeus.enabled'] == 'true'}">
			<li><portal:portalLink displayTitle="true"
					title="CG Account Default"
					url="kr/lookup.do?methodToCall=start&businessObjectClassName=org.kuali.kfs.module.external.kc.businessobject.AccountAutoCreateDefaults&docFormKey=88888888&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true" />
			</li>
		</c:if>
		<c:if
			...
			<li><portal:portalLink displayTitle="true" title="Agency"
			...
			<li><portal:portalLink displayTitle="true" title="Agency Type"
			...
			<li><portal:portalLink displayTitle="true"
					title="Award Auto Creation Default"
					url="kr/lookup.do?methodToCall=start&businessObjectClassName=org.kuali.kfs.module.cg.businessobject.AwardAutoCreateDefaults&docFormKey=88888888&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true" />
			</li>
			<li><portal:portalLink displayTitle="true" title="Award Status"
			...
			<li><portal:portalLink displayTitle="true" title="CFDA"
			...
			<li><portal:portalLink displayTitle="true" title="Proposal Type"
