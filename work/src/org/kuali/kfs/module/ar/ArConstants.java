...
public class ArConstants {
    ...
    public static final String GLPE_WRITEOFF_TAX_GENERATION_METHOD = "GLPE_WRITEOFF_TAX_GENERATION_METHOD";
    ...
    public static final String GLPE_WRITEOFF_TAX_GENERATION_METHOD_DISALLOW = "D";
