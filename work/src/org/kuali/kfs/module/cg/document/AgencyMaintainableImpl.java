...
public class AgencyMaintainableImpl extends FinancialSystemMaintainable {
    ...
    public void doRouteStatusChange(DocumentHeader header) {
        ...
        String description = SpringContext.getBean(KualiConfigurationService.class).getPropertyString(CREATED_BY_AGENCY_DOC);
    ...
    public void processAfterNew(MaintenanceDocument document, Map<String, String[]> parameters) {
        ...
        try {
            ...
            parameterAgencyFrequencyCode = SpringContext.getBean(ParameterService.class).getParameterValue(Agency.class, CGConstants.DEFAULT_PREFERRED_BILLING_FREQUENCY_PARAMETER);
            agency.setAgencyFrequencyCode(parameterAgencyFrequencyCode);
        }
        catch (Exception e) {
            LOG.debug("Exception : " + e.getMessage() + " happened when getting parameterAgencyFrequencyCode.  Set first value as default");
        }
