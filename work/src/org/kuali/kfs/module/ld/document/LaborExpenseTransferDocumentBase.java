 ...
 */
public abstract class LaborExpenseTransferDocumentBase extends GeneralLedgerPostingDocumentBase
    implements Copyable, Correctable, LaborExpenseTransferDocument, LaborLedgerPostingDocument {
    ...
    public ExpenseTransferSourceAccountingLine getExpenseTransferSourceAccountingLine(int index) {
        ...
        return (ExpenseTransferSourceAccountingLine) getSourceAccountingLines().get(index);
    }
    ...
    public ExpenseTransferTargetAccountingLine getExpenseTransferTargetAccountingLine(int index) {
        ...
        return (ExpenseTransferTargetAccountingLine) getTargetAccountingLines().get(index);
    }
