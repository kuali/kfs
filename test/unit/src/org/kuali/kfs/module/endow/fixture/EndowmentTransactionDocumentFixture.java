...
public enum EndowmentTransactionDocumentFixture {
    ...
    private EndowmentTransactionDocumentFixture(String documentNumber, 
                                                String transactionSubTypeCode, 
                                                String  transactionSourceTypeCode, 
     ...
     * @return endowmentTransactionDocument
     */
    public EndowmentTransactionalDocumentBase createEndowmentTransactionDocument(String documentNumber, 
                                                                                 String transactionSubTypeCode, 
                                                                                 String  transactionSourceTypeCode, 
                                                                                 boolean transactionPosted, 
                                                                                 String objectId, Long versionNumber) {
