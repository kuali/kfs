...
public class TransferOfFundsDocumentRuleTest
    ...
    private Integer _count0;
    private Integer _count1;
    ...
    /**
     * Count is an incremented fixture. It's used for sizes, counting, or
     * indexes. This is a count of '0'.
     *
     * @return Integer of 0
     * @see TransactionalDocumentRuleTestBase#getCount0
     */
    public final Integer getCount0() {
        return _count0;
    }

    /**
     * Accessor method for count0 fixture.
     *
     * @param c <code>{@link Integer}</code> to set fixture to.
     */
    public final void setCount0( Integer c ) {
        _count0 = c;
    }

    /**
     * Count is an incremented fixture. It's used for sizes, counting, or
     * indexes. This is a count of '1'.
     *
     * @return Integer of 1
     * @see TransactionalDocumentRuleTestBase#getCount0
     */
    ...
    /**
     * Accessor method for count1 fixture.
     *
     * @param c <code>{@link Integer}</code> to set fixture to.
     */
    public final void setCount1( Integer c ) {
        _count1 = c;
    }

    /**
     * Count is an incremented fixture. It's used for sizes, counting, or
     * indexes. This is a count of '2'.
     *
     * @return Integer of 2
     * @see TransactionalDocumentRuleTestBase#getCount2
     */
    ...
    /**
     * Accessor method for count2 fixture.
     *
     * @param c <code>{@link Integer}</code> to set fixture to.
     */
    public final void setCount2( Integer c ) {
        _count2 = c;
    }
