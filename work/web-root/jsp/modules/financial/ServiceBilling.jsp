...
<kul:documentPage showDocumentInfo="true" documentTypeName="KualiServiceBillingDocument" htmlFormAction="financialServiceBilling" renderMultipart="true" showTabButtons="true">
