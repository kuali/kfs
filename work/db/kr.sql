...
ALTER TABLE KRIM_ENTITY_ETHNIC_T 
	ADD CONSTRAINT KRIM_ENTITY_ETHNIC_TC0 UNIQUE (OBJ_ID)
/
ALTER TABLE KRIM_ENTITY_ETHNIC_T
    ADD CONSTRAINT KRIM_ENTITY_ETHNIC_TP1 PRIMARY KEY (ID)
/
...
ALTER TABLE KRIM_ENTITY_RESIDENCY_T
    ADD CONSTRAINT KRIM_ENTITY_RESIDENCY_TC0 UNIQUE (OBJ_ID)
/
ALTER TABLE KRIM_ENTITY_RESIDENCY_T
...
ALTER TABLE KRIM_ENTITY_VISA_T
    ADD CONSTRAINT KRIM_ENTITY_VISA_TC0 UNIQUE (OBJ_ID)
/
ALTER TABLE KRIM_ENTITY_VISA_T
