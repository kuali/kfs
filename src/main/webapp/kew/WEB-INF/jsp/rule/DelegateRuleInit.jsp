...
<kul:page headerTitle="Delegate Routing Rule" transactionalDocument="false" showDocumentInfo="false" htmlFormAction="DelegateRule" docTitle="Delegate Routing Rule Creation">

	<kew:delegateRuleInit />
