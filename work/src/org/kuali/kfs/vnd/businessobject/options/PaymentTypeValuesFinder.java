...
/**
 * Values finder for <code>PaymentTermsType</code>.
 * Similar to <code>PaymentTermsValuesFinder</code>, except that the list of <code>KeyValuePair</code>s 
 * returned by this class' <code>getKeyValues()</code> method are a description and a description, rather 
 * than a code and a description. That method's signature needs to stay the same to satisfy the 
