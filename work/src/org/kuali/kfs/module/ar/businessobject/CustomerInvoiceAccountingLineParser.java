...
public class CustomerInvoiceAccountingLineParser extends AccountingLineParserBase {
    ...
    private static final String[] CUSTOMER_INVOICE_ACCOUNTING_LINE = { CHART_OF_ACCOUNTS_CODE, ACCOUNT_NUMBER, SUB_ACCOUNT_NUMBER, FINANCIAL_OBJECT_CODE, FINANCIAL_SUB_OBJECT_CODE, PROJECT_CODE, ORGANIZATION_REFERENCE_ID, AMOUNT, INVOICE_ITEM_CODE, INVOICE_ITEM_QUANTITY, INVOICE_ITEM_DESCRIPTION, INVOICE_ITEM_SERVICE_DATE, UNIT_OF_MEASURE_CODE, INVOICE_ITEM_UNIT_PRICE, INVOICE_ITEM_TAXABLE_INDICATOR };
    ...
    public String[] getSourceAccountingLineFormat() {
        return CUSTOMER_INVOICE_ACCOUNTING_LINE;
    }
