...
/**
 * SelectSystem Purap Rule Interface
 ...
 */
public interface SelectSystemPurapRule {
    
    /**
     * Checks the rules that are applicable to the SelectSystem Event on a Transactional Document
     * 
