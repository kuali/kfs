...
public class VendorCreditMemoNewIndividualItemValidation extends PurchasingAccountsPayableNewIndividualItemValidation {
    ...
    public boolean validate(AttributedDocumentEvent event) {
        ...
        if (cmItem.getItemType().isLineItemIndicator()) {
            String errorKeyPrefix = KFSPropertyConstants.DOCUMENT + "." + PurapPropertyConstants.ITEM + "[" + Integer.toString(0) + "].";
