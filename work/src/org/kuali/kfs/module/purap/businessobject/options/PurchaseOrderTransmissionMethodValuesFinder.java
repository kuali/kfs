...
public class PurchaseOrderTransmissionMethodValuesFinder extends KeyValuesBase {
    ...
    public List getKeyValues() {
        ...
        for (Iterator iter = codes.iterator(); iter.hasNext();) {
            PurchaseOrderTransmissionMethod transmissionMethod = (PurchaseOrderTransmissionMethod) iter.next();
            labels.add(new KeyLabelPair(transmissionMethod.getPurchaseOrderTransmissionMethodCode(), transmissionMethod.getPurchaseOrderTransmissionMethodDescription()));
        }
