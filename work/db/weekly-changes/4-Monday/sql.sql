...
'CONFG', '10',
'Total number of failures to print on the report for each category of balancing failures on the balancing batch job. This is used for laborBalancingStep.',
'A'
FROM dual)
;
insert into krns_parm_t
...
'NUMBER_OF_COMPARISON_FAILURES_TO_PRINT_PER_REPORT', sys_guid(),1,
'CONFG', '10',
'Total number of failures to print on the report for each category of balancing failures on the balancing batch job. This is used for posterBalancingStep.',
'A'
FROM dual)
;
