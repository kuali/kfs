...
/**
 * Fixture class for AwardInvoiceAccount
 */
public enum AwardInvoiceAccountFixture {

    AWD_INV_ACCT_1(new Long(111), "BL", SpringContext.getBean(UniversityDateService.class).getCurrentFiscalYear(), "1031400", "5000", null, null, CGPropertyConstants.INCOME_ACCOUNT);
    ...
    private AwardInvoiceAccountFixture(Long proposalNumber, String chartOfAccountsCode, Integer universityFiscalYear, String accountNumber, String objectCode, String subObjectCode, String subAccountNumber, String accountType) {
