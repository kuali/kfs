...
public class MilestoneScheduleRuleUtil {
    ...
    public static boolean checkIfMilestonesExists(MilestoneSchedule milestoneSchedule) {
        ...
        MilestoneSchedule result = (MilestoneSchedule) SpringContext.getBean(BusinessObjectService.class).findBySinglePrimaryKey(MilestoneSchedule.class, milestoneSchedule.getProposalNumber());
