...
public class PaymentDetailSearchForm extends ActionForm {
    ...
    public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
        ...
        if (buttonPressed.startsWith("btnSearch")) {
            if ((GeneralUtilities.isStringEmpty(this.custPaymentDocNbr)) && (GeneralUtilities.isStringEmpty(this.invoiceNbr)) && (GeneralUtilities.isStringEmpty(this.purchaseOrderNbr)) && (GeneralUtilities.isStringEmpty(this.processId)) && (GeneralUtilities.isStringEmpty(this.paymentId)) && (GeneralUtilities.isStringEmpty(this.payeeName)) && (GeneralUtilities.isStringEmpty(this.payeeId)) && (GeneralUtilities.isStringEmpty(this.payeeIdTypeCd)) && (GeneralUtilities.isStringEmpty(this.disbursementTypeCode)) && (GeneralUtilities.isStringEmpty(this.paymentStatusCode)) && (GeneralUtilities.isStringEmpty(this.netPaymentAmount)) && (GeneralUtilities.isStringEmpty(this.beginDisbursementDate)) && (GeneralUtilities.isStringEmpty(this.endDisbursementDate)) && (GeneralUtilities.isStringEmpty(this.beginPaymentDate)) && (GeneralUtilities.isStringEmpty(this.endPaymentDate)) && (GeneralUtilities.isStringEmpty(this.disbursementNbr)) && (GeneralUtilities.isStringEmpty(this.chartCode))
                    && (GeneralUtilities.isStringEmpty(this.orgCode)) && (GeneralUtilities.isStringEmpty(this.subUnitCode)) && (GeneralUtilities.isStringEmpty(this.requisitionNbr)) && (GeneralUtilities.isStringEmpty(this.customerInstitutionNumber)) && (GeneralUtilities.isStringEmpty(this.pymtAttachment)) && (GeneralUtilities.isStringEmpty(this.processImmediate)) && (GeneralUtilities.isStringEmpty(this.pymtSpecialHandling))) {
                ...
                if ((!(GeneralUtilities.isStringEmpty(this.disbursementNbr))) && (!(GeneralUtilities.isStringAllNumbers(this.disbursementNbr)))) {
                    actionErrors.add("errors", new ActionMessage("paymentDetailSearchForm.disbursementNbr.invalid"));
                }
                if ((!(GeneralUtilities.isStringEmpty(this.processId))) && (!(GeneralUtilities.isStringAllNumbers(this.processId)))) {
                    actionErrors.add("errors", new ActionMessage("paymentDetailSearchForm.processId.invalid"));
                }
                if ((!(GeneralUtilities.isStringEmpty(this.paymentId))) && (!(GeneralUtilities.isStringAllNumbers(this.paymentId)))) {
                    actionErrors.add("errors", new ActionMessage("paymentDetailSearchForm.paymentId.invalid"));
                }
                if ((!(GeneralUtilities.isStringEmpty(this.netPaymentAmount))) && (!(GeneralUtilities.isStringAllNumbersOrASingleCharacter(this.netPaymentAmount, '.')))) {
                    actionErrors.add("errors", new ActionMessage("paymentDetailSearchForm.netPaymentAmount.invalid"));
                }
                if ((!(GeneralUtilities.isStringEmpty(this.payeeId))) && (GeneralUtilities.isStringEmpty(this.payeeIdTypeCd))) {
