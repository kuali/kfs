...
<div align="right">
	<kul:help documentTypeName="${DataDictionary.BudgetDocument.documentTypeName}" pageName="${CGConstants.OUTPUT_HEADER_TAB}" altText="page help"/>
</div>
...
<div id="workarea" >
      ...
      <div id="globalbuttons" class="globalbuttons">
        <html:image src="${ConfigProperties.externalizable.images.url}buttonsmall_genpdf.gif" styleClass="globalbuttons" property="methodToCall.pdfOutput" title="Copy current document" alt="Copy current document" onclick="excludeSubmitRestriction=true"/>
      </div>
