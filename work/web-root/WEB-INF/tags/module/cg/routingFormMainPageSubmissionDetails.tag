...
<kul:tab tabTitle="Submission Details" defaultOpen="true" tabErrorKey="document.contractGrantProposal*,document.projectAbstract,document.routingFormProjectTitle,document.routingFormLayDescription,document.routingFormBudget*" auditCluster="mainPageAuditErrors" tabAuditKey="document.routingFormBudget*,document.previousFederalIdentifier,document.routingFormPurposeCode,document.researchTypeCode,document.routingFormOtherPurposeDescription,document.routingFormProjectTitle,document.routingFormLayDescription,document.projectAbstract,document.routingFormProjectTypes*,document.projectTypeOtherDescription,document.routingFormPriorGrantNumber,document.grantNumber">
	<div class="tab-container-error"><div class="left-errmsg-tab"><cg:auditErrors cluster="mainPageAuditErrors" keyMatch="document.routingFormBudget*,document.previousFederalIdentifier,document.routingFormPurposeCode,document.researchTypeCode,document.routingFormOtherPurposeDescription,document.routingFormProjectTitle,document.routingFormLayDescription,document.projectAbstract,document.routingFormProjectTypes*,document.projectTypeOtherDescription,document.routingFormPriorGrantNumber,document.grantNumber" isLink="false" includesTitle="true"/></div></div>
                    ...
                    <tr>
                      <c:if test="${fn:length(KualiForm.document.routingFormProjectTypes) != 0}">
				        <td class="nobord" width="50%" valign="top">
					      <cg:routingFormMainPageSubmissionDetailsProjectTypes begin="0" end="${KualiForm.routingFormProjectTypesSizeByTwoColumns}"/>
                        </td>
					    <td class="nobord" width="50%" valign="top">
					      <cg:routingFormMainPageSubmissionDetailsProjectTypes begin="${KualiForm.routingFormProjectTypesSizeByTwoColumns + 1}" end="${fn:length(KualiForm.document.routingFormProjectTypes)}"/>
                        </td>
                      </c:if>
                    </tr>
				  </table>
              ...
              <tr>
                ...
                <td colspan="3" align=left valign=middle nowrap >
		            ...
		            <table cellpadding="0" cellspacing="0" class="nobord">
					  ...
					  <tr>
		                <td class="nobord"> <div align="left">
		               		 ${KualiForm.document.routingFormKeywords[status.index].routingFormKeywordDescription} 
		                </div></td>
		                <td class="nobord"><div align="center">
		                  <c:if test="${!viewOnly}">
