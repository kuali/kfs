...
public class ReferralToCollectionsLookupResultInquirableImpl extends KfsInquirableImpl {
    ...
    public HtmlData getInquiryUrl(BusinessObject businessObject, String attributeName) {
        ...
        if (KFSPropertyConstants.PROPOSAL_NUMBER.equals(attributeName)) {
            ...
            inquiryHref.setHref("kr/inquiry.do?businessObjectClassName=org.kuali.kfs.integration.cg.ContractsAndGrantsBillingAward&proposalNumber=" + ObjectUtils.getPropertyValue((ReferralToCollectionsLookupResult) businessObject, attributeName) + "&methodToCall=start");
        }
