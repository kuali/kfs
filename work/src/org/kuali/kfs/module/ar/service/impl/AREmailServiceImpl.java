...
public class AREmailServiceImpl extends DefaultEmailService implements AREmailService {
    ...
    public void sendInvoicesViaEmail(List<ContractsGrantsInvoiceDocument> invoices) throws AddressException, MessagingException {
        ...
        for (ContractsGrantsInvoiceDocument invoice : invoices) {
            ...
            for (InvoiceAgencyAddressDetail agencyAddress : agencyAddresses) {
                if (ArConstants.InvoiceIndicator.EMAIL.equals(agencyAddress.getPreferredInvoiceIndicatorCode())) {
                    ...
                    if (ObjectUtils.isNotNull(note)) {
                        ...
                        // From Address
                        String sender = KNSServiceLocator.getParameterService().getParameterValue(ContractsGrantsInvoiceEmailReportsBatchStep.class, ArConstants.CG_INVOICE_FROM_EMAIL_ADDRESS);
                        ...
                        // The Subject
                        String subject = KNSServiceLocator.getParameterService().getParameterValue(ContractsGrantsInvoiceEmailReportsBatchStep.class, ArConstants.CG_INVOICE_EMAIL_SUBJECT);
                        String bodyText = KNSServiceLocator.getParameterService().getParameterValue(ContractsGrantsInvoiceEmailReportsBatchStep.class, ArConstants.CG_INVOICE_EMAIL_BODY);
            ...
            invoice.setMarkedForProcessing(false);
    ...
    private void getEmailParameterList(Map<String, String> primaryKeys, ContractsGrantsInvoiceDocument invoice, ContractsAndGrantsAgencyAddress agencyAddress) {
        ...
        key.put("organizationCode", orgCode[0].trim());
        key.put("chartOfAccountsCode", orgCode[1].trim());
