...
/**
 * Generates a poster balancing report if data is present in the GL history tables. Instructions on how to test this process:
 * - Place an acceptable GL_SORTPOST.data into batchFileDirectoryName (see spring-ld.xml)<br>
 * - Run BatchStepRunner for posterEntriesStep<br>
 * - Run BatchStepRunner for posterBalancingStep<br>
 * - Evaluate PosterBalancingServiceImpl.BALANCING_FILENAME in KFSConstants.REPORTS_DIRECTORY_KEY for results<br>
 */
