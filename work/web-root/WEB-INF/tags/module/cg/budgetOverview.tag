...
<div align="right">
  ...
  <cg:budgetDetailSelection includeSummary="true" />
        ...
        <div align="center">
          ...
          <div class="tab-container" align="center">
            <table class="datatable" cellpadding="0" cellspacing="0">
              ...
              <!-- Defined here because can't pass a fmt:formatNumber to cg:budgetExpensesRow -->
              ...
              <cg:budgetExpensesRow tabTitle="Personnel - Salary" defaultOpen="false" amountRequested="${personnelSalaryAgencyRequest}" institutionCostShare="${personnelSalaryInstitutionCostShare}" thirdPartyCostShare="--">
                <tr>
              ...
              </cg:budgetExpensesRow>

              <cg:budgetExpensesRow tabTitle="Personnel - Fringe Benefits" defaultOpen="false" amountRequested="${personnelFringeBenefitsAgencyRequest}" institutionCostShare="${personnelFringeBenefitsInstitutionCostShare}" thirdPartyCostShare="--">
                <tr>
              ...
              <logic:iterate id="nonpersonnelCategory" name="KualiForm" property="nonpersonnelCategories" indexId="i">
                  ...
                  <cg:budgetExpensesRow tabTitle="${nonpersonnelCategory.name}" defaultOpen="false" amountRequested="${nonpersonnelAmountRequested}" institutionCostShare="${nonpersonnelInstitutionCostShare}" thirdPartyCostShare="${nonpersonnelThirdPartyCostShare}">
