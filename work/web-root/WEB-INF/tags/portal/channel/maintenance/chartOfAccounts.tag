...
<div class="body">
    <ul class="chan">
		...
		<li><portal:portalLink displayTitle="true" title="Indirect Cost Recovery Rate Detail" url="kr/lookup.do?methodToCall=start&businessObjectClassName=org.kuali.kfs.coa.businessobject.IndirectCostRecoveryRateDetail&docFormKey=88888888&returnLocation=${application.url}/portal.do&hideReturnLink=true" /></li>
		...
		<li><portal:portalLink displayTitle="true" title="Indirect Cost Recovery Exclusion By Type" url="kr/lookup.do?methodToCall=start&businessObjectClassName=org.kuali.kfs.coa.businessobject.IndirectCostRecoveryExclusionType&docFormKey=88888888&returnLocation=${application.url}/portal.do&hideReturnLink=true" /></li>
