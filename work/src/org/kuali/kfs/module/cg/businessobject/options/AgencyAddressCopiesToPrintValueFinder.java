...
public class AgencyAddressCopiesToPrintValueFinder implements ValueFinder {
    ...
    public String getValue() {
        String nbrOfCopiesToPrint = SpringContext.getBean(ParameterService.class).getParameterValue(AgencyAddress.class, CGConstants.DEFAULT_NUMBER_OF_COPIES_TO_PRINT);
