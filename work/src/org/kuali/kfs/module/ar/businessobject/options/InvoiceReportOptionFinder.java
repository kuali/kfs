...
public class InvoiceReportOptionFinder extends KeyValuesBase implements ValueFinder {
    ...
    public List getKeyValues() {
        ...
        labels.add(new KeyLabelPair(ArConstants.OUTSTANDING_INVOICES, ArConstants.OUTSTANDING_INVOICES));
        labels.add(new KeyLabelPair(ArConstants.PAST_DUE_INVOICES, ArConstants.PAST_DUE_INVOICES));
