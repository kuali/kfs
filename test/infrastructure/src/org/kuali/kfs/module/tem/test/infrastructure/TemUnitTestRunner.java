 ...
 */
public class TemUnitTestRunner extends BlockJUnit4ClassRunner {
    private static boolean listenerAdded = false;

    /**
     * Constructs a TemUnitTestRunner to run <code>klass</code>.
     * 
     * @see org.junit.runners.BlockJUnit4ClassRunner#BlockJUnit4ClassRunner(java.lang.Class)
     */
    public TemUnitTestRunner(Class<?> klass) throws InitializationError {
        super(klass);
    }

    /**
     * Overridden to call setMethod if test class is implementer of <code>TemUnitTestMethodAware</code>
     * 
    ...
    protected Statement methodInvoker(FrameworkMethod method, Object test) {
        if (test instanceof TemUnitTestMethodAware) {
            ((TemUnitTestMethodAware) test).setTestMethod(method.getMethod());
        }
    ...
    public void run(RunNotifier notifier) {
        if (!listenerAdded) {
            notifier.addListener(TemUnitTestBase.getRunListener());
            listenerAdded = true;
        }
        super.run(notifier);
    }
