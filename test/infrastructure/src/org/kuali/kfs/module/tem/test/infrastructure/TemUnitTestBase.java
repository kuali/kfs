...
import org.kuali.kfs.module.tem.test.infrastructure.lifecycle.TemUnitTestMainLifecycle;
 ...
 */
@RunWith(TemUnitTestRunner.class)
public class TemUnitTestBase extends Assert implements TemUnitTestMethodAware {
    // non static Log to allow it to be named after the runtime class
    protected final Log LOG = LogFactory.getLog(this.getClass());

    private static TemUnitTestMainLifecycle LIFECYCLE = new TemUnitTestMainLifecycle();
