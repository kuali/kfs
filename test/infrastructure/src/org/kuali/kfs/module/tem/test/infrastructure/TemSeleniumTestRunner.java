...
public class TemSeleniumTestRunner extends TemUnitTestRunner {
    
    private static boolean listenerAdded = false;

    public TemSeleniumTestRunner(Class<?> klass) throws InitializationError {
        super(klass);
    }
    ...
    public void run(RunNotifier notifier) {
        if (!listenerAdded) {
            notifier.addListener(TemSeleniumTestBase.getRunListener());
            listenerAdded = true;
        }
        super.run(notifier);
    }
    ...
    public static void main(String ... args) {
        // org.junit.runner.JUnitCore.runClasses(org.kuali.kfs.module.tem.selenium.TravelReimbursementDocumentTest.class);
    }
