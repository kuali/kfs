...
public class CGConstants extends JSTLConstants {
    ...
    public static final String BUDGET_COST_SHARE_PERMISSION_CODE = "COST_SHARE_PERMISSION";
    ...
    public static final String GRADUATE_ASSISTANT_NONPERSONNEL_SUB_CATEGORY_CODE = "GRADUATE_ASSISTANT_NONPERSONNEL_SUB_CATEGORY";
    public static final String GRADUATE_ASSISTANT_NONPERSONNEL_CATEGORY_CODE = "GRADUATE_ASSISTANT_NONPERSONNEL_CATEGORY";

    public static final String KRA_BUDGET_INDIRECT_COST_PROVIDED_SYSTEM = "INDIRECT_COST_PROVIDED_SYSTEM";
    public static final String KRA_BUDGET_INDIRECT_COST_PROVIDED_MANUALLY = "INDIRECT_COST_PROVIDE_MANUALLY";
