        ...
        <%-- If PO available, display the delivery information from the PO --%>
        	<c:if test="${isPOAvailable}">
	            ...
	            <tr>
	                ...
	                <td align=left valign=middle class="datacell">
	                    <kul:htmlControlAttribute attributeEntry="${documentAttributes.deliveryCampusName}" property="document.deliveryCampus.campus.campusName" readOnly="true" />
               	 	</td>
	            </tr>
	            <tr>
        			<th align=left valign=middle class="bord-l-b">
        	...
        	<c:if test="${!isPOAvailable}">
				...
				<tr>
                	...
                	<td align=left valign=middle class="datacell">
	                    ...
	                    <c:if test="${(fullEntryMode)}" >
	                        <kul:lookup boClassName="org.kuali.rice.kim.bo.Person" fieldConversions="name:document.institutionContactName,phoneNumber:document.institutionContactPhoneNumber,emailAddress:document.institutionContactEmailAddress" />
	                    </c:if>
                	</td>
                	<th align=right valign=middle class="bord-l-b" rowspan="4">
	                    <div align="right"><kul:htmlAttributeLabel attributeEntry="${documentAttributes.deliveryAdditionalInstructionText}"/></div>
