...
public class KEMIDHistoricalBalanceDetailInquirable extends KfsInquirableImpl {
    ...
    public HtmlData getInquiryUrl(BusinessObject businessObject, String attributeName, boolean forceInquiry) {
        ...
        if ((isIncome && isIncomeNotNullOrZero) || (isPrincipal && isPrincipalNotNullOrZero)) {
            ...
            params.put(EndowPropertyConstants.KEMID_HIST_BAL_DET_KEMID_CLOSED_INDICATOR, historicalBalanceDetail.getKemidObj().isClosedIndicator() ? "Yes" : "No");
            ...
            fieldList.put(EndowPropertyConstants.KEMID_HIST_BAL_DET_KEMID_CLOSED_INDICATOR, historicalBalanceDetail.getKemidObj().isClosedIndicator() ? "Yes" : "No");
