...
public class PurgeSufficientFundBalancesStep extends AbstractStep {
    ...
    public boolean execute(String jobName) {
        String yearStr = getConfigurationService().getParameterValue(KFSConstants.GL_NAMESPACE, GLConstants.Components.PURGE_SUFFICIENT_FUND_BALANCES_STEP, KFSConstants.SystemGroupParameterNames.PURGE_GL_SF_BALANCES_T_BEFORE_YEAR);
