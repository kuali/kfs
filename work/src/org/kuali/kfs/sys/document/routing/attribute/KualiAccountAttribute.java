...
public class KualiAccountAttribute implements RoleAttribute, WorkflowAttribute {
    ...
    /**
     * This method will build a string representation of a qualified account role a qualified account role is the role, with the corresponding string values that further qualify the role to apply for a given account.
     * 
     * @param roleName
     * @param chart
     * @param account
    ...
    /**
     * This should be a mapping between the FIS document type and the Workflow document type, and should give back the FIS document type name so that we can lookup delegations based on the FIS name instead of the workflow name.
     * 
