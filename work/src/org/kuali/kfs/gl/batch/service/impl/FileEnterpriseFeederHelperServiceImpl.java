 ...
 * 
 * Note: this class is marked as transactional.  Using this class from a class not annotated as {@link Transactional}
 * allows the implementation of a transaction per file.  That is, every time the feedOnFile method is called, a new transaction
 * is created, and is committed or rolled back depending on whether the upload was successful.
 * 
...
public class FileEnterpriseFeederHelperServiceImpl implements FileEnterpriseFeederHelperService {
    ...
    /**
     * This method does the reading and the loading of reconciliation.  Read class description.
     * 
     ...
     * @param reconFile a URL to the reconciliation file.  See the implementation of {@link ReconciliationParserService} for file format.
     ...
     * @see org.kuali.module.gl.service.impl.FileEnterpriseFeederHelperService#feedOnFile(java.io.File, java.io.File, java.io.File, org.kuali.module.gl.bo.OriginEntryGroup)
     */
    public void feedOnFile(File doneFile, File dataFile, File reconFile, OriginEntryGroup originEntryGroup, String feederProcessName,
            String reconciliationTableId, EnterpriseFeederStatusAndErrorMessagesWrapper statusAndErrors) {
    ...
    /**
     * Returns whether the reconciliation process succeeded by looking at the reconciliation error messages
     * 
     * For this implementation, the reconciliation does not succeed if at least one of the error messages in
     * the list has a type of {@link Message#TYPE_FATAL}
     *  
     * @param errorMessages
     * @return
     */
