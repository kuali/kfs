...
public class BudgetConstructionDocumentAccountObjectDetailReportServiceImpl implements BudgetConstructionDocumentAccountObjectDetailReportService {
    ...
    private void buildReportsHeader(BudgetConstructionBalanceByAccount balanceByAccount, BudgetConstructionAccountObjectDetailReport accountObjectDetailReport) {
        ...
        accountObjectDetailReport.setOrganizationName(balanceByAccount.getAccount().getOrganization().getOrganizationName());
        
        accountObjectDetailReport.setFundGroupCode(balanceByAccount.getAccount().getSubFundGroup().getFundGroupCode());
        accountObjectDetailReport.setFundGroupName(balanceByAccount.getAccount().getSubFundGroup().getFundGroup().getName());
        ...
        accountObjectDetailReport.setAccountName(balanceByAccount.getAccount().getAccountName());
        try {
            accountObjectDetailReport.setSubAccountName(balanceByAccount.getSubAccount().getSubAccountName());
        }
        catch (Exception e) {
            accountObjectDetailReport.setSubAccountName("");
        }
    }
