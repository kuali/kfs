...
public class RoutingFormPersonnel extends PersistableBusinessObjectBase {
    ...
    public void populateWithUserServiceFields() {
        ...
        ChartOrgHolder chartOrg = org.kuali.kfs.sys.context.SpringContext.getBean(org.kuali.kfs.sys.service.FinancialSystemUserService.class).getOrganizationByNamespaceCode(user, KFSConstants.Modules.CHART);
