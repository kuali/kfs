...
public class KEMIDCurrentBalanceDetailInquirable extends KfsInquirableImpl {
    ...
    public HtmlData getInquiryUrl(BusinessObject businessObject, String attributeName, boolean forceInquiry) {
        ...
        if ((isIncome && isIncomeNotNullOrZero) || (isPrincipal && isPrincipalNotNullOrZero)) {
            ...
            params.put(EndowPropertyConstants.CURRENT_BAL_CLOSED_INDICATOR, currentBalanceDetail.getKemidObj().isClosedIndicator() ? "Yes" : "No");
            ...
            fieldList.put(EndowPropertyConstants.CURRENT_BAL_CLOSED_INDICATOR, currentBalanceDetail.getKemidObj().isClosedIndicator() ? "Yes" : "No");
