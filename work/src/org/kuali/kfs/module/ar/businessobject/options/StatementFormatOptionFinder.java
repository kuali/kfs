...
public class StatementFormatOptionFinder extends KeyValuesBase implements ValueFinder {
    ...
    public List<KeyLabelPair> getKeyValues() {
        ...
        labels.add(new KeyLabelPair(ArConstants.STATEMENT_FORMAT_SUMMARY, ArConstants.STATEMENT_FORMAT_SUMMARY));
        labels.add(new KeyLabelPair(ArConstants.STATEMENT_FORMAT_DETAIL, ArConstants.STATEMENT_FORMAT_DETAIL));
        return labels;
    }
}
