			          ...
			          <div align="center">
			            ...
			            <table class="grid" summary="" cellpadding="4" cellspacing="0">
                          ...
                          <label for="newPersonnelType.person">
						              ...
						              <kul:lookup boClassName="org.kuali.rice.kim.bo.Person" fieldConversions="principalId:newPersonnel.principalId,name:newPersonnel.user.name,baseSalaryAmount:newPersonnel.baseSalary" />
						              <br />
