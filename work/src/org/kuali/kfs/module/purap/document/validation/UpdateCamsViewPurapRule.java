...
/**
 * UpdateCamsView Purap Rule Interface
 ...
 */
public interface UpdateCamsViewPurapRule {
    
    /**
     * Checks the rules that are applicable to the UpdateCamsView Event on a Transactional Document
     * 
