...
public class DisbursementVoucherDocumentRule extends AccountingDocumentRuleBase implements DisbursementVoucherConstants {
    ...
    private void validateDocumentationLocation(DisbursementVoucherDocument document) {
        ...
        ChartOrgHolder chartOrg = org.kuali.kfs.sys.context.SpringContext.getBean(org.kuali.kfs.sys.service.FinancialSystemUserService.class).getOrganizationByNamespaceCode(getInitiator(document),KFSConstants.Modules.CHART);
