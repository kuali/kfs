...
public class AwardInvoiceMinimumInvoiceAmountValueFinder implements ValueFinder {
    ...
    public String getValue() {
        String minInvoiceAmt = SpringContext.getBean(ParameterService.class).getParameterValue(ContractsGrantsInvoiceDocument.class, ArConstants.MINIMUM_INVOICE_AMOUNT);
