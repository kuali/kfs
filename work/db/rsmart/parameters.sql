...
INSERT INTO KRNS_PARM_T (NMSPC_CD, PARM_DTL_TYP_CD, PARM_NM, OBJ_ID, VER_NBR, PARM_TYP_CD, TXT, PARM_DESC_TXT, CONS_CD, APPL_NMSPC_CD)
VALUES ('KFS-TEM','TravelAuthorization','TRAVEL_ADVANCE_DV_PAYMENT_REASON_CODE',SYS_GUID(),1,'CONFG','T','DV Payment Reason Code for the travel advance payment.','A','KFS');
...
INSERT INTO KRNS_PARM_T (NMSPC_CD, PARM_DTL_TYP_CD, PARM_NM, OBJ_ID, VER_NBR, PARM_TYP_CD, TXT, PARM_DESC_TXT, CONS_CD, APPL_NMSPC_CD)
VALUES ('KFS-TEM','TravelRelocation','VENDOR_PAYMENT_DV_REASON_CODE',SYS_GUID(),1,'CONFG','3','Travel Vendor Payments','A','KFS');
