...
/**
 * Action class for Dunning Letter Distribution On-Demand Lookup.
 */
public class DunningLetterDistributionOnDemandLookupAction extends KualiMultipleValueLookupAction {

    private static final org.apache.log4j.Logger LOG = org.apache.log4j.Logger.getLogger(DunningLetterDistributionOnDemandLookupAction.class);
    ...
    protected List<ResultRow> selectAll(MultipleValueLookupForm multipleValueLookupForm, int maxRowsPerPage) {
        ...
        for (ResultRow row : resultTable) {
            ...
            if (row instanceof DunningLetterDistributionOnDemandResultRow) {
                for (ResultRow subResultRow : ((DunningLetterDistributionOnDemandResultRow) row).getSubResultRows()) {
    ...
    public ActionForward prepareToReturnSelectedResults(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (success) {
            ...
            String dunningLetterDistributionOnDemandResultRowOnDemandSummaryUrl = UrlFactory.parameterizeUrl("arDunningLetterDistributionOnDemandSummary.do", parameters);
            return new ActionForward(dunningLetterDistributionOnDemandResultRowOnDemandSummaryUrl, true);
