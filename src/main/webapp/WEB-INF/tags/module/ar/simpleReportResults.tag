...
<%@ attribute name="resultLabel" required="true" description="The label for the business object the result represents."%>

<tr>
	<td colspan="${fn:length(subResultRows[0].columns)+1}"><br />
		<center>
