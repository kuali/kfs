...
<table cellpadding="0" cellspacing="0" class="datatable" summary=""> 
  ...
  <c:if test="${i eq 1}"> <html:hidden property="document.budget.graduateAssistantRate[${ctr}].documentHeaderId" /> 
  ...
  <tr align="left">
    <th height="22">&nbsp;</th>
    <th height="22" colspan="2"><div align="center"><html:image property="methodToCall.copySystemGraduateAssistantLines.anchorGradAsst" styleClass="tinybutton" src="images/tinybutton-copsysrates.gif" alt="copy system rate"/></div></th>
  </tr>
  </c:if>
</table>
