...
public class RoutingFormServiceImpl implements RoutingFormService {
    ...
    public Long createAndRouteProposalMaintenanceDocument(RoutingFormDocument routingFormDocument) {
        ...
        try {
            MaintenanceDocument proposalMaintenanceDocument = (MaintenanceDocument)documentService.getNewDocument("KualiProposalAutoGeneratedMaintenanceDocument");
    ...
    private Proposal createProposalFromRoutingForm(RoutingFormDocument routingFormDocument) {
        ...
        for (RoutingFormResearchRisk routingFormResearchRisk : routingFormDocument.getRoutingFormResearchRisks()) {
            ...
            newProposalResearchRisk.setIsActive(routingFormResearchRisk.getResearchRiskStudies() != null && routingFormResearchRisk.getResearchRiskStudies().size() > 0 || routingFormResearchRisk.getResearchRiskDescription() != null);
