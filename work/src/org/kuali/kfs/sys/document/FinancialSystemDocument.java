...
/**
 * This class is a specific KFS DocumentBase class.
 */
public class FinancialSystemDocument extends DocumentBase {
    ...
    public void setDocumentHeader(DocumentHeader documentHeader) {
        if (documentHeader == null) {
            throw new IllegalArgumentException("document header parameter was null");
        } else if (!FinancialSystemDocumentHeader.class.isAssignableFrom(documentHeader.getClass())) {
