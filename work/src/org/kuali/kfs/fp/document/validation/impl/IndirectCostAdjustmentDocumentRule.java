...
public class IndirectCostAdjustmentDocumentRule extends TransactionalDocumentRuleBase {
	...
	protected void customizeExplicitGeneralLedgerPendingEntry(TransactionalDocument transactionalDocument, AccountingLine accountingLine, GeneralLedgerPendingEntry explicitEntry) {
        ...
        explicitEntry.setReferenceFinDocumentTypeCode(GENERAL_LEDGER_PENDING_ENTRY_CODE.BLANK_STRING);
        explicitEntry.setFinancialDocumentReferenceNbr(GENERAL_LEDGER_PENDING_ENTRY_CODE.BLANK_STRING);
        explicitEntry.setTransactionEncumbranceUpdtCd(GENERAL_LEDGER_PENDING_ENTRY_CODE.BLANK_STRING);
	}
