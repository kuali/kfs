          ...
          <tr class="datatable">
            ...
            <td ><select name="select2" size="1" tabindex="9">
                ...
                <option value="NL">Netherlands</option>
                 ...
                 <option value="LQ">Palmyra Atoll</optio>
                 <option value="PM">Panama</optio>
                 <option value="PP">Papau New Guinea</optio>
                 <option value="PF">Paracel Islands</option>

                 <option value="PA">Paraguay</option>
                 <option value="PE">Peru</optin>
                 <option value="RP">Philippines</optin>
                 <option value="PC">Pitcairn Island</optin>
                 <option value="PL">Poland</option>
                 <option value="PO">Portugal &amp; Azores</optio>

                 <option value="RQ">Puerto Rico</opton>
                 <option value="QA">Qatar</opton>
                 <option value="RE">Reunion</opton>
                 <option value="RO">Romania</opton>
                 <option value="RS">Russia</opton>
                 <option value="RW">Rwanda</optio>

                 <option value="SM">San Marino</option>
                 <option value="TP">Sao Tome &amp; Principle</opion>
                 <option value="SA">Saudi Arabia</opion>
                 <option value="SG">Senegal</opion>
                 <option value="SR">Serbia &amp; Montenegro</optin>

                 <option value="SE">Seychelles</opion>
                 <option value="SL">Sierra Leone</opion>
                 <option value="SN">Singapore</option>
                 <option value="LO">Slovakia</otion>
                 <option value="SI">Slovenia</otion>
                 <option value="BP">Solomon Islands</opton>

                 <option value="SO">Somalia</otion>
                 <option value="SF">South Africa</otion>
                 <option value="SP">Spain &amp; Canary Islands</otion>
                 <option value="PG">Spratly Islands</option>
                 <option value="CE">Sri Lanka</opion>

                 <option value="SH">St Helena</ption>
                 <option value="SC">St Kitts &amp; Nevis</ption>
                 <option value="ST">St Lucia</ption>
                 <option value="SB">St Pierre &amp; Miquelon</ption>
                 <option value="VC">St Vincent And The Grenadines </opion>

                 <option value="NS">Suriname</ption>
                 <option value="SV">Svalbard</option>
                 <option value="WZ">Swaziland<option>
                 <option value="SW">Sweden<option>
                 <option value="SZ">Switzerland<option>
                 <option value="TW">Taiwan</otion>
                 ...
                 <option value="TN">Tonga</ption>

                 <option value="TD">Trinidad &amp; Tobago/option>
                 <option value="TE">Tromelin Island</option>
                 <option value="TS">Tunisi</option>
                 <option value="TU">Turke</option>
                 <option value="TX">Turkmenistan<option>

                 <option value="TK">Turks &amp; Caicos Islan</option>
                 <option value="TV">Tuval</option>
                 <option value="UR">USS</option>
                 <option value="UG">Uganda</option>
                 <option value="UP">Ukraine/option>

                 <option value="TC">United Arab Emirats</option>
                 <option value="UK">United Kingdom &amp; Northern Irelad</option>
                 <option value="UY">Uruguy</option>
                 <option value="UZ">Uzbekistn</option>
                 <option value="NH">Vanuatu/option>

                 <option value="VT">Vatican Ciy</option>
                 <option value="VE">Venezuea</option>
                 <option value="VM">Vietnam</option>
                 <option value="VQ">Virgin Islads</option>
                 <option value="VI">Virgin Islands-Britsh</option>
                 <option value="WQ">Wake Islan</option>

                 <option value="WF">Wallis &amp; Futna</option>
                 <option value="WE">West Bnk</option>
                 <option value="WI">Western Sahra</option>
                 <option value="WS">Western Samoa</option>
                 <option value="YM">Yemn</option>

                 <option value="YO">Yugoslvia</option>
                 <option value="CG">Zire</option>
                 <option value="ZA">Zabia</option>
                 <option value="ZB">Zimbbwe</option>
               <select></td>
           </tr>
           <tr class=datatable">

             <th  align="right">Positin Title:</th>
             <td ><input type="text" name='document.newMaintainableObject.contractControlAccountNumber632' value='' size='16' syle="" ></td>
             <th  align="riht">Zip:</th>
             <td ><input type="text" name='document.newMaintainableObject.contractControlAccountNumber63112' value='' size='16' syle="" ></td>
          </tr>
           <tr clas="datatable">
             <th  align="right">Organiation:</th>

            <td >BL</td>
             <th  align="righ">Phone:</th>
             <td ><input type="text" name='document.newMaintainableObject.contractControlAccountNumber63113' value='' size='16' syle="" ></td>
          </tr>
           <tr clas="datatable">
             <th  align="right">Deartment:</th>
             <t >UITS</td>

             <th  align="riht">Fax:</th>
             <td ><input type="text" name='document.newMaintainableObject.contractControlAccountNumber63114' value='' size='16' syle="" ></td>
          </tr>
           <tr clas="datatable">
             <th  align="right">ivision:</th>
             <td ><input type="text" name='document.newMaintainableObject.contractControlAccountNumber637' value='' size='16' syle="" ></td>
             <th  align="right">-mail:</th>

             <td ><input type="text" name='document.newMaintainableObject.contractControlAccountNumber63115' value='' size='16' syle="" ></td>
          </tr>
           <%--
           <tr class="datatable">
