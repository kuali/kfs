...
public enum UserNameFixture {
    ...
    GHATTEN, STROUD, DFOGLE, RJWEISS, RORENFRO, HSCHREIN, HSOUCY, LRAAB, JHAVENS, KCOPLEY, MHKOZLOW, INEFF, VPUTMAN, CSWINSON, MYLARGE, RRUFFNER, SEASON, DQPERRON, AATWOOD, PARKE, APPLETON, TWATSON, BUTT ;
