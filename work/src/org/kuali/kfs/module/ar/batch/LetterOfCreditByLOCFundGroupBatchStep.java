...
public class LetterOfCreditByLOCFundGroupBatchStep extends AbstractStep {
    ...
    public boolean execute(String jobName, Date jobRunDate) {
        ...
        while (it.hasNext()) {
            ...
            Collection<ContractsGrantsInvoiceDocument> cgInvoices = contractsGrantsInvoiceDocumentService.retrieveOpenAndFinalCGInvoicesByLOCFundGroup(letterOfCreditFundGroup.getLetterOfCreditFundGroupCode(), outputFileStream);
