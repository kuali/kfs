...
import org.kuali.kfs.module.cg.businessobject.RoutingFormStatus;
        ...
        if (ObjectUtils.isNotNull(projectDirector) && ObjectUtils.isNotNull(projectDirector.getUser())) {
            ...
            if (StringUtils.isNotBlank(projectDirector.getChartOfAccountsCode())) {
                ...
                if (StringUtils.isBlank(projectDirector.getOrganizationCode())) {
                    xml.append(org.kuali.kfs.sys.context.SpringContext.getBean(org.kuali.kfs.sys.service.FinancialSystemUserService.class).getOrganizationByNamespaceCode(projectDirector.getUser(),KFSConstants.ParameterNamespaces.CHART).getOrganizationCode());
                }
                else {
