 ...
 */
public class ContractsGrantsInvoiceOnDemandLookupResult extends TransientBusinessObjectBase {
    ...
    public ContractsAndGrantsBillingFrequency getBillingFrequency() {
        return billingFrequency = (ContractsAndGrantsBillingFrequency) SpringContext.getBean(KualiModuleService.class).getResponsibleModuleService(ContractsAndGrantsBillingFrequency.class).retrieveExternalizableBusinessObjectIfNecessary(this, billingFrequency, "billingFrequency");
    }
