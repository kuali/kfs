                ...
                <td height="70" align=left valign=middle class="datacell"><div align="center"><br>
                  ...
                  <table align="center" cellpadding="4">
                      ...
                      <tr>
                        ...
                        <td align=left valign=middle class="right"><input type="text" size="10" class="right" name="document.totalCashAmount" value="${KualiForm.cashReceiptDocument.totalCashAmount}" />
                        </td>
                      </tr>
                      <tr>
                        <td align=left valign=middle><div align="right"><strong>Coins:</strong></div></td>
                        <td align=left valign=middle class="right"><input type="text" class="right" size="10" name="document.totalCoinAmount" value="${KualiForm.cashReceiptDocument.totalCoinAmount}" />
                        </td>
                      </tr>
                      <tr>
