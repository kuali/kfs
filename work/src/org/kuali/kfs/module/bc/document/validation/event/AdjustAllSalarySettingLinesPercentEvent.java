...
public class AdjustAllSalarySettingLinesPercentEvent extends SalarySettingBaseEvent {
     ...
     */
    public AdjustAllSalarySettingLinesPercentEvent(String description, String errorPathPrefix, BudgetConstructionDocument document, List<PendingBudgetConstructionAppointmentFunding> appointmentFundings) {
