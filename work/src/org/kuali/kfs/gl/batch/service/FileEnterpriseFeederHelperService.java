...
/**
 * Implementations of this interface are responsible for reconciliation of origin entry data in a file and loading them into the origin entry table.
 * 
 * Note that implementations of this class may have special useful transactional properties.  See implementation description for more details.
 */
public interface FileEnterpriseFeederHelperService {
     ...
     * 
     * This method DOES NOT handle the deletion of the done file
     * 
     ...
     * @param reconFile the reconciliation file.  See implementations of {@link org.kuali.module.gl.service.ReconciliationParserService}
     ...
     * @param statusAndErrors a class with references to a {@link org.kuali.module.gl.util.EnterpriseFeederStatus} object and a list of error messages.
     * Implementations of this method may need to throw an exception to force a transaction rollback, which means that it can't return a value.  This parameter
     * allows the method to output status/error information
     */
