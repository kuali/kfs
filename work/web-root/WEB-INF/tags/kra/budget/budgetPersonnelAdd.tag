                  ...
                  <td class="annotate-t">
			        ...
			        <div class="annotate-container">
			          ...
			          <div align="center">
			            ...
			            <br>
			            <span class="infoline">
				            <html:image property="methodToCall.clearNewPersonnel" src="${ConfigProperties.kr.externalizable.images.url}tinybutton-clear1.gif" title="clear" alt="clear" title="clear" />&nbsp;
			              <html:image property="methodToCall.insertPersonnel" src="${ConfigProperties.externalizable.images.url}tinybutton-addpers.gif" title="add this person" alt="add this person" title="add this person"/>
			            </span>
			          </div>
			        </div>
