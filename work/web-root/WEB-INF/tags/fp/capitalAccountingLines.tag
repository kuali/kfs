...
<kul:tab tabTitle="Accounting Lines for Capitalization" defaultOpen="false" tabErrorKey="${KFSConstants.EDIT_CAPITAL_ASSET_INFORMATION_ERRORS}" >
			...
			<tr>
   	        ...
   	        <logic:iterate id="capitalAccountingLinesCollection" name="KualiForm" property="capitalAccountingLines" indexId="ctr">
		    	<tr>
		            ...
		            <td class="datacell"><kul:htmlControlAttribute attributeEntry="${capitalAccountingLinesAttributes.amount}" property="capitalAccountingLines[${ctr}].amount" readOnly="true"/></td>
