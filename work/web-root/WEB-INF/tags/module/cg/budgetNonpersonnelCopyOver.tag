...
<div id="workarea">
  ...
  <cg:budgetNonpersonnelCopyOverAmountTab tabTitle="Agency Amount Requested" copyIndicatorLabel="agencyCopyIndicator" amountType="agency" transparentBackground="true"/>
  ...
  <c:if test="${KualiForm.document.budget.institutionCostShareIndicator}">
    <cg:budgetNonpersonnelCopyOverAmountTab tabTitle="Institution Cost Share" copyIndicatorLabel="budgetInstitutionCostShareCopyIndicator" amountType="institution" transparentBackground="false"/>
  </c:if>
  ...
  <c:if test="${KualiForm.document.budget.budgetThirdPartyCostShareIndicator}">
    <cg:budgetNonpersonnelCopyOverAmountTab tabTitle="3rd Party Cost Share" copyIndicatorLabel="budgetThirdPartyCostShareCopyIndicator" amountType="third" transparentBackground="false"/>
  </c:if>
