...
public class DisbursementVoucherTravelServiceTest extends KualiTestBaseWithSpring {
    ...
    public void testCalculatePerDiem() throws Exception {
        ...
        runPerDiemTest(dvDocument.getDvNonEmployeeTravel().getDvPerdiemStartDttmStamp(), dvDocument.getDvNonEmployeeTravel()
                .getDvPerdiemEndDttmStamp(), new KualiDecimal(50), new KualiDecimal(37.50));
        ...
        runPerDiemTest(dvDocument.getDvNonEmployeeTravel().getDvPerdiemStartDttmStamp(), dvDocument.getDvNonEmployeeTravel()
                .getDvPerdiemEndDttmStamp(), new KualiDecimal(10), new KualiDecimal(10));
    ...
    private void runPerDiemTest(Timestamp startTime, Timestamp endTime, KualiDecimal perDiemRate, KualiDecimal expectedPerDiemAmount) {
        assertEquals("Per diem amount not correct ", expectedPerDiemAmount, disbursementVoucherTravelService
                .calculatePerDiemAmount(startTime, endTime, perDiemRate));
    }
    ...
    private void runMileageAmountTest(Integer totalMiles, KualiDecimal expectedMileageAmount, Timestamp effectiveDate) {
        assertEquals("Mileage amount not correct ", expectedMileageAmount, disbursementVoucherTravelService.calculateMileageAmount(
                totalMiles, effectiveDate));
    }
