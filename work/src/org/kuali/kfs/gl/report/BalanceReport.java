    ...
    public void generateReport(List<GlSummary> glBalances, List<String> balanceTypeCodes, Date runDate, String reportTitle, String fileprefix, String destinationDirectory) {
        ...
        try {
            ...
            for (Iterator iter = glBalances.iterator(); iter.hasNext();) {
                ...
                balances.addCell(cell);
                cell = new PdfPCell(new Phrase(nf.format((gls.getBeginningBalanceLineAmount().add(gls.getContractsGrantsBeginningBalanceAmount())).doubleValue()), textFont));
                cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
                balances.addCell(cell);
                cell = new PdfPCell(new Phrase(nf.format(gls.getAccountLineAnnualBalanceAmount().doubleValue()), textFont));
                cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
                balances.addCell(cell);
                cell = new PdfPCell(new Phrase(nf.format(gls.getMonth1Amount().doubleValue()), textFont));
                cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
                balances.addCell(cell);
                cell = new PdfPCell(new Phrase(nf.format(gls.getMonth2Amount().doubleValue()), textFont));
                cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
                balances.addCell(cell);
                cell = new PdfPCell(new Phrase(nf.format(gls.getMonth3Amount().doubleValue()), textFont));
                cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
                balances.addCell(cell);
                cell = new PdfPCell(new Phrase(nf.format(gls.getMonth4Amount().doubleValue()), textFont));
                cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
                balances.addCell(cell);

                cell = new PdfPCell(new Phrase("", textFont));
                balances.addCell(cell);
                cell = new PdfPCell(new Phrase(nf.format(gls.getMonth5Amount().doubleValue()), textFont));
                cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
                balances.addCell(cell);
                cell = new PdfPCell(new Phrase(nf.format(gls.getMonth6Amount().doubleValue()), textFont));
                cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
                balances.addCell(cell);
                cell = new PdfPCell(new Phrase(nf.format(gls.getMonth7Amount().doubleValue()), textFont));
                cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
                balances.addCell(cell);
                cell = new PdfPCell(new Phrase(nf.format(gls.getMonth8Amount().doubleValue()), textFont));
                cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
                balances.addCell(cell);
                cell = new PdfPCell(new Phrase(nf.format(gls.getMonth9Amount().doubleValue()), textFont));
                cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
                balances.addCell(cell);
                cell = new PdfPCell(new Phrase(nf.format(gls.getMonth10Amount().doubleValue()), textFont));
                cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
                balances.addCell(cell);

                cell = new PdfPCell(new Phrase("", textFont));
                balances.addCell(cell);
                cell = new PdfPCell(new Phrase(nf.format(gls.getMonth11Amount().doubleValue()), textFont));
                cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
                balances.addCell(cell);
                cell = new PdfPCell(new Phrase(nf.format(gls.getMonth12Amount().doubleValue()), textFont));
                cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
                balances.addCell(cell);
                cell = new PdfPCell(new Phrase(nf.format(gls.getMonth13Amount().doubleValue()), textFont));
                cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
                balances.addCell(cell);
            ...
            balances.addCell(cell);
            cell = new PdfPCell(new Phrase(nf.format((totals.getBeginningBalanceLineAmount().add(totals.getContractsGrantsBeginningBalanceAmount())).doubleValue()), textFont));
            cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
            balances.addCell(cell);
            cell = new PdfPCell(new Phrase(nf.format(totals.getAccountLineAnnualBalanceAmount().doubleValue()), textFont));
            cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
            balances.addCell(cell);
            cell = new PdfPCell(new Phrase(nf.format(totals.getMonth1Amount().doubleValue()), textFont));
            cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
            balances.addCell(cell);
            cell = new PdfPCell(new Phrase(nf.format(totals.getMonth2Amount().doubleValue()), textFont));
            cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
            balances.addCell(cell);
            cell = new PdfPCell(new Phrase(nf.format(totals.getMonth3Amount().doubleValue()), textFont));
            cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
            balances.addCell(cell);
            cell = new PdfPCell(new Phrase(nf.format(totals.getMonth4Amount().doubleValue()), textFont));
            cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
            balances.addCell(cell);

            cell = new PdfPCell(new Phrase("", textFont));
            balances.addCell(cell);
            cell = new PdfPCell(new Phrase(nf.format(totals.getMonth5Amount().doubleValue()), textFont));
            cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
            balances.addCell(cell);
            cell = new PdfPCell(new Phrase(nf.format(totals.getMonth6Amount().doubleValue()), textFont));
            cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
            balances.addCell(cell);
            cell = new PdfPCell(new Phrase(nf.format(totals.getMonth7Amount().doubleValue()), textFont));
            cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
            balances.addCell(cell);
            cell = new PdfPCell(new Phrase(nf.format(totals.getMonth8Amount().doubleValue()), textFont));
            cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
            balances.addCell(cell);
            cell = new PdfPCell(new Phrase(nf.format(totals.getMonth9Amount().doubleValue()), textFont));
            cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
            balances.addCell(cell);
            cell = new PdfPCell(new Phrase(nf.format(totals.getMonth10Amount().doubleValue()), textFont));
            cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
            balances.addCell(cell);

            cell = new PdfPCell(new Phrase("", textFont));
            balances.addCell(cell);
            cell = new PdfPCell(new Phrase(nf.format(totals.getMonth11Amount().doubleValue()), textFont));
            cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
            balances.addCell(cell);
            cell = new PdfPCell(new Phrase(nf.format(totals.getMonth12Amount().doubleValue()), textFont));
            cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
            balances.addCell(cell);
            cell = new PdfPCell(new Phrase(nf.format(totals.getMonth13Amount().doubleValue()), textFont));
            cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
            balances.addCell(cell);
