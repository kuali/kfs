...
public class BudgetConstructionMonthSummaryReportDaoJdbc extends BudgetConstructionDaoJdbcBase implements BudgetConstructionMonthSummaryReportDao {
    ...
    private static String[] updateReportsMonthSummaryTable = new String[10];
    ...
    public BudgetConstructionMonthSummaryReportDaoJdbc() {
        ...
        sqlText.append("SELECT '12345', ctrl.sel_org_fin_coa, ctrl.sel_org_cd, ctrl.sel_sub_fund_grp, ctrl.univ_fiscal_yr, \n");
        sqlText.append(" ctrl.fin_coa_cd, 'A', pbgl.fin_object_cd, '---', sum(pbgl.acln_annl_bal_amt) \n");
        ...
        updateReportsMonthSummaryTable[0] = sqlText.toString();
        ...
        sqlText.append(" FIN_COA_CD, INC_EXP_CD, FIN_OBJECT_CD, FIN_SUB_OBJ_CD, ACLN_ANNL_BAL_AMT) \n");
        sqlText.append("SELECT '12345', ctrl.sel_org_fin_coa, ctrl.sel_org_cd, ctrl.sel_sub_fund_grp, ctrl.univ_fiscal_yr, \n");
        sqlText.append(" ctrl.fin_coa_cd, 'B', pbgl.fin_object_cd, '---', sum(pbgl.acln_annl_bal_amt) \n");
        sqlText.append("FROM ld_pnd_bcnstr_gl_t pbgl, ld_bcn_ctrl_list_t ctrl, LD_BCN_SUBFUND_PICK_T pick \n");
        sqlText.append("WHERE pick.person_unvl_id = '1234567' \n");
        sqlText.append(" AND pick.report_flag > 0 \n");
        sqlText.append(" AND pick.sub_fund_grp_cd = ctrl.sel_sub_fund_grp \n");
        ...
        updateReportsMonthSummaryTable[1] = sqlText.toString();
        sqlText.delete(0, sqlText.length());
        ...
        sqlText.append("SELECT '12345', ctrl.sel_org_fin_coa, ctrl.sel_org_cd, ctrl.sel_sub_fund_grp, ctrl.univ_fiscal_yr, ctrl.fin_coa_cd, 'A', \n");
        sqlText.append(" mnth.fin_object_cd, '---', sum(mnth.fdoc_ln_mo1_amt), sum(mnth.fdoc_ln_mo2_amt), sum(mnth.fdoc_ln_mo3_amt), \n");
        ...
        sqlText.append("AND mnth.fin_obj_typ_cd in ('IN','IC','CH','AS') \n");
        ...
        updateReportsMonthSummaryTable[2] = sqlText.toString();
        sqlText.delete(0, sqlText.length());
        ...
        sqlText.append(" FIN_OBJECT_CD, FIN_SUB_OBJ_CD, FDOC_LN_MO1_AMT, FDOC_LN_MO2_AMT, FDOC_LN_MO3_AMT, FDOC_LN_MO4_AMT, FDOC_LN_MO5_AMT, \n");
        sqlText.append(" FDOC_LN_MO6_AMT, FDOC_LN_MO7_AMT, FDOC_LN_MO8_AMT, FDOC_LN_MO9_AMT, FDOC_LN_MO10_AMT, FDOC_LN_MO11_AMT, FDOC_LN_MO12_AMT) \n");
        sqlText.append("SELECT '12345', ctrl.sel_org_fin_coa, ctrl.sel_org_cd, ctrl.sel_sub_fund_grp, ctrl.univ_fiscal_yr, ctrl.fin_coa_cd, \n");
        sqlText.append(" 'B', mnth.fin_object_cd, '---', sum(mnth.fdoc_ln_mo1_amt), sum(mnth.fdoc_ln_mo2_amt), sum(mnth.fdoc_ln_mo3_amt), \n");
        sqlText.append(" sum(mnth.fdoc_ln_mo4_amt), sum(mnth.fdoc_ln_mo5_amt), sum(mnth.fdoc_ln_mo6_amt), sum(mnth.fdoc_ln_mo7_amt), \n");
        sqlText.append(" sum(mnth.fdoc_ln_mo8_amt), sum(mnth.fdoc_ln_mo9_amt), sum(mnth.fdoc_ln_mo10_amt), sum(mnth.fdoc_ln_mo11_amt), sum(mnth.fdoc_ln_mo12_amt) \n");
        sqlText.append("FROM ld_bcnstr_month_t mnth, ld_bcn_ctrl_list_t ctrl, ld_bcn_subfund_pick_t pick \n");
        sqlText.append("WHERE pick.person_unvl_id = '1234567' \n");
        ...
        sqlText.append(" AND pick.person_unvl_id = ctrl.person_unvl_id \n");
        sqlText.append(" AND mnth.fdoc_nbr = ctrl.fdoc_nbr \n");
        sqlText.append(" AND mnth.fin_obj_typ_cd in ('EE','ES','EX','LI') \n");
        ...
        updateReportsMonthSummaryTable[3] = sqlText.toString();
        sqlText.delete(0, sqlText.length());                  
        ...
        updateReportsMonthSummaryTable[4] = sqlText.toString();
        sqlText.delete(0, sqlText.length());                  
        ...
        updateReportsMonthSummaryTable[5] = sqlText.toString();
        sqlText.delete(0, sqlText.length());
        ...
        updateReportsMonthSummaryTable[6] = sqlText.toString();
        sqlText.delete(0, sqlText.length());
        ...
        updateReportsMonthSummaryTable[7] = sqlText.toString();
        sqlText.delete(0, sqlText.length());  
        ...
        sqlText.append("SELECT '1234567', ld_bcn_build_mnthsumm01_mt.sel_org_fin_coa, ld_bcn_build_mnthsumm01_mt.sel_org_cd, \n");
        ...
        sqlText.append("WHERE ld_bcn_build_mnthsumm01_mt.univ_fiscal_yr = objt.univ_fiscal_yr \n");
    ...
    public void updateReportsMonthSummaryTable(String personUserIdentifier) {
