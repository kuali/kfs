    ...
    <div class="tab-container" align=center>
        ...
        <table cellpadding="0" cellspacing="0" class="datatable" summary="Splitting Item Selection">
        	...
        	<logic:iterate indexId="ctr" name="KualiForm" property="document.items" id="itemLine">
        		...
        		<c:choose>
        			<c:when test="${itemLine.itemType.itemTypeAboveTheLineIndicator == true}">
        				<tr>
				        	<td class="datacell">
				        		<div align="center">
			        ...
			        <c:otherwise> 
			        	<html:hidden property="document.item[${ctr}].movingToSplit"/>
			        	...
			        	<html:hidden property="document.item[${ctr}].itemUnitOfMeasureCode"/>
			        	<html:hidden property="document.item[${ctr}].itemCatalogNumber"/>
			        	<html:hidden property="document.item[${ctr}].purchasingCommodityCode"/>
			        	<html:hidden property="document.item[${ctr}].itemDescription"/>
			        	<html:hidden property="document.item[${ctr}].itemUnitPrice"/>
