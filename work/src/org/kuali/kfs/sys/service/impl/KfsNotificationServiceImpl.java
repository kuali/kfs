...
public class KfsNotificationServiceImpl implements KfsNotificationService {
    ...
    protected void setupForNonProductionEnviroment(MailMessage mailMessage) {
        String productionEnvironmentCode = this.getKualiConfigurationService().getPropertyString(KFSConstants.PROD_ENVIRONMENT_CODE_KEY);
        String environmentCode = this.getKualiConfigurationService().getPropertyString(KFSConstants.ENVIRONMENT_KEY);
