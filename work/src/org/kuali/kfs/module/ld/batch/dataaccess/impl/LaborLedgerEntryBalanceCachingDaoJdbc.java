...
public class LaborLedgerEntryBalanceCachingDaoJdbc extends LedgerEntryBalanceCachingDaoJdbc {
    ...
    public List compareBalanceHistory(Class balanceClass, Class historyClass, int pastYears) {
        ...
        String balanceTable = getPersistenceStructureService().getTableName(balanceClass);
        String historyTable = getPersistenceStructureService().getTableName(historyClass);
       
        int fiscalYear = getUniversityDateService().getCurrentFiscalYear()-pastYears;
