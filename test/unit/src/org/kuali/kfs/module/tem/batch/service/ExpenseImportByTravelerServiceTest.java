...
public class ExpenseImportByTravelerServiceTest extends KualiTestBase {
    ...
    public void testValidateAccountingInfo() {
        ...
        Parameter param = parameterService.retrieveParameter(PARAM_NAMESPACE, AgencyMatchProcessParameter.AGENCY_MATCH_DTL_TYPE, AgencyMatchProcessParameter.CTS_AIR_OBJECT_CODE);
        param.setParameterValue("5000");
