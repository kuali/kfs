...
public abstract class AccountsReceivableLookupableHelperServiceImplBase extends KualiLookupableHelperServiceImpl {
    ...
    /**
     * Overridden to add Rice Path prefix to the URL where necessary (cases where the Lookupable is called
     * from the KFS context instead of the Rice context).
     *
    ...
    public HtmlData getInquiryUrl(BusinessObject bo, String propertyName) {
        ...
        if (StringUtils.startsWith(hRef.getHref(), KRADConstants.INQUIRY_ACTION)) {
