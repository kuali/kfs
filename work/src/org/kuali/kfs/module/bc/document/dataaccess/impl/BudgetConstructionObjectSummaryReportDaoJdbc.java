...
public class BudgetConstructionObjectSummaryReportDaoJdbc extends BudgetConstructionDaoJdbcBase implements BudgetConstructionObjectSummaryReportDao {
    ...
    public BudgetConstructionObjectSummaryReportDaoJdbc() {
        ...
        // update the original lines using the FTE generated above. (PostGreSQL supposedly does not allow the target table in an
        // UPDATE to be aliased. Gennick, p.159.)
        ...
        // update the base FTE in the reporting table using the holding table values. (PostGreSQL supposedly does not allow the
        // target table in an UPDATE to be aliased. Gennick, p.159.)
        sqlBuilder.append("UPDATE LD_BCN_OBJT_SUMM_T\n");
