...
/**
 * Defines a rule which gets invoked immediately before an accounting line is updated within a document.
 */
public interface UpdateAccountingLineRule<F extends AccountingDocument> extends AccountingLineRule {
    /**
     ...
     */
    public boolean processUpdateAccountingLineBusinessRules(F financialDocument, AccountingLine originalAccountingLine, AccountingLine updatedAccountingLine);
}