...
public class BudgetAdjustmentDocument extends TransactionalDocumentBase {
    ...
    private Integer nextPsSourceLineNumber;
    private Integer nextPsTargetLineNumber;
	...
	public Integer getNextPsSourceLineNumber() {
		return nextPsSourceLineNumber;
	}

	public void setNextPsSourceLineNumber(Integer nextPsSourceLineNumber) {
		this.nextPsSourceLineNumber = nextPsSourceLineNumber;
	}

	public Integer getNextPsTargetLineNumber() {
		return nextPsTargetLineNumber;
	}

	public void setNextPsTargetLineNumber(Integer nextPsTargetLineNumber) {
		this.nextPsTargetLineNumber = nextPsTargetLineNumber;
	}
}