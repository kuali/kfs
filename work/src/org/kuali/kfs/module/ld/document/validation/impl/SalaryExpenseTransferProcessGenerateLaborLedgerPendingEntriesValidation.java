 ...
 */
public class SalaryExpenseTransferProcessGenerateLaborLedgerPendingEntriesValidation extends GenericValidation {
    ...
    public boolean processGenerateLaborLedgerPendingEntries(AccountingDocument document, AccountingLine accountingLine, GeneralLedgerPendingEntrySequenceHelper sequenceHelper) {
        ...
        List<LaborLedgerPendingEntry> expensePendingEntries = LaborPendingEntryGenerator.generateExpensePendingEntries(expenseTransferAccountingDocument, expenseTransferAccountingLine, sequenceHelper);
        expenseTransferAccountingDocument.getLaborLedgerPendingEntries().addAll(expensePendingEntries);

        List<LaborLedgerPendingEntry> benefitPendingEntries = LaborPendingEntryGenerator.generateBenefitPendingEntries(expenseTransferAccountingDocument, expenseTransferAccountingLine, sequenceHelper);
        expenseTransferAccountingDocument.getLaborLedgerPendingEntries().addAll(benefitPendingEntries);
