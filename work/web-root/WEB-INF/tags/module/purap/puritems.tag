				...
				<tr>
					...
					<td class="infoline">
					    <kul:htmlControlAttribute
						    ...
						    readOnly="${not (fullEntryMode or (amendmentEntry and itemLine.versionNumber == null)) or itemLine.itemTypeCode == 'UNOR' or lockB2BEntry}" tabindexOverride="${tabindexOverrideBase + 0}"/>
					</td>
					<td class="infoline">
					    <kul:htmlControlAttribute
