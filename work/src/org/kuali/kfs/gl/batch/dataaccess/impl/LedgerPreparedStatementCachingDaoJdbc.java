...
public class LedgerPreparedStatementCachingDaoJdbc extends AbstractPreparedStatementCachingDaoJdbc implements LedgerPreparedStatementCachingDao {
    ...
    static {
        sql.put(RETRIEVE_PREFIX + Entry.class, "select max(trn_entr_seq_nbr) from gl_entry_t where univ_fiscal_yr = ? and fin_coa_cd = ? and account_nbr = ? and sub_acct_nbr = ? and fin_object_cd = ? and fin_sub_obj_cd = ? and fin_balance_typ_cd = ? and fin_obj_typ_cd = ? and univ_fiscal_prd_cd = ? and fdoc_typ_cd = ? and fs_origin_cd = ? and fdoc_nbr = ?");
        ...
        sql.put(INSERT_PREFIX + Balance.class, "insert into GL_BALANCE_T values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
        ...
        sql.put(INSERT_PREFIX + Encumbrance.class, "insert into GL_ENCUMBRANCE_T values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
        ...
        sql.put(INSERT_PREFIX + ExpenditureTransaction.class, "insert into GL_EXPEND_TRN_T values (?,?,?,?,?,?,?,?,?,?,?,?)");
        ...
        sql.put(INSERT_PREFIX + SufficientFundBalances.class, "insert into GL_SF_BALANCES_T values (?,?,?,?,?,?,?,?,?)");
        ...
        sql.put(INSERT_PREFIX + AccountBalance.class, "insert into GL_ACCT_BALANCES_T values (?,?,?,?,?,?,?,?,?,?)");
        ...
        sql.put(INSERT_PREFIX + Entry.class, "INSERT INTO GL_ENTRY_T VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
        sql.put(INSERT_PREFIX + Reversal.class, "INSERT INTO GL_REVERSAL_T VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
    }
    ...
    public void updateAccountBalance(final AccountBalance accountBalance) {
        new UpdatingJdbcWrapper<AccountBalance>() {
            ...
            protected void populateStatement(PreparedStatement preparedStatement) throws SQLException {
                ...
                preparedStatement.setTimestamp(4, dateTimeService.getCurrentTimestamp());
    ...
    public void updateEncumbrance(final Encumbrance encumbrance) {
        new UpdatingJdbcWrapper<Encumbrance>() {
            ...
            protected void populateStatement(PreparedStatement preparedStatement) throws SQLException {
                ...
                preparedStatement.setTimestamp(6, dateTimeService.getCurrentTimestamp());
    ...
    public void updateSufficientFundBalances(final SufficientFundBalances sufficientFundBalances) {
        new UpdatingJdbcWrapper<SufficientFundBalances>() {
            ...
            protected void populateStatement(PreparedStatement preparedStatement) throws SQLException {
                ...
                preparedStatement.setTimestamp(5, dateTimeService.getCurrentTimestamp());
