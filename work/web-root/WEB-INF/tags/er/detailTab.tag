	...
	<c:when test="${isEditable}">
		...
		<div class="tab-container" align=center>
			<er:detailLinesWithGrouping id="editableDetailLineTable" detailLines="${detailLines}" 
				...
				hiddenFieldNames="chartOfAccountsCode,financialObjectCode,documentNumber,universityFiscalYear,newLineIndicator,federalOrFederalPassThroughIndicator,persistedPayrollAmount,persistedEffortPercent,versionNumber"
