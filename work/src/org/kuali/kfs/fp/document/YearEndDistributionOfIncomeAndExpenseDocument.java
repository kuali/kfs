...
/**
 * Year End version of the <code>DistributionOfIncomeAndExpenseDocument</code> functionally the only difference is the accounting
 * period code used on the glpe entries
 * 
