...
public class UserSession implements Serializable {
    ...
    /**
     * @return the FinancialSystemUser which is the current user in the system, backdoor if backdoor is set
     * 
     * Note: this must return a UniversalUser object to satisfy the contract of classes within the Rice KNS.
     */
     ...
     * @return the FinancialSystemUser which is the current user in the system, backdoor if backdoor is set
     */
    public FinancialSystemUser getFinancialSystemUser() {
        if (backdoorUser != null) {
            return backdoorUser;
        }
        else {
