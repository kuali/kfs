	...
	<div class="tab-container" align=center>
		...
		<table cellpadding=0 class="datatable" summary="Final Invoice Reversal Entries">
			...
			<tr>
				...
				<kul:htmlAttributeHeaderCell attributeEntry="${attributes.documentNumber}" />
			...
			<c:if test="${not readOnly}">
				<tr>
					...
					<td class="infoline"><kul:htmlControlAttribute attributeEntry="${attributes.documentNumber}" property="invoiceEntry.documentNumber"
			...
			<logic:iterate id="FinalInvoiceReversalEntry" name="KualiForm" property="document.invoiceEntries" indexId="ctr">
				<tr>
					...
					<td class="datacell"><kul:htmlControlAttribute attributeEntry="${attributes.documentNumber}"
							property="document.invoiceEntries[${ctr}].documentNumber" readOnly="true" /></td>
					<c:if test="${not readOnly}">
						<td class="datacell">
							<div align="center">
