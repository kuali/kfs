...
public class DataLoadHandler implements PdpFileHandler {
    ...
    public void setGroup(XmlGroup group) {
        ...
        if (pg.getEmployeeIndicator() == null) {
        ...
        if (customer.getNraReview().booleanValue() && customer.getEmployeeCheck().booleanValue() && pg.getEmployeeIndicator().booleanValue() && pg.getNraPayment().booleanValue()) {
            if (heldForNRAEmployee != null) {
                pg.setPaymentStatus(heldForNRAEmployee);
                this.setTaxEmailRequired(true);
            }
        }
        else if (customer.getEmployeeCheck().booleanValue() && pg.getEmployeeIndicator().booleanValue()) {
    ...
    private void replaceAccountingString(Code objChangeCd, List changeRecords, PaymentAccountDetail pad) {
        ...
        changeRecords.add(newAccountHistory("fin_object_cd", customer.getDefaultObjectCode(), pad.getFinObjectCode(), objChangeCd));
        changeRecords.add(newAccountHistory("fin_sub_obj_cd", customer.getDefaultSubObjectCode(), pad.getFinSubObjectCode(), objChangeCd));
