...
/**
 * Business object for Collector Hierarchy.
 */
public class CollectorHierarchy extends PersistableBusinessObjectBase {
    ...
    private List<CollectorInformation> collectorInformations;

    /**
     * Default constructor
     */
    public CollectorHierarchy() {
        super();
        collectorInformations = new ArrayList<CollectorInformation>();
    }
    ...
    /**
     * Gets the collectorInformations attribute.
     * 
     * @return Returns collectorInformations attribute.
     */
    public List<CollectorInformation> getCollectorInformations() {
        return collectorInformations;
    }

    /**
     * Sets the collectorInformations
     * 
     * @param collectorInformations
     */
    public void setCollectorInformations(List<CollectorInformation> collectorInformations) {
