...
public interface MassImportFileParser {
     ...
     */
    public abstract List<MassImportLineBase> importLines(String fileName, byte[] data, Class<? extends MassImportLineBase> itemClass, MassImportDocument document, String errorPathPrefix);
