...
public class CGEmailServiceImpl extends DefaultEmailService implements CGEmailService {
    ...
    public void sendEmail(List<Milestone> milestones, Award award) {
        ...
        String messageKey = kualiConfigurationService.getPropertyString(CGKeyConstants.MESSAGE_CG_UPCOMING_MILESTONES_EMAIL_LINE_1);
        ...
        messageKey = kualiConfigurationService.getPropertyString(CGKeyConstants.MESSAGE_CG_UPCOMING_MILESTONES_EMAIL_LINE_2);
        body.append(MessageFormat.format(messageKey, new Object[] { null }) + "\n\n");
    ...
    protected String getEmailSubject(String subjectParmaterName) {
        String subject = parameterService.getParameterValue(UpcomingMilestoneNotificationStep.class, subjectParmaterName);
