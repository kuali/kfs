              ...
              <tr>
                ...
                <td nowrap class="infoline" colspan="2">
                  <div align="center">
					...
					&nbsp;&nbsp;
					<kul:lookup boClassName="org.kuali.kfs.coa.businessobject.Org" fieldConversions="chartOfAccounts.chartOfAccountsCode:newRoutingFormOrganization.chartOfAccountsCode,organizationCode:newRoutingFormOrganization.organizationCode"  anchor="otherOrganizations" />
					</div>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</td>
              ...
              <c:forEach items="${KualiForm.document.routingFormOrganizations}" var="routingFormOrganization" varStatus="status">
                ...
                <td nowrap class="neutral" colspan="2">
                  ...
                  <div align="center">
					...
					&nbsp;&nbsp;
					<kul:lookup boClassName="org.kuali.kfs.coa.businessobject.Org" fieldConversions="chartOfAccounts.chartOfAccountsCode:document.routingFormOrganization[${status.index}].chartOfAccountsCode,organizationCode:document.routingFormOrganization[${status.index}].organizationCode" anchor="otherOrganizations" />
				</div>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</td>
                  ...
                  <td class="neutral">
                    <div align="center"><html:image property="methodToCall.deleteRoutingFormOrganization.line${status.index}.anchor${currentTabIndex}" styleClass="tinybutton" src="${ConfigProperties.kr.externalizable.images.url}tinybutton-delete1.gif" title="delete institution cost share" alt="delete institution cost share" /></div>
                  </td>
                </tr>
              </c:forEach>
            </table>
