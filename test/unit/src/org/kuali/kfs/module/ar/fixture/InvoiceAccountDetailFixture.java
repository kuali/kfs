...
public enum InvoiceAccountDetailFixture {
    ...
    INV_ACCT_DTL4("5030", new Long(80072), new Integer(2011), "IN", "1292016", "2336320", new KualiDecimal(120), new KualiDecimal(1), KualiDecimal.ZERO, new KualiDecimal(120), KualiDecimal.ZERO);
