...
public class CorrectionChange extends BusinessObjectBase implements Comparable {
    ...
    /**
     * Only fieldName and replacementValue are compared because this method
     * is intended to be used with respect to the Set relation in CorrectionGroup.
     * Comparisons of other fields aren't relevent, and would be detrimental. 
     * 
