...
{
	if (confirm('This will execute the Message Fetcher which will grab all messages in the queue with this machine\'s application id and ip address and queue them up to be processed again.  Are you sure you want to do this?')) {
