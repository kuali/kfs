    ...
    <td>
      <table width="100%" border=0 cellpadding=0 cellspacing=0 class="bord-r-t">
        <tbody>
          ...
          <tr>
            <th rowspan="2" align=right nowrap >
            	Disbursement Date Range:<br><font size="1"> Ex. 11/26/2004  </font>
            </th>
          ...
          <tr>
            <th rowspan="2" align=right nowrap >
            	Pay Date Range:<br><font size="1"> Ex. 01/06/2004  </font>
            </th>
            <td rowspan="2" align=left class="datacell">
          ...
          <tr>
            ...
            <th nowrap=nowrap colspan="6">
              <div align="center">
                <input type="image" name="btnSearch" src="<%= request.getContextPath() + "/images/button_search.gif" %>" alt="Search" align="absmiddle"></a>
                <input type="image" name="btnClear" src="<%= request.getContextPath() + "/images/button_clearfields.gif" %>" alt="Clear" align="absmiddle"></a>
								<!-- ADVANCED BUTTON
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
	    ...
	    <td>
				...
				<display-el:table sort="list" name="sessionScope.indivSearchResults" id="item" pagesize="${perPage}" width="100%" cellpadding="4" cellspacing="0" class="bord-r-t">
				  ...
				  <display-el:column sortable="true" sortProperty="custPaymentDocNbr" title="Source Document Number" headerClass="thfont" class="datacell">
				  	<font size="0px">
						<c:if test="${(PaymentDetailSearchForm.oldDisbursementNbr != item.paymentGroup.disbursementNbr) && (not empty PaymentDetailSearchForm.oldDisbursementNbr)}">
								<img src="<%= request.getContextPath() + "/images/bullet-red.gif" %>" alt=">>">
						</c:if>
						...
						<!-- a href=""/paymentdetail.do?DetailId=" + item.getId() + " />" %>"><c:out value="${item.custPaymentDocNbr}" /></a -->
					</font>&nbsp;
				  </display-el:column>
...
&nbsp;&nbsp;&nbsp;&nbsp;<img src="<%= request.getContextPath() + "/images/bullet-red.gif" %>" alt=">>"> Signifies a Cancelled and Re-issued Payment.  See the Payment History Tab for the matching Disbursement Number.
</c:if>
