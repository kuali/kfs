        ...
        <tr>
          <td>
          	...
          	<c:if test="${batchSearchResults != null}" >
				      ...
				      &nbsp; ::
				      &nbsp; <a href="<%= request.getContextPath().toString() %>/batchsearch.do?btnBack_batchIndiv=param">Individual Payments in Batch</a>
				    </c:if>
				    <c:if test="${batchSearchResults == null}" >
			    ...
			    <td>
			      <table width="100%" border=0 cellpadding=4 cellspacing=0 class="tabtable">
			        <tr>
			            ...
			            <div align="center">
										<c:if test="${btnPressed != 'btnSummaryTab'}" >
			             		<a href="<%= request.getContextPath().toString() %>/paymentdetail.do?btnSummaryTab=param" class="HdrScrLnk">
			            	</c:if>
										Summary
										<c:if test="${btnPressed != 'btnSummaryTab'}" >
			             		</a>
			            ...
			            <div align="center">
										<c:if test="${btnPressed != 'btnBatchTab'}" >
			             		<a href="<%= request.getContextPath().toString() %>/paymentdetail.do?btnBatchTab=param" class="HdrScrLnk">
			            	</c:if>
										Batch
										<c:if test="${btnPressed != 'btnBatchTab'}" >
			             		</a>
			            ...
			            <div align="center">
										<c:if test="${btnPressed != 'btnPaymentTab'}" >
			             		<a href="<%= request.getContextPath().toString() %>/paymentdetail.do?btnPaymentTab=param" class="HdrScrLnk">
			            	</c:if>
										Payment
										<c:if test="${btnPressed != 'btnPaymentTab'}" >
			             		</a>
			            ...
			            <div align="center">
										<c:if test="${btnPressed != 'btnPayeeTab'}" >
			             		<a href="<%= request.getContextPath().toString() %>/paymentdetail.do?btnPayeeTab=param" class="HdrScrLnk">
			            	</c:if>
										Payee
										<c:if test="${btnPressed != 'btnPayeeTab'}" >
			             		</a>
								...
								<c:if test="${btnPressed != 'btnAccountingTab'}" >
									...
									<div align=center>
										<c:if test="${btnPressed != 'btnAccountingTab'}" >
			             		<a href="<%= request.getContextPath().toString() %>/paymentdetail.do?btnAccountingTab=param" class="HdrScrLnk">
			            	</c:if>
										Accounting
										<c:if test="${btnPressed != 'btnAccountingTab'}" >
			             		</a>
								...
								<c:if test="${btnPressed != 'btnAchInfoTab'}" >
									...
									<div align=center>
										<c:if test="${btnPressed != 'btnAchInfoTab'}" >
			             		<a href="<%= request.getContextPath().toString() %>/paymentdetail.do?btnAchInfoTab=param" class="HdrScrLnk">
			            	</c:if>
										ACH Info
										<c:if test="${btnPressed != 'btnAchInfoTab'}" >
			             		</a>
			            ...
			            <div align=center>
										<c:if test="${btnPressed != 'btnHistoryTab'}" >
			             		<a href="<%= request.getContextPath().toString() %>/paymentdetail.do?btnHistoryTab=param" class="HdrScrLnk">
			            	</c:if>
										History
										<c:if test="${btnPressed != 'btnHistoryTab'}" >
			             		</a>
			            ...
			            <div align=center>
										<c:if test="${btnPressed != 'btnNotesTab'}" >
			             		<a href="<%= request.getContextPath().toString() %>/paymentdetail.do?btnNotesTab=param" class="HdrScrLnk">
			            	</c:if>
										Notes
										<c:if test="${btnPressed != 'btnNotesTab'}" >
			             		</a>
						              ...
						              <th nowrap=nowrap>
						                <div align="center">
				              			  <c:if test="${SecurityRecord.holdRole == true}">
											          <input type="image" name="btnHold" src="<%= request.getContextPath().toString() %>/images/button_holdpayment.gif" alt="Hold Payment" align="absmiddle">
						        		      </c:if>
				              			  <c:if test="${SecurityRecord.cancelRole == true}">
											          <input type="image" name="btnCancel" src="<%= request.getContextPath() + "/images/button_cancelpayment.gif" %>" alt="Cancel Payment" align="absmiddle">
						        		      </c:if>
