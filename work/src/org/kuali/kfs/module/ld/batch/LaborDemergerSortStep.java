...
public class LaborDemergerSortStep extends AbstractStep {
    ...
    public boolean execute(String jobName, Date jobRunDate) {
        ...
        String inputFile = batchFileDirectoryName + LaborConstants.BatchFileSystem.DIVIDER + LaborConstants.BatchFileSystem.SCRUBBER_ERROR_OUTPUT_FILE;
        String outputFile = batchFileDirectoryName + LaborConstants.BatchFileSystem.DIVIDER + LaborConstants.BatchFileSystem.SCRUBBER_ERROR_SORTED_FILE;
