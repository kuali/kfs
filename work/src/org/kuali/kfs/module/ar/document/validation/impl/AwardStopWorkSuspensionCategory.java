...
/**
 * Suspension Category that checks to see if the invoice's award has stop work marked.
 */
public class AwardStopWorkSuspensionCategory extends SuspensionCategoryBase {
