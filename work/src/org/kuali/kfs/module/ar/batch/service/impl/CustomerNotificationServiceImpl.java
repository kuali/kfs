...
public class CustomerNotificationServiceImpl implements CustomerNotificationService {
    ...
    protected OrganizationOptions getOrganizationOptions(CustomerInvoiceDocument invoiceDocument) {
        ...
        return (OrganizationOptions) businessObjectService.findByPrimaryKey(OrganizationOptions.class, criteria);
    }
    ...
    protected String getNotificationSender() {
        return this.getParameterService().getParameterValue(CustomerAgingReportNotificationStep.class, ArParameterKeyConstants.AR_EMAIL_SENDER_PARAM_NM);
    }
    ...
    protected Integer getCustomerAgingNotificationOnDays() {
        String daysAsString = this.getParameterService().getParameterValue(CustomerAgingReportNotificationStep.class, ArParameterKeyConstants.CUSTOMER_AR_AGING_EMAIL_NOTIFICATION_DAYS_PARAM_NM);
        if (!StringUtils.isNumeric(daysAsString)) {
            daysAsString = this.getParameterService().getParameterValue(CustomerAgingReportDetail.class, ArConstants.CUSTOMER_INVOICE_AGE);
        }
    ...
    protected String getNotificationSelectionOption() {
        return this.getParameterService().getParameterValue(CustomerAgingReportNotificationStep.class, ArParameterKeyConstants.AR_EMAIL_NOTIFICATION_SELECTION_TYPE_PARAM_NM); 
    }
    ...
    protected List<String> getNotificationSelection(String fieldName) {        
        return this.getParameterService().getParameterValues(CustomerAgingReportNotificationStep.class, ArParameterKeyConstants.AR_EMAIL_NOTIFICATION_SELECTION_PARAM_NM, fieldName);
    }    
    ...
    protected String getNotificationText() {
        return this.getParameterService().getParameterValue(CustomerAgingReportNotificationStep.class, ArParameterKeyConstants.AR_EMAIL_NOTIFICATION_TEXT_PARAM_NM);
    }
    ...
    protected String getNotificationSubject() {
        return this.getParameterService().getParameterValue(CustomerAgingReportNotificationStep.class, ArParameterKeyConstants.AR_EMAIL_NOTIFICATION_SUBJECT_PARAM_NM);
    }
