...
<%@ attribute name="personListIndex" required="true"%>
                 ...
                 <c:choose>
	                 <c:when test="${fn:contains(KualiForm.appointmentTypeGridMappings['fullYear'], person.appointmentTypeCode)}">
	                   <cg:budgetPersonnelFullYearGrid person="${person}" personListIndex="${personListIndex}" matchAppointmentType="${person.appointmentTypeCode}" />
	                 </c:when>
                   ...
                   <c:when test="${fn:contains(KualiForm.appointmentTypeGridMappings['academicSummer'], person.appointmentTypeCode)}">
                     <cg:budgetPersonnelSummerGrid person="${person}" personListIndex="${personListIndex}"  matchAppointmentType="${person.appointmentTypeCode}"/>
                   </c:when>
                   <c:when test="${fn:contains(KualiForm.appointmentTypeGridMappings['hourly'], person.appointmentTypeCode)}">
                     <cg:budgetPersonnelHourlyGrid person="${person}" personListIndex="${personListIndex}" matchAppointmentType="${person.appointmentTypeCode}" />
                   </c:when>
                   <c:when test="${fn:contains(KualiForm.appointmentTypeGridMappings['gradResAssistant'], person.appointmentTypeCode)}">
                     <cg:budgetResGradAsstGrid person="${person}" personListIndex="${personListIndex}"  matchAppointmentType="${person.appointmentTypeCode}" />
                   </c:when>
                 </c:choose>
                 ...
                 <c:if test="${not empty person.secondaryAppointmentTypeCode }">
                  <c:choose>
	                  <c:when test="${fn:contains(KualiForm.appointmentTypeGridMappings['fullYear'], person.secondaryAppointmentTypeCode)}">
	                    <cg:budgetPersonnelFullYearGrid person="${person}" personListIndex="${personListIndex}" matchAppointmentType="${person.secondaryAppointmentTypeCode}" />
	                  </c:when>
                    ...
                    <c:when test="${fn:contains(KualiForm.appointmentTypeGridMappings['academicSummer'], person.secondaryAppointmentTypeCode)}">
                      <cg:budgetPersonnelSummerGrid person="${person}" personListIndex="${personListIndex}" matchAppointmentType="${person.secondaryAppointmentTypeCode}"  />
                    </c:when>
                    <c:when test="${fn:contains(KualiForm.appointmentTypeGridMappings['hourly'], person.secondaryAppointmentTypeCode)}">
                      <cg:budgetPersonnelHourlyGrid person="${person}" personListIndex="${personListIndex}" matchAppointmentType="${person.secondaryAppointmentTypeCode}"  />
                    </c:when>
                    <c:when test="${fn:contains(KualiForm.appointmentTypeGridMappings['gradResAssistant'], person.secondaryAppointmentTypeCode)}">
                      <cg:budgetResGradAsstGrid person="${person}" personListIndex="${personListIndex}" matchAppointmentType="${person.secondaryAppointmentTypeCode}"  />
                    </c:when>
                  </c:choose>
                 </c:if>
