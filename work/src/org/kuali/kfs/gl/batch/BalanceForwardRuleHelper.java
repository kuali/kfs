...
//  972  004970        MOVE 'Y' TO WS-SELECT-GENERAL-SW.
          ...
          if(ObjectHelper.isOneOf(balance.getBalanceTypeCode(), new String[] {"AC", "NB"})
                  && ObjectHelper.isOneOf(balance.getObjectTypeCode(), new String[] {"AS", "LI", "FB"})) {
...
// 1024  005510**** THE ABOVE LINE HAD 'CH' ADDED 7/18/95 ARE
          ...
          if(ObjectHelper.isOneOf(balance.getBalanceTypeCode(), new String[] {"AC", "CB"})
                  && ObjectHelper.isOneOf(
                          balance.getObjectTypeCode(), 
                          new String[] {"EE", "ES", "EX", "IC", "TE", "TI", "IN", "CH"})) {
...
// 1076  006030                OR 'PFCMR ')
              ...
              if(null != subFundGroup 
                      && ("CG".equals(subFundGroup.getFundGroupCode())
                              || ObjectHelper.isOneOf(
...
//          1141  006680     END-EXEC.
              ...
              //    balanceTypeService.getBalanceTypByCode(balance.getBalanceTypeCode());
...
//          1147  006740           IF CABTYP-FIN-BALTYP-ENC-CD = 'Y'
              ...
              if(null != balanceType && balanceType.isFinBalanceTypeEncumIndicator()) {
          
//          1148  006750             MOVE 'N' TO TRN-ENCUM-UPDT-CD
//          1149  006760                         WS-TRN-ENCUM-UPDT-CD
              
                  transactionEncumbranceUpdateCode = "N";
...
//          1171  006980           MOVE 'Y' TO WS-FATAL-ERROR-FLAG
                  ...
                  throw new FatalErrorException(
                          new StringBuffer(" ERROR ACCESSING BALANCE TYPE TABLE FOR ")
                          .append(balance.getBalanceTypeCode()).toString());
...
//          1181  007080     END-EXEC.
              ...
              ObjectType objectType = balance.getObjectType(); 
              //    objectTypeService.getByPrimaryKey(balance.getObjectTypeCode());
...
//          1187  007140        IF CAOTYP-FIN-OBJTYP-DBCR-CD = 'C' OR 'D'
              ...
              String objectTypeDebitCreditCode = Constants.GL_CREDIT_CODE;
              // NOTE this field doesn't seem to be used anywhere in the cobol 
              // String subFundGroupCode = null;
              
              if(null != objectType 
                      && ObjectHelper.isOneOf(
                              objectType.getFinObjectTypeDebitcreditCd(), 
...
//          1189  007160             TO WS-FIN-OBJTYP-DBCR-CD
                  ...
                  objectTypeDebitCreditCode = objectType.getFinObjectTypeDebitcreditCd();
...
//          1192  007190           MOVE 'C' TO WS-FIN-OBJTYP-DBCR-CD
                  ...
                  objectTypeDebitCreditCode = Constants.GL_CREDIT_CODE;
...
//          1211  007380           MOVE 'Y' TO WS-FATAL-ERROR-FLAG
                  ...
                  throw new FatalErrorException(
                          new StringBuffer(" ERROR ACCESSING OBJECT TYPE TABLE FOR ")
...
//              1270  007970        IF WS-FIN-OBJTYP-DBCR-CD = 'D'
                      ...
                      if(Constants.GL_DEBIT_CODE.equals(objectTypeDebitCreditCode)) {
...
//              1276  008030          TO TRN-DEBIT-CRDT-CD.
                      ...
                      entry.setTransactionDebitCreditCode(objectTypeDebitCreditCode);
...
//              1351  008730       TO UNIV-FISCAL-PRD-CD             OF GLEN-RECORD.
                  ...
                  entry.setUniversityFiscalPeriodCode("CB");
...
//              1376  008980           IF WS-FIN-OBJTYP-DBCR-CD = 'C'
                          ...
                          if("C".equals(objectTypeDebitCreditCode)) {
