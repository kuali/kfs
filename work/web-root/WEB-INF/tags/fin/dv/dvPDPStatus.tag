...
<kul:tab tabTitle="Pre-Disbursement Processor Status" defaultOpen="false">
  ...
  <table style="datatable" cellpadding="0" border="0" summary="DV PDP Status">
    ...
    <tr>
      ...
      <td align="left" valign="middle" class="datacell" width="50%"><kul:htmlControlAttribute attributeEntry="${dvAttributes.paidDate}" property="document.paidDate" readOnly="true" /></td>
    </tr>
    <tr>
