...
public class CalculatePersonnelEvent extends KualiDocumentEventBase {
    ...
    /**
     * Constructs a CalculatePersonnelEvent with the given errorPathPrefix and document.
     * 
     * @param errorPathPrefix
     * @param document
     */
    public CalculatePersonnelEvent(String errorPathPrefix, Document document) {
     ...
     * @param document
     */
    public CalculatePersonnelEvent(Document document) {
        this("", document);
    }
    ...
    public boolean invokeRuleMethod(BusinessRule rule) {
        return ((BudgetDocumentRule) rule).verifyPersonnelRequiredFields(document);
    }
}
