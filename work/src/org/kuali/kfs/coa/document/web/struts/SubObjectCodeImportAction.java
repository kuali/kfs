 ...
 */
public class SubObjectCodeImportAction extends MassImportTransactionalDocumentActionBase {
    private static final Logger LOG = Logger.getLogger(SubObjectCodeImportAction.class);
