...
public class CreditCardVendorRule extends MaintenanceDocumentRuleBase {
    ...
    protected boolean processCustomRouteDocumentBusinessRules(MaintenanceDocument document) {
        ...
        if (newCreditCardVendor.getIncomeSubAccountNumber() != null) {
            ...
            if (checkRequiredSubAccount("Income")){
                ...
                if (existenceSubAccount == null){
                    putFieldError("incomeSubAccountNumber", KeyConstants.ERROR_CCV_INVALIDSUBACCOUNT, 
                            "Income Sub-Account Number, "+ newCreditCardVendor.getIncomeSubAccountNumber());
                } else
        ...
        if (newCreditCardVendor.getExpenseSubAccountNumber() != null) {
            if (checkRequiredSubAccount("Expense")){
                ...
                if (existenceSubAccount == null){
                    putFieldError("expenseSubAccountNumber", KeyConstants.ERROR_CCV_INVALIDSUBACCOUNT, 
                            "Expense Sub-Account Number, "+ newCreditCardVendor.getExpenseSubAccountNumber());
        ...
        if (newCreditCardVendor.getIncomeFinancialSubObjectCode() != null) {
            if (checkRequiredSubObjectCode("Income")){
                ...
                if (existenceSubObj ==null) {
                    putFieldError("incomeFinancialSubObjectCode", KeyConstants.ERROR_CCV_INVALIDSUBOBJECT, 
                        "Income Sub-Object Code, "+ newCreditCardVendor.getIncomeFinancialSubObjectCode());
                } else
        ...
        if (newCreditCardVendor.getExpenseFinancialSubObjectCode() != null) {
            if (checkRequiredSubObjectCode("Expense")){
                ...
                if (existenceSubObj ==null) {
                    putFieldError("expenseFinancialSubObjectCode", KeyConstants.ERROR_CCV_INVALIDSUBOBJECT, 
                        "Expense Sub-Object Code, "+ newCreditCardVendor.getExpenseFinancialSubObjectCode());
                } else
                    //check the Sub-Object is active
                    if (!existenceSubObj.isFinancialSubObjectActiveIndicator()){
    ...
    /**
     * This method...is for checking whether or not account is active.
     * check the existence and expired
     * 
     */
