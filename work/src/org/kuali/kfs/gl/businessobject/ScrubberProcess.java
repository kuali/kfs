...
public class ScrubberProcess {
    ...
    private void runLedgerEntryReports(Date runDate, List<OriginEntryGroup> originEntryGroupList, String reportNamePrefix){
        List<Integer> groupIdList = new ArrayList<Integer>();
        
        for(Iterator originEntryGroupIterator = originEntryGroupList.iterator(); originEntryGroupIterator.hasNext();){
            OriginEntryGroup originEntryGroup = (OriginEntryGroup)originEntryGroupIterator.next();
            groupIdList.add(originEntryGroup.getId());
        }
        System.out.println("groupIdList : " + groupIdList);
        reportService.generateLedgerReports(runDate, groupIdList, reportNamePrefix);
    }
