...
/**
 * Integration class for ProposalCreationStatusDTO
 */
public class ProposalCreationStatusDTO implements Serializable {
    ...
    protected ContractAndGrantsProposal proposal;

    public ProposalCreationStatusDTO() {
    }
