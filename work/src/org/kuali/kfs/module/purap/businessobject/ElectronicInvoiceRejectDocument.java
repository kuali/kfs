...
public class ElectronicInvoiceRejectDocument implements Serializable, PersistenceBrokerAware {
  ...
  private Integer epicPurchaseOrderId;
  private String epicPODeliveryCampusCode;
  ...
  private ElectronicInvoiceLoadSummary electronicInvoiceLoadSummary;
  private List electronicInvoiceRejectItems = new ArrayList();
  private List electronicInvoiceRejectReasons = new ArrayList();
  ...
  private void setFileLevelData(ElectronicInvoice ei) {
    ...
    this.invoiceDate = ei.getInvoiceDateDisplayText();
...
//        ElectronicInvoiceMappingService.CXML_ADDRESS_REMIT_TO_NAME);
    ...
    this.invoicePurchaseOrderId = eio.getInvoicePurchaseOrderID();
    this.epicPurchaseOrderId = eio.getPurchaseOrderID();
    this.epicPODeliveryCampusCode = eio.getPurchaseOrderCampusCode();
...
//    }
  ...
  public BigDecimal getTotalAmount() {
    ...
    try {
      for (Iterator iter = this.electronicInvoiceRejectItems.iterator(); iter.hasNext();) {
  ...
  /**
   * @return Returns the loadSummaryId.
   */
  public Integer getLoadSummaryId() {
    return loadSummaryId;
  }
  /**
   * @param loadSummaryId The loadSummaryId to set.
   */
  public void setLoadSummaryId(Integer loadSummaryId) {
    this.loadSummaryId = loadSummaryId;
  }
  /**
   * @return Returns the electronicInvoiceLoadSummary.
   */
  public ElectronicInvoiceLoadSummary getElectronicInvoiceLoadSummary() {
    return electronicInvoiceLoadSummary;
  }
  /**
   * @param electronicInvoiceLoadSummary The electronicInvoiceLoadSummary to set.
   */
  public void setElectronicInvoiceLoadSummary(
      ElectronicInvoiceLoadSummary electronicInvoiceLoadSummary) {
    this.electronicInvoiceLoadSummary = electronicInvoiceLoadSummary;
    this.loadSummaryId = electronicInvoiceLoadSummary.getInvoiceLoadSummaryIdentifier();
  }
  /**
   ...
   */
  public List getElectronicInvoiceRejectItems() {
    return electronicInvoiceRejectItems;
  }
  /**
   * @param electronicInvoiceRejectItems The electronicInvoiceRejectItems to set.
   */
  public void setElectronicInvoiceRejectItems(List electronicInvoiceRejectItems) {
    this.electronicInvoiceRejectItems = electronicInvoiceRejectItems;
  }
  /**
   * @return Returns the electronicInvoiceRejectReasons.
   */
  public List getElectronicInvoiceRejectReasons() {
    return electronicInvoiceRejectReasons;
  }
  /**
   * @param electronicInvoiceRejectReasons The electronicInvoiceRejectReasons to set.
   */
  public void setElectronicInvoiceRejectReasons(List electronicInvoiceRejectReasons) {
    this.electronicInvoiceRejectReasons = electronicInvoiceRejectReasons;
  }
  /**
   * @return Returns the epicPODeliveryCampusCode.
   */
  public String getEpicPODeliveryCampusCode() {
    return epicPODeliveryCampusCode;
  }
  /**
   * @param epicPODeliveryCampusCode The epicPODeliveryCampusCode to set.
   */
  public void setEpicPODeliveryCampusCode(String epicPODeliveryCampusCode) {
    this.epicPODeliveryCampusCode = epicPODeliveryCampusCode;
  }
  /**
   * @return Returns the epicPurchaseOrderId.
   */
  public Integer getEpicPurchaseOrderId() {
    return epicPurchaseOrderId;
  }
  /**
   * @param epicPurchaseOrderId The epicPurchaseOrderId to set.
   */
  public void setEpicPurchaseOrderId(Integer epicPurchaseOrderId) {
    this.epicPurchaseOrderId = epicPurchaseOrderId;
  }
  /**
