    ...
    <div class="tab-container" align=center>
        ...
        <table cellpadding="0" cellspacing="0" class="datatable" summary="Additional Section">
            ...
            <tr>
                ...
                <td align=left valign=middle class="datacell">
                    <kul:htmlControlAttribute attributeEntry="${documentAttributes.purchaseOrderCostSourceCode}" property="document.purchaseOrderCostSourceCode" readOnly="${not (fullEntryMode or amendmentEntry)}" />
                </td>
                <th align=right valign=middle class="bord-l-b">
