...
<kul:documentPage showDocumentInfo="true" documentTypeName="KualiYearEndDistributionOfIncomeAndExpenseDocument" htmlFormAction="financialYearEndDistributionOfIncomeAndExpense" renderMultipart="true" showTabButtons="true">
