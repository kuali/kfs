...
<table cellpadding="0" cellspacing="0" class="datatable" >
	<tr>
            ...
            <th class="bord-l-b">
	            <div align="right" >
	            	<kul:htmlAttributeLabel attributeEntry="${documentAttributes.paymentMethod}" />
	           	</div>
            </th>
            <td class="datacell">
            	<kul:htmlControlAttribute attributeEntry="${documentAttributes.paymentMethod}" property="document.paymentMethod" readOnly="${!fullEntryMode}"/>                 
            </td>
      </tr>
      <tr>
            <th class="bord-l-b">
      ...
      <tr>
            ...
            <c:if test="${KualiForm.displayNonEmployeeCheckBox}"> 
	            ...
	            <td class="datacell">
	            	<kul:htmlControlAttribute attributeEntry="${documentAttributes.nonEmployeeCertified}" property="document.nonEmployeeCertified" readOnly="${!fullEntryMode}"/>
				</td>
			</c:if>            
      </tr>     
      <tr>
