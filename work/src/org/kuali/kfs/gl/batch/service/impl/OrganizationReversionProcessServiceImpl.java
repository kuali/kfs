...
public class OrganizationReversionProcessServiceImpl implements OrganizationReversionProcessService {
    ...
    private static final String ORGANIZATION_REVERSION_END_OF_YEAR_PROCESS_BEAN_NAME = "glOrganizationReversionEndOfYearProcess";
    private static final String ORGANIZATION_REVERSION_BEGINNING_OF_YEAR_PROCESS_BEAN_NAME = "glOrganizationReversionBeginningOfYearProcess";
    ...
    public void organizationReversionProcessEndOfYear(Map jobParameters, Map<String, Integer> organizationReversionCounts) {
        ...
        OrganizationReversionProcess orp = organizationReversionProcesses.get(OrganizationReversionProcessServiceImpl.ORGANIZATION_REVERSION_END_OF_YEAR_PROCESS_BEAN_NAME);
    ...
    public void organizationReversionProcessBeginningOfYear(Map jobParameters, Map<String, Integer> organizationReversionCounts) {
        ...
        Map<String, OrganizationReversionProcess> organizationReversionProcesses = SpringContext.getBeansOfType(OrganizationReversionProcess.class);
        OrganizationReversionProcess orp = organizationReversionProcesses.get(OrganizationReversionProcessServiceImpl.ORGANIZATION_REVERSION_BEGINNING_OF_YEAR_PROCESS_BEAN_NAME);
