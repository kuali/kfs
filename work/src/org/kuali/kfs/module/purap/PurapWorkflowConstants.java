...
public class PurapWorkflowConstants {
    ...
    public static class PurchaseOrderDocument {
        ...
        public enum NodeDetailEnum implements NodeDetails {
            ...
            VENDOR_TAX_REVIEW ("Vendor Tax Review", PurapConstants.PurchaseOrderStatuses.AWAIT_TAX_REVIEW, PurapConstants.PurchaseOrderStatuses.DAPRVD_TAX),
            DOCUMENT_TRANSMISSION ("Document Transmission", null, PurapConstants.PurchaseOrderStatuses.VOID),
            ;
    ...
    public static class PaymentRequestDocument {
        public enum NodeDetailEnum implements NodeDetails {
            ...
            ACCOUNTS_PAYABLE_REVIEW ("Accounts Payable Review", PurapConstants.PaymentRequestStatuses.AWAITING_ACCOUNTS_PAYABLE_REVIEW, PurapConstants.PaymentRequestStatuses.CANCELLED_PRIOR_TO_AP_APPROVAL, false),
            SUB_ACCOUNT_REVIEW (KualiWorkflowUtils.RouteLevelNames.SUB_ACCOUNT_REVIEW, PurapConstants.PaymentRequestStatuses.AWAITING_SUB_ACCT_MGR_REVIEW, PurapConstants.PaymentRequestStatuses.CANCELLED_POST_AP_APPROVE, false),
            ACCOUNT_REVIEW (KualiWorkflowUtils.RouteLevelNames.ACCOUNT_REVIEW, PurapConstants.PaymentRequestStatuses.AWAITING_FISCAL_REVIEW, PurapConstants.PaymentRequestStatuses.CANCELLED_POST_AP_APPROVE, true),
            ORG_REVIEW (KualiWorkflowUtils.RouteLevelNames.ORG_REVIEW, PurapConstants.PaymentRequestStatuses.AWAITING_ORG_REVIEW, PurapConstants.PaymentRequestStatuses.CANCELLED_POST_AP_APPROVE, false),
            VENDOR_TAX_REVIEW ("Vendor Tax Review", PurapConstants.PaymentRequestStatuses.AWAITING_TAX_REVIEW, PurapConstants.PaymentRequestStatuses.CANCELLED_POST_AP_APPROVE, false),
            ;
    ...
    public static class CreditMemoDocument {
        public enum NodeDetailEnum implements NodeDetails {
            ADHOC_REVIEW (DOC_ADHOC_NODE_NAME, null, PurapConstants.PaymentRequestStatuses.CANCELLED_IN_PROCESS, false),
            ACCOUNTS_PAYABLE_REVIEW ("Accounts Payable Review", PurapConstants.CreditMemoStatuses.AWAITING_ACCOUNTS_PAYABLE_REVIEW, PurapConstants.CreditMemoStatuses.CANCELLED_PRIOR_TO_AP_APPROVAL, false),
            ACCOUNT_REVIEW (KualiWorkflowUtils.RouteLevelNames.ACCOUNT_REVIEW, PurapConstants.CreditMemoStatuses.AWAITING_FISCAL_REVIEW, PurapConstants.CreditMemoStatuses.CANCELLED_POST_AP_APPROVE, false),
            ;
