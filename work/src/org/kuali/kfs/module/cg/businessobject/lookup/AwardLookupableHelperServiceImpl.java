...
public class AwardLookupableHelperServiceImpl extends KualiLookupableHelperServiceImpl {
    ...
    public List<HtmlData> getCustomActionUrls(BusinessObject businessObject, List pkNames) {
        ...
        if (allowsMaintenanceNewOrCopyAction()) {
            anchorHtmlDataList.add(getUrlData(businessObject, KNSConstants.MAINTENANCE_COPY_METHOD_TO_CALL, pkNames));
        }
    ...
    private AnchorHtmlData getInvoicesLookupUrl(BusinessObject bo) {
        ...
        params.put("proposalNumber", award.getProposalNumber().toString());
