    ...
    <div class="tab-container" align=center>
        ...
        <table cellpadding="0" cellspacing="0" class="datatable" summary="Additional Section">
            ...
            <tr>
                ...
                <td align=left valign=middle class="datacell">
                    <kul:htmlControlAttribute attributeEntry="${documentAttributes.purchaseOrderTransmissionMethodCode}" property="document.purchaseOrderTransmissionMethodCode" readOnly="${not (fullEntryMode or amendmentEntry)}" />
                </td>
                <th align=right valign=middle class="bord-l-b">
            ...
            <tr>
                ...
                <td align=left valign=middle class="datacell">
                    <kul:htmlControlAttribute attributeEntry="${documentAttributes.purchaseOrderCostSourceCode}" property="document.purchaseOrderCostSourceCode" extraReadOnlyProperty="document.purchaseOrderCostSourceDescription" readOnly="${not (fullEntryMode or amendmentEntry) or displayRequisitionFields}" />
                </td>
                <th align=right valign=middle class="bord-l-b">
            ...
            <tr>
                ...
                <c:choose>
	                <c:when test="${displayRequisitionFields}">
		                ...
		                <td align=left valign=middle class="datacell">
		                    <kul:htmlControlAttribute attributeEntry="${documentAttributes.requisitionOrganizationReference2Text}" property="document.requisitionOrganizationReference1Text" readOnly="${not (fullEntryMode or amendmentEntry)}" />
		                </td>
	                </c:when>
        			<c:otherwise>
		                <th align=right valign=middle class="bord-l-b">
            ...
            <tr>
                ...
                <c:choose>
	                <c:when test="${displayRequisitionFields}">
		                ...
		                <td align=left valign=middle class="datacell">
		                    <kul:htmlControlAttribute attributeEntry="${documentAttributes.requisitionOrganizationReference1Text}" property="document.requisitionOrganizationReference3Text" readOnly="${not (fullEntryMode or amendmentEntry)}" />
		                </td>
	                </c:when>
        			<c:otherwise>
		                <th align=right valign=middle class="bord-l-b">
