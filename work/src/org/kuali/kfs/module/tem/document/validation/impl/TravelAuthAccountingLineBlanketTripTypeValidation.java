   ...
   public class TravelAuthAccountingLineBlanketTripTypeValidation extends GenericValidation {
    ...
    public boolean validate(AttributedDocumentEvent event) {
           ...
           if (travelDocument.getSourceAccountingLines() != null || travelDocument.getSourceTotal().isGreaterThan(KualiDecimal.ZERO)) {
               if (travelDocument.getTripType() != null && travelDocument.getTripType().isBlanketTravel()) {
                   ...
                   GlobalVariables.getMessageMap().putError(TemPropertyConstants.NEW_SOURCE_ACCTG_LINE, KFSKeyConstants.ERROR_CUSTOM, "Accounting Line is not applicable for In State Blanket trip type.");
                   rulePassed = false;               
               }                  
           }
