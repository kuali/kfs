...
public class DefaultInvoiceTemplateFinder implements ValueFinder {
    ...
    public String getValue() {
        String value = null;
        value = KNSServiceLocator.getParameterService().getParameterValue(CGConstants.CG_NAMESPACE_CODE, CGConstants.AGENCY_DETAIL_TYPE_CODE, CGConstants.DEFAULT_INVOICE_TEMPLATE);
