...
public class KEMIDHistoricalBalanceInquirable extends KfsInquirableImpl {
    ...
    public HtmlData getInquiryUrl(BusinessObject businessObject, String attributeName, boolean forceInquiry) {
        ...
        if (EndowPropertyConstants.KEMID_HIST_BAL_TOTAL_MARKET_VAL.equals(attributeName) && ObjectUtils.isNotNull(historicalBalance.getTotalMarketValue())) {
            ...
            params.put(EndowPropertyConstants.KEMID_HIST_BAL_DET_KEMID_CLOSED_INDICATOR, historicalBalance.getKemidObj().isClosedIndicator() ? "Yes" : "No");
            ...
            fieldList.put(EndowPropertyConstants.KEMID_HIST_BAL_DET_KEMID_CLOSED_INDICATOR, historicalBalance.getKemidObj().isClosedIndicator() ? "Yes" : "No");
