...
public class ProxyTicket extends ServiceTicket {
    ...
    public ProxyTicket(ProxyGrantingTicket t, String service) {
        /*
         * By convention, a proxy ticket is never taken to proceed from an initial login. (That is, "renew=true" will always fail
         * for a proxy ticket.) Because of this, we pass "false" to the parent class's constructor.
         */
