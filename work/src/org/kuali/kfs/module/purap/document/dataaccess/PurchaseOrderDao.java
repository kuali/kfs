...
public interface PurchaseOrderDao {
    ...
    /**
     * This method gets all the Purchase orders docnbrs
     * @return List of PO fdoc_nbr
     */

    public List<String> getPurchaseOrderDocumentNumbersForComparison(Integer id, String docNumber) ;
