...
public class CreateRecurringCashTransferTransactionsStep extends AbstractStep {

    private CreateRecurringCashTransferTransactionsService createRecurringCashTransferTransactionsService;
    
    public boolean execute(String jobName, Date jobRunDate) throws InterruptedException {

        return createRecurringCashTransferTransactionsService.createRecurringCashTransferTransactions();
    }
