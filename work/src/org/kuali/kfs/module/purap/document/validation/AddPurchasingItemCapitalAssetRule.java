...
/**
 * Add Purchasing Item Capital Asset Rule Interface.
 * Defines a rule which gets invoked immediately before a item capital asset is added to a Purchasing Document.
 */
public interface AddPurchasingItemCapitalAssetRule {
