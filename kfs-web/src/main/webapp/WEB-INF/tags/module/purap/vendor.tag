            ...
            <tr>
                ...
                <td align=left valign=middle class="datacell" width="25%">
                    <kul:htmlControlAttribute 
                    	...
                    	readOnly="${(readOnlyForPREQ or readOnlyAddrForPREQ) or not (fullEntryMode or amendmentEntry) or displayCreditMemoFields or (lockB2BEntry and (displayRequisitionFields or displayPurchaseOrderFields))}" tabindexOverride="${tabindexOverrideBase + 3}"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td align=left valign=middle class="datacell">
                    <kul:htmlControlAttribute 
                    	...
                    	readOnly="${(readOnlyForPREQ or readOnlyAddrForPREQ) or not (fullEntryMode or amendmentEntry) or displayCreditMemoFields or (lockB2BEntry and (displayRequisitionFields or displayPurchaseOrderFields))}" tabindexOverride="${tabindexOverrideBase + 0}"/>
