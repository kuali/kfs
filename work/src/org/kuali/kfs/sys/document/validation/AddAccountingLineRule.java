...
/**
 * Defines a rule which gets invoked immediately before an accounting line is added to a document.
 */
public interface AddAccountingLineRule<F extends AccountingDocument> extends AccountingLineRule {
    /**
