    ...
    private void processGroup(OriginEntryGroup originEntryGroup) {
        ...
        while (entries.hasNext()) {
            ...
            if (!isFatal(transactionErrors)) {
                ...
                // TODO: Check
                /*
                 * if (otherDocTypeCodes.succeedsRule(scrubbedEntry.getFinancialDocumentTypeCode())) { String m =
