...
public class PurchaseOrderDataDictionaryDocumentSearchCustomizer extends PurAPDataDictionaryDocumentSearchCustomizer {

    /**
     * Constructs a DataDictionaryDocumentSearchCustomizer.java.
     */
    public PurchaseOrderDataDictionaryDocumentSearchCustomizer() {
        super();
