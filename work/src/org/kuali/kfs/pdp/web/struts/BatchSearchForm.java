...
public class BatchSearchForm extends ActionForm {
    ...
    public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
        ...
        if (buttonPressed.startsWith("btnSearch")) {
            if ((GeneralUtilities.isStringEmpty(this.batchId)) && (GeneralUtilities.isStringEmpty(this.chartCode)) && (GeneralUtilities.isStringEmpty(this.orgCode)) && (GeneralUtilities.isStringEmpty(this.subUnitCode)) && (GeneralUtilities.isStringEmpty(this.paymentCount)) && (GeneralUtilities.isStringEmpty(this.paymentTotalAmount)) && (GeneralUtilities.isStringEmpty(this.beginDate)) && (GeneralUtilities.isStringEmpty(this.endDate))) {
                ...
                if ((!(GeneralUtilities.isStringEmpty(this.batchId))) && (!(GeneralUtilities.isStringAllNumbers(this.batchId)))) {
                    actionErrors.add("errors", new ActionMessage("batchSearchForm.batchId.invalid"));
                }
                if ((!(GeneralUtilities.isStringEmpty(this.paymentCount))) && (!(GeneralUtilities.isStringAllNumbers(this.paymentCount)))) {
                    actionErrors.add("errors", new ActionMessage("batchSearchForm.paymentCount.invalid"));
                }
                if ((!(GeneralUtilities.isStringEmpty(this.paymentTotalAmount))) && (!(GeneralUtilities.isStringAllNumbersOrASingleCharacter(this.paymentTotalAmount, '.')))) {
                ...
                if ((GeneralUtilities.isStringEmpty(this.batchId)) && (GeneralUtilities.isStringEmpty(this.paymentCount)) && (GeneralUtilities.isStringEmpty(this.paymentTotalAmount))) {
                    // If batchId, paymentCount, and paymentTotalAmount are empty then at least one date is required
                    if ((GeneralUtilities.isStringEmpty(this.beginDate)) && (GeneralUtilities.isStringEmpty(this.endDate))) {
                        actionErrors.add("errors", new ActionMessage("batchSearchForm.batchcriteria.noDate"));
                    }
                    else if (((!(GeneralUtilities.isStringEmpty(this.beginDate))) || (!(GeneralUtilities.isStringEmpty(this.endDate)))) && ((GeneralUtilities.isStringEmpty(this.beginDate)) || (GeneralUtilities.isStringEmpty(this.endDate)))) {
                        // If we have one (but not both) dates the user must enter either the chartCode, orgCode, or subUnitCode
                        if ((GeneralUtilities.isStringEmpty(this.chartCode)) && (GeneralUtilities.isStringEmpty(this.orgCode)) && (GeneralUtilities.isStringEmpty(this.subUnitCode))) {
