...
public interface YearEndDao {
    /**
     * Returns the keys (Chart Code and Account Number) of PriorYearAccounts that are missing for
     * the balances associated with the given fiscal year
    ...
    /**
     * Returns a set of the keys (chartOfAccountsCode and accountNumber) of PriorYearAccounts that are missing
     * for the open encumbrances of a given fiscal year
    ...
    /**
     * 
     * Returns a set of the keys (subFundGroupCode) of sub fund groups that are missing for the prior
     * year accounts associated with a fiscal year to find balances for
    ...
    /**
     * Returns a set of the keys (subFundGroupCode) of sub fund groups that are missing for the prior year
     * accounts associated with a fiscal year to find open encumbrances for
