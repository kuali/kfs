...
/**
 * An interface declaring the methods that steps running year end services would need to use to close out
 * activity of an ending fiscal year (though, note: OrganizationReversion, the other year end job, is not 
 * defined here).
 */
public interface YearEndService {
    ...
    /**
     * The method responsible for creating origin entries that will forward qualifying encumbrances into the
     * next fiscal year.
     * 
    ...
    /**
     * Implementations of this method are responsible for generating origin entries to forward the balances
     * of qualifying balances from the previous fiscal year
     * 
    ...
    /**
     * This method is considered responsible for generating all of the origin entries that will close out
     * nominal activity for a given fiscal year.
     * 
     * @param nominalClosingOriginEntryGroup the origin entry group that nominal activity closing origin entries 
     * @param nominalClosingJobParameters the parameters needed by the job to run correctly: the current university date and the fiscal year to close
